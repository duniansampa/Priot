...
static int
GetStatistic_getStatisticHelperHandler(MibHandler *handler,
...
static MibHandler *
GetStatistic_getStatisticHandler(int offset)
{
    MibHandler *ret =
        AgentHandler_createHandler("get_statistic",
                               GetStatistic_getStatisticHelperHandler);
    if (ret) {
                                   ...
                                   oid start, int begin, int end)
{
    AgentHandler_injectHandler(reginfo,
                           GetStatistic_getStatisticHandler(begin - start));
