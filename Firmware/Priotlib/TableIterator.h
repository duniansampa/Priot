...
typedef Types_VariableList *
(FirstDataPointFT) ( void ** loop_context,
                     void ** data_context,
                     Types_VariableList *,
                     struct IteratorInfo_s *);

typedef Types_VariableList *
(NextDataPoint)  ( void **loop_context,
                   void **data_context,
                   Types_VariableList *,
                   struct IteratorInfo_s *);

typedef void *
(MakeDataContextFT) ( void *loop_context,
                      struct IteratorInfo_s *);

typedef void
(FreeLoopContextFT) ( void *,
                              struct IteratorInfo_s *);

typedef void
(FreeDataContext) ( void *,
                    struct IteratorInfo_s *);
...
void
TableIterator_handlerOwnsIteratorInfo( MibHandler *h );
...
void *
TableIterator_extractIteratorContext(RequestInfo *);

void
TableIterator_insertIteratorContext(RequestInfo *, void *);
...
#define TableIterator_registerTableIterator2(reginfo, iinfo)   \
    ...
    TableIterator_register_table_iterator((reginfo), (iinfo)))
...
void *
TableIterator_rowFirst( IteratorInfo *);

void *
TableIterator_rowGet(IteratorInfo *, void *);

void *
TableIterator_rowNext( IteratorInfo *, void *);

void *
TableIterator_rowGetByidx( IteratorInfo *,
                           Types_VariableList * );

void *
TableIterator_rowNextByidx( IteratorInfo *,
                            Types_VariableList * );

void *
TableIterator_rowGetByoid( IteratorInfo *,
                           oid *,
                           size_t );

void *
TableIterator_rowNextByoid( IteratorInfo *,
                            oid *,
                            size_t );

int
TableIterator_rowCount( IteratorInfo * );
