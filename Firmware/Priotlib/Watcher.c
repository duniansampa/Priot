...
#define Watcher_freeWrapper free
    ...
    case MODE_SET_RESERVE2:
        ...
        if (old_data == NULL) {
            ...
            AgentHandler_requestAddListData(requests,
                                          DataList_create
                                          ("watcher", old_data, &Watcher_freeWrapper));
        break;
...
Watcher_getWatchedTimestampHandler(void)
{
    ...
    ret = AgentHandler_createHandler("watcher-timestamp",
...
Watcher_getWatchedSpinlockHandler(void)
{
    ...
    ret = AgentHandler_createHandler("watcher-spinlock",
