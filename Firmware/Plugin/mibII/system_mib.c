...
//    extmp.next = NULL;
//    exec_command(&extmp);
//    strlcpy_strlcpy(version_descr, extmp.output, sizeof(version_descr));
...
//#else
//#ifdef HAVE_UNAME
//    strlcpy_strlcpy(sysName, utsName.nodename, sizeof(sysName));
//#else
...
//    extmp.next = NULL;
//    exec_command(&extmp);
//    strlcpy_strlcpy(sysName, extmp.output, sizeof(sysName));
//    if (strlen(sysName) >= 1)
