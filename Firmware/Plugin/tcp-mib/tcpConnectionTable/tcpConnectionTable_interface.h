...
#include "Table.h"
    ...
    Container_Container *tcpConnectionTable_container_get(void);
    ...
    int             tcpConnectionTable_index_to_oid(Types_Index *
                                                    oid_idx,
                                                    tcpConnectionTable_mib_index
                                                    * mib_idx);
    int             tcpConnectionTable_index_from_oid(Types_Index *
                                                      oid_idx,
                                                      tcpConnectionTable_mib_index
                                                      * mib_idx);
    ...
    void
             ...
             tcpConnectionTable_valid_columns_set(ColumnInfo *vc);
