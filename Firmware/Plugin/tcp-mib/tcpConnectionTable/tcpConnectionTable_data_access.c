...
{
    DEBUG_MSGTL( ( "verbose:tcpConnectionTable:tcpConnectionTable_init_data",
        "called\n" ) );
...
void tcpConnectionTable_container_init( Container_Container** container_ptr_ptr,
    Cache* cache )
{
    DEBUG_MSGTL( ( "verbose:tcpConnectionTable:tcpConnectionTable_container_init", "called\n" ) );
...
{
    DEBUG_MSGTL( ( "verbose:tcpConnectionTable:tcpConnectionTable_container_shutdown", "called\n" ) );
...
_add_connection( netsnmp_tcpconn_entry* entry, Container_Container* container )
{
    ...
    DEBUG_MSGTL( ( "tcpConnectionTable:access", "creating new entry\n" ) );
    ...
    if ( ( NULL != rowreq_ctx ) && ( MFD_SUCCESS == tcpConnectionTable_indexes_set( rowreq_ctx,
                                                        entry->loc_addr_len,
                                                        entry->loc_addr,
                                                        entry->loc_addr_len,
                                                        entry->loc_port,
        ...
        if ( CONTAINER_INSERT( container, rowreq_ctx ) ) {
            LOGGER_LOGONCE( ( LOGGER_PRIORITY_DEBUG,
...
int tcpConnectionTable_container_load( Container_Container* container )
{
    ...
    DEBUG_MSGTL( ( "verbose:tcpConnectionTable:tcpConnectionTable_container_load", "called\n" ) );
    ...
    DEBUG_MSGT( ( "verbose:tcpConnectionTable:tcpConnectionTable_cache_load",
...
{
    DEBUG_MSGTL( ( "verbose:tcpConnectionTable:tcpConnectionTable_container_free", "called\n" ) );
...
{
    DEBUG_MSGTL( ( "verbose:tcpConnectionTable:tcpConnectionTable_row_prep",
        "called\n" ) );
