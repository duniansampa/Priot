...
{
    DEBUG_MSGTL( ( "verbose:tcpConnectionTable:init_tcpConnectionTable",
        "called\n" ) );
...
void initialize_table_tcpConnectionTable( void )
{
    ...
    DEBUG_MSGTL( ( "verbose:tcpConnectionTable:initialize_table_tcpConnectionTable", "called\n" ) );
 ...
 */
int tcpConnectionTable_rowreq_ctx_init( tcpConnectionTable_rowreq_ctx*
                                            rowreq_ctx,
    void* user_init_ctx )
{
    DEBUG_MSGTL( ( "verbose:tcpConnectionTable:tcpConnectionTable_rowreq_ctx_init", "called\n" ) );
 ...
 *
 */
void tcpConnectionTable_rowreq_ctx_cleanup( tcpConnectionTable_rowreq_ctx*
        rowreq_ctx )
{
    DEBUG_MSGTL( ( "verbose:tcpConnectionTable:tcpConnectionTable_rowreq_ctx_cleanup", "called\n" ) );
 ...
 */
int tcpConnectionTable_pre_request( tcpConnectionTable_registration*
        user_context )
{
    DEBUG_MSGTL( ( "verbose:tcpConnectionTable:tcpConnectionTable_pre_request", "called\n" ) );
 ...
 */
int tcpConnectionTable_post_request( tcpConnectionTable_registration*
                                         user_context,
    int rc )
{
    DEBUG_MSGTL( ( "verbose:tcpConnectionTable:tcpConnectionTable_post_request", "called\n" ) );
...
{
    DEBUG_MSGTL( ( "verbose:tcpConnectionTable:tcpConnectionTable_release_data", "called\n" ) );
 ...
 */
int tcpConnectionTable_indexes_set_tbl_idx( tcpConnectionTable_mib_index*
                                                tbl_idx,
    u_long
...
{
    DEBUG_MSGTL( ( "verbose:tcpConnectionTable:tcpConnectionTable_indexes_set_tbl_idx", "called\n" ) );
    ...
    Assert_assert( tbl_idx->tcpConnectionRemAddressType == tbl_idx->tcpConnectionLocalAddressType );
     ...
     */
    if ( ( NULL == tbl_idx->tcpConnectionLocalAddress ) || ( tbl_idx->tcpConnectionLocalAddress_len < ( tcpConnectionLocalAddress_val_ptr_len ) ) ) {
        Logger_log( LOGGER_PRIORITY_ERR, "not enough space for value\n" );
        return MFD_ERROR;
    }
    tbl_idx->tcpConnectionLocalAddress_len = tcpConnectionLocalAddress_val_ptr_len;
     ...
     */
    /** WARNING: this code might not work for netsnmp_tcpconn_entry */
    tbl_idx->tcpConnectionRemAddressType = tbl_idx->tcpConnectionLocalAddressType;
     ...
     */
    if ( ( NULL == tbl_idx->tcpConnectionRemAddress ) || ( tbl_idx->tcpConnectionRemAddress_len < ( tcpConnectionRemAddress_val_ptr_len ) ) ) {
        Logger_log( LOGGER_PRIORITY_ERR, "not enough space for value\n" );
        return MFD_ERROR;
    }
 ...
 *  from the mib index.
 */
int tcpConnectionTable_indexes_set( tcpConnectionTable_rowreq_ctx* rowreq_ctx,
    ...
    u_long tcpConnectionRemPort_val )
{
    DEBUG_MSGTL( ( "verbose:tcpConnectionTable:tcpConnectionTable_indexes_set", "called\n" ) );

    if ( MFD_SUCCESS != tcpConnectionTable_indexes_set_tbl_idx( &rowreq_ctx->tbl_idx,
                            tcpConnectionLocalAddressType_val,
                            tcpConnectionLocalAddress_val_ptr,
                            tcpConnectionLocalAddress_val_ptr_len,
    ...
    u_long* tcpConnectionState_val_ptr )
{
    ...
    Assert_assert( NULL != tcpConnectionState_val_ptr );

    DEBUG_MSGTL( ( "verbose:tcpConnectionTable:tcpConnectionState_get",
        "called\n" ) );
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != tcpConnectionProcess_val_ptr );

    DEBUG_MSGTL( ( "verbose:tcpConnectionTable:tcpConnectionProcess_get",
        "called\n" ) );
...
int tcpConnectionTable_undo_setup( tcpConnectionTable_rowreq_ctx* rowreq_ctx )
{
    ...
    DEBUG_MSGTL( ( "verbose:tcpConnectionTable:tcpConnectionTable_undo_setup",
        "called\n" ) );
...
int tcpConnectionTable_undo( tcpConnectionTable_rowreq_ctx* rowreq_ctx )
{
    ...
    DEBUG_MSGTL( ( "verbose:tcpConnectionTable:tcpConnectionTable_undo",
        "called\n" ) );
...
int tcpConnectionTable_undo_cleanup( tcpConnectionTable_rowreq_ctx* rowreq_ctx )
{
    ...
    DEBUG_MSGTL( ( "verbose:tcpConnectionTable:tcpConnectionTable_undo_cleanup", "called\n" ) );
...
int tcpConnectionTable_commit( tcpConnectionTable_rowreq_ctx* rowreq_ctx )
{
    ...
    DEBUG_MSGTL( ( "verbose:tcpConnectionTable:tcpConnectionTable_commit",
        "called\n" ) );
...
int tcpConnectionTable_undo_commit( tcpConnectionTable_rowreq_ctx* rowreq_ctx )
{
    ...
    DEBUG_MSGTL( ( "verbose:tcpConnectionTable:tcpConnectionTable_undo_commit", "called\n" ) );
...
{
    DEBUG_MSGTL( ( "verbose:tcpConnectionTable:tcpConnectionState_check_value", "called\n" ) );
...
{
    DEBUG_MSGTL( ( "verbose:tcpConnectionTable:tcpConnectionState_undo_setup",
        "called\n" ) );
    ...
    u_long tcpConnectionState_val )
{
    ...
    DEBUG_MSGTL( ( "verbose:tcpConnectionTable:tcpConnectionState_set",
        "called\n" ) );
...
int tcpConnectionState_undo( tcpConnectionTable_rowreq_ctx* rowreq_ctx )
{
    ...
    DEBUG_MSGTL( ( "verbose:tcpConnectionTable:tcpConnectionState_undo",
        "called\n" ) );
 ...
 */
int tcpConnectionTable_check_dependencies( tcpConnectionTable_rowreq_ctx*
        rowreq_ctx )
{
    int rc = MFD_SUCCESS;

    DEBUG_MSGTL( ( "internal:tcpConnectionTable:tcpConnectionTable_check_dependencies", "called\n" ) );
