 ...
 */
int tcpListenerTable_init_data( tcpListenerTable_registration*
        tcpListenerTable_reg )
{
    DEBUG_MSGTL( ( "verbose:tcpListenerTable:tcpListenerTable_init_data",
        "called\n" ) );
 ...
 */
void tcpListenerTable_container_init( Container_Container** container_ptr_ptr,
    Cache* cache )
{
    DEBUG_MSGTL( ( "verbose:tcpListenerTable:tcpListenerTable_container_init",
        "called\n" ) );
 ...
 */
void tcpListenerTable_container_shutdown( Container_Container* container_ptr )
{
    DEBUG_MSGTL( ( "verbose:tcpListenerTable:tcpListenerTable_container_shutdown", "called\n" ) );
 ...
 */
static void
_add_connection( netsnmp_tcpconn_entry* entry, Container_Container* container )
{
    tcpListenerTable_rowreq_ctx* rowreq_ctx;

    DEBUG_MSGTL( ( "tcpListenerTable:access", "creating new entry\n" ) );
    ...
    if ( ( NULL != rowreq_ctx ) && ( MFD_SUCCESS == tcpListenerTable_indexes_set( rowreq_ctx,
                                                        entry->loc_addr_len,
                                                        ( char* )entry->loc_addr,
                                                        entry->loc_addr_len,
                                                        entry->loc_port ) ) ) {
 ...
 *
 */
int tcpListenerTable_container_load( Container_Container* container )
{
    Container_Container* raw_data = netsnmp_access_tcpconn_container_load( NULL,
        NETSNMP_ACCESS_TCPCONN_LOAD_ONLYLISTEN );

    DEBUG_MSGTL( ( "verbose:tcpListenerTable:tcpListenerTable_container_load",
        "called\n" ) );
     ...
     */
    CONTAINER_FOR_EACH( raw_data, ( Container_FuncObjFunc* )
                                      _add_connection,
        container );
    ...
    DEBUG_MSGT( ( "verbose:tcpListenerTable:tcpListenerTable_cache_load",
 ...
 *
 */
void tcpListenerTable_container_free( Container_Container* container )
{
    DEBUG_MSGTL( ( "verbose:tcpListenerTable:tcpListenerTable_container_free",
        "called\n" ) );
...
{
    DEBUG_MSGTL( ( "verbose:tcpListenerTable:tcpListenerTable_row_prep",
        "called\n" ) );
