...
#include "Table.h"
    ...
    Container_Container *tcpListenerTable_container_get(void);
    ...
    int             tcpListenerTable_index_to_oid(Types_Index * oid_idx,
                                                  ...
                                                  * mib_idx);
    int             tcpListenerTable_index_from_oid(Types_Index *
                                                    oid_idx,
                                                    tcpListenerTable_mib_index
                                                    * mib_idx);
     ...
     */
    void            tcpListenerTable_valid_columns_set(ColumnInfo
                                                       *vc);
