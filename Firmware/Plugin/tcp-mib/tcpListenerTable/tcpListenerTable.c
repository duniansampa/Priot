...
const int tcpListenerTable_oid_size = ASN01_OID_LENGTH( tcpListenerTable_oid );
...
{
    DEBUG_MSGTL( ( "verbose:tcpListenerTable:init_tcpListenerTable",
        "called\n" ) );
...
void initialize_table_tcpListenerTable( void )
{
    ...
    DEBUG_MSGTL( ( "verbose:tcpListenerTable:initialize_table_tcpListenerTable", "called\n" ) );
...
int tcpListenerTable_rowreq_ctx_init( tcpListenerTable_rowreq_ctx* rowreq_ctx,
    void* user_init_ctx )
{
    DEBUG_MSGTL( ( "verbose:tcpListenerTable:tcpListenerTable_rowreq_ctx_init", "called\n" ) );
 ...
 *
 */
void tcpListenerTable_rowreq_ctx_cleanup( tcpListenerTable_rowreq_ctx*
        rowreq_ctx )
{
    DEBUG_MSGTL( ( "verbose:tcpListenerTable:tcpListenerTable_rowreq_ctx_cleanup", "called\n" ) );
...
{
    DEBUG_MSGTL( ( "verbose:tcpListenerTable:tcpListenerTable_pre_request",
        "called\n" ) );
...
int tcpListenerTable_post_request( tcpListenerTable_registration* user_context,
    int rc )
{
    DEBUG_MSGTL( ( "verbose:tcpListenerTable:tcpListenerTable_post_request",
        "called\n" ) );
...
{
    DEBUG_MSGTL( ( "verbose:tcpListenerTable:tcpListenerTable_release_data",
        "called\n" ) );
 ...
 */
int tcpListenerTable_indexes_set_tbl_idx( tcpListenerTable_mib_index* tbl_idx,
    u_long
...
{
    DEBUG_MSGTL( ( "verbose:tcpListenerTable:tcpListenerTable_indexes_set_tbl_idx", "called\n" ) );
     ...
     */
    if ( ( NULL == tbl_idx->tcpListenerLocalAddress ) || ( tbl_idx->tcpListenerLocalAddress_len < ( tcpListenerLocalAddress_val_ptr_len ) ) ) {
...
int tcpListenerTable_indexes_set( tcpListenerTable_rowreq_ctx* rowreq_ctx,
    ...
    u_long tcpListenerLocalPort_val )
{
    DEBUG_MSGTL( ( "verbose:tcpListenerTable:tcpListenerTable_indexes_set",
        "called\n" ) );

    if ( MFD_SUCCESS != tcpListenerTable_indexes_set_tbl_idx( &rowreq_ctx->tbl_idx,
                            tcpListenerLocalAddressType_val,
                            tcpListenerLocalAddress_val_ptr,
                            tcpListenerLocalAddress_val_ptr_len,
    ...
    u_long* tcpListenerProcess_val_ptr )
{
    ...
    Assert_assert( NULL != tcpListenerProcess_val_ptr );

    DEBUG_MSGTL( ( "verbose:tcpListenerTable:tcpListenerProcess_get",
        "called\n" ) );
