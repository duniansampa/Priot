...
#include "Table.h"
    ...
    Container_Container *ipDefaultRouterTable_container_get(void);
    ...
    int             ipDefaultRouterTable_index_to_oid(Types_Index *
                                                      oid_idx,
                                                      ipDefaultRouterTable_mib_index
                                                      * mib_idx);
    int             ipDefaultRouterTable_index_from_oid(Types_Index *
                                                        oid_idx,
                                                        ipDefaultRouterTable_mib_index
                                                        * mib_idx);
     ...
     */
    void           
        ipDefaultRouterTable_valid_columns_set(ColumnInfo *vc);
