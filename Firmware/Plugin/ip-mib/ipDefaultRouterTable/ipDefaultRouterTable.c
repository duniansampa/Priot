...
{
    DEBUG_MSGTL( ( "verbose:ipDefaultRouterTable:init_ipDefaultRouterTable",
        "called\n" ) );
...
void initialize_table_ipDefaultRouterTable( void )
{
    ...
    DEBUG_MSGTL( ( "verbose:ipDefaultRouterTable:initialize_table_ipDefaultRouterTable", "called\n" ) );
     ...
     */
    _ipDefaultRouterTable_initialize_interface( ipDefaultRouterTable_user_context_p, flags );
} /* initialize_table_ipDefaultRouterTable */
 ...
 */
int ipDefaultRouterTable_rowreq_ctx_init( ipDefaultRouterTable_rowreq_ctx*
                                              rowreq_ctx,
    void* user_init_ctx )
{
    DEBUG_MSGTL( ( "verbose:ipDefaultRouterTable:ipDefaultRouterTable_rowreq_ctx_init", "called\n" ) );
 ...
 *
 */
void ipDefaultRouterTable_rowreq_ctx_cleanup( ipDefaultRouterTable_rowreq_ctx*
        rowreq_ctx )
{
    DEBUG_MSGTL( ( "verbose:ipDefaultRouterTable:ipDefaultRouterTable_rowreq_ctx_cleanup", "called\n" ) );
 ...
 */
int ipDefaultRouterTable_pre_request( ipDefaultRouterTable_registration*
        user_context )
{
    DEBUG_MSGTL( ( "verbose:ipDefaultRouterTable:ipDefaultRouterTable_pre_request", "called\n" ) );
...
int ipDefaultRouterTable_post_request( ipDefaultRouterTable_registration*
    ...
    int rc )
{
    DEBUG_MSGTL( ( "verbose:ipDefaultRouterTable:ipDefaultRouterTable_post_request", "called\n" ) );
