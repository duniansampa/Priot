 ...
 */
int ipDefaultRouterTable_init_data( ipDefaultRouterTable_registration*
        ipDefaultRouterTable_reg )
{
    DEBUG_MSGTL( ( "verbose:ipDefaultRouterTable:ipDefaultRouterTable_init_data", "called\n" ) );
 ...
 */
void ipDefaultRouterTable_container_init( Container_Container** container_ptr_ptr,
    Cache* cache )
{
    DEBUG_MSGTL( ( "verbose:ipDefaultRouterTable:ipDefaultRouterTable_container_init", "called\n" ) );
 ...
 */
void ipDefaultRouterTable_container_shutdown( Container_Container* container_ptr )
{
    DEBUG_MSGTL( ( "verbose:ipDefaultRouterTable:ipDefaultRouterTable_container_shutdown", "called\n" ) );
...
_check_entry_for_updates( ipDefaultRouterTable_rowreq_ctx* rowreq_ctx,
    void** magic )
{
    Container_Container* defaultrouter_container = ( Container_Container* )magic[ 0 ];
    Container_Container* to_delete = ( Container_Container* )magic[ 1 ];

    /*
     * check for matching entry using secondary index.
     */
    netsnmp_defaultrouter_entry* defaultrouter_entry = ( netsnmp_defaultrouter_entry* )
        CONTAINER_FIND( defaultrouter_container, rowreq_ctx->data );
    if ( NULL == defaultrouter_entry ) {
        DEBUG_MSGTL( ( "ipDefaultRouterTable:access", "removing missing entry\n" ) );
        ...
        DEBUG_MSGTL( ( "ipDefaultRouterTable:access", "updating existing entry\n" ) );
    ...
    Container_Container* container )
{
    ...
    DEBUG_MSGTL( ( "ipDefaultRouterTable:access", "creating new entry\n" ) );

    Assert_assert( NULL != defaultrouter_entry );
    ...
    rowreq_ctx = ipDefaultRouterTable_allocate_rowreq_ctx( defaultrouter_entry,
        NULL );
    if ( ( NULL != rowreq_ctx ) && ( MFD_SUCCESS == ipDefaultRouterTable_indexes_set( rowreq_ctx,
        ...
        if ( CONTAINER_INSERT( container, rowreq_ctx ) < 0 ) {
            DEBUG_MSGTL( ( "ipAddressTable:access",
 ...
 *
 */
int ipDefaultRouterTable_container_load( Container_Container* container )
{
    Container_Container* defaultrouter_container;
    void* tmp_ptr[ 2 ];

    DEBUG_MSGTL( ( "verbose:ipDefaultRouterTable:ipDefaultRouterTable_container_load", "called\n" ) );
     ...
     * the container.
     */
    defaultrouter_container = netsnmp_access_defaultrouter_container_load( NULL,
    ...
    CONTAINER_FOR_EACH( container,
        ( Container_FuncObjFunc* )_check_entry_for_updates,
        tmp_ptr );
    ...
    DEBUG_MSGT( ( "verbose:ipDefaultRouterTable:ipDefaultRouterTable_container_load",
 ...
 *
 */
void ipDefaultRouterTable_container_free( Container_Container* container )
{
    DEBUG_MSGTL( ( "verbose:ipDefaultRouterTable:ipDefaultRouterTable_container_free", "called\n" ) );
...
{
    DEBUG_MSGTL( ( "verbose:ipDefaultRouterTable:ipDefaultRouterTable_row_prep", "called\n" ) );
