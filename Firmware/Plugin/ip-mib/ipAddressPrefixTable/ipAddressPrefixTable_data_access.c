 ...
 */
int ipAddressPrefixTable_init_data( ipAddressPrefixTable_registration*
        ipAddressPrefixTable_reg )
{
    DEBUG_MSGTL( ( "verbose:ipAddressPrefixTable:ipAddressPrefixTable_init_data", "called\n" ) );
 ...
 */
void ipAddressPrefixTable_container_init( Container_Container** container_ptr_ptr,
    Cache* cache )
{
    DEBUG_MSGTL( ( "verbose:ipAddressPrefixTable:ipAddressPrefixTable_container_init", "called\n" ) );
 ...
 */
void ipAddressPrefixTable_container_shutdown( Container_Container* container_ptr )
{
    DEBUG_MSGTL( ( "verbose:ipAddressPrefixTable:ipAddressPrefixTable_container_shutdown", "called\n" ) );
 ...
 *
 */
int ipAddressPrefixTable_container_load( Container_Container* container )
{
    ...
    Container_Iterator* addr_it;
    int count = 0;
    u_char tmp_pfx[ NETSNMP_ACCESS_IPADDRESS_BUF_SIZE ];

    DEBUG_MSGTL( ( "verbose:ipAddressPrefixTable:ipAddressPrefixTable_container_load", "called\n" ) );

    addr_container = ipAddressTable_container_get();
    if ( NULL == addr_container ) {
        DEBUG_MSGTL( ( "ipAddressPrefixTable:container_load",
     ...
     * the container.
     */
    for ( addr_rowreq_ctx = ( ipAddressTable_rowreq_ctx* )CONTAINER_ITERATOR_FIRST( addr_it );
          addr_rowreq_ctx; addr_rowreq_ctx = ( ipAddressTable_rowreq_ctx* )CONTAINER_ITERATOR_NEXT( addr_it ) ) {
        ...
        netsnmp_ipaddress_flags_copy( &rowreq_ctx->data.ipAddressPrefixAdvPreferredLifetime,
        ...
        if ( MFD_SUCCESS != ipAddressPrefixTable_indexes_set( rowreq_ctx,
                                addr_rowreq_ctx->data->if_index,
                                addr_rowreq_ctx->tbl_idx.ipAddressAddrType, tmp_pfx,
                                addr_rowreq_ctx->data->ia_address_len,
                                addr_rowreq_ctx->data->ia_prefix_len ) ) {
            Logger_log( LOGGER_PRIORITY_ERR,
        ...
        tmp_rowreq_ctx = ( ipAddressPrefixTable_rowreq_ctx* )CONTAINER_FIND( container, rowreq_ctx );
         ...
         */
        netsnmp_ipaddress_prefix_origin_copy( &rowreq_ctx->data.ipAddressPrefixOrigin,
            addr_rowreq_ctx->data->ia_origin,
            addr_rowreq_ctx->data->flags,
    ...
    CONTAINER_ITERATOR_RELEASE( addr_it );

    DEBUG_MSGT( ( "verbose:ipAddressPrefixTable:ipAddressPrefixTable_container_load", "inserted %d records\n", count ) );
 ...
 *
 */
void ipAddressPrefixTable_container_free( Container_Container* container )
{
    DEBUG_MSGTL( ( "verbose:ipAddressPrefixTable:ipAddressPrefixTable_container_free", "called\n" ) );
...
{
    DEBUG_MSGTL( ( "verbose:ipAddressPrefixTable:ipAddressPrefixTable_row_prep", "called\n" ) );
