...
{
    DEBUG_MSGTL( ( "verbose:ipIfStatsTable:init_ipIfStatsTable", "called\n" ) );
...
void initialize_table_ipIfStatsTable( void )
{
    ...
    DEBUG_MSGTL( ( "verbose:ipIfStatsTable:initialize_table_ipIfStatsTable",
        "called\n" ) );
...
int ipIfStatsTable_rowreq_ctx_init( ipIfStatsTable_rowreq_ctx* rowreq_ctx,
    void* user_init_ctx )
{
    DEBUG_MSGTL( ( "verbose:ipIfStatsTable:ipIfStatsTable_rowreq_ctx_init",
        "called\n" ) );
...
{
    DEBUG_MSGTL( ( "verbose:ipIfStatsTable:ipIfStatsTable_rowreq_ctx_cleanup",
        "called\n" ) );
...
{
    DEBUG_MSGTL( ( "verbose:ipIfStatsTable:ipIfStatsTable_pre_request",
        "called\n" ) );
...
int ipIfStatsTable_post_request( ipIfStatsTable_registration* user_context,
    int rc )
{
    DEBUG_MSGTL( ( "verbose:ipIfStatsTable:ipIfStatsTable_post_request",
        "called\n" ) );
