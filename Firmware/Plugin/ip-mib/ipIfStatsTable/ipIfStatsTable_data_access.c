...
{
    DEBUG_MSGTL( ( "verbose:ipIfStatsTable:ipIfStatsTable_init_data",
        "called\n" ) );
 ...
 */
void ipIfStatsTable_container_init( Container_Container** container_ptr_ptr,
    Cache* cache )
{
    DEBUG_MSGTL( ( "verbose:ipIfStatsTable:ipIfStatsTable_container_init",
        "called\n" ) );
     ...
     * assigned...
     */
    *container_ptr_ptr = Container_find( "ipIfStatsTable:tableContainer" );
    if ( NULL != *container_ptr_ptr ) {
        ( *container_ptr_ptr )->containerName = strdup( "ipIfStatsTable" );
    ...
    Container_Container* stats )
{
    ...
    if ( NULL == ifstats_entry ) {
        DEBUG_MSGTL( ( "ipIfStatsTable:access",
        ...
        if ( 1 == rowreq_ctx->known_missing ) {
            ...
            rowreq_ctx->ipIfStatsDiscontinuityTime = Agent_getAgentUptime();
            ipIfStatsTable_lastChange_set( Agent_getAgentUptime() );
        }
    ...
    Container_Container* container )
{
    ...
    DEBUG_MSGTL( ( "ipIfStatsTable:access", "creating new entry\n" ) );

    Assert_assert( NULL != ifstats_entry );
 ...
 */
void ipIfStatsTable_container_shutdown( Container_Container* container_ptr )
{
    DEBUG_MSGTL( ( "verbose:ipIfStatsTable:ipIfStatsTable_container_shutdown",
        "called\n" ) );
 ...
 *
 */
int ipIfStatsTable_container_load( Container_Container* container )
{
    Container_Container* stats;

    DEBUG_MSGTL( ( "verbose:ipIfStatsTable:ipIfStatsTable_container_load",
        "called\n" ) );
    ...
    DEBUG_MSGT( ( "verbose:ipIfStatsTable:ipIfStatsTable_container_load",
 ...
 *
 */
void ipIfStatsTable_container_free( Container_Container* container )
{
    DEBUG_MSGTL( ( "verbose:ipIfStatsTable:ipIfStatsTable_container_free",
        "called\n" ) );
...
{
    DEBUG_MSGTL( ( "verbose:ipIfStatsTable:ipIfStatsTable_row_prep",
        "called\n" ) );
