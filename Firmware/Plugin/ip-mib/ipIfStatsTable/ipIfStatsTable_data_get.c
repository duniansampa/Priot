...
{
    DEBUG_MSGTL( ( "verbose:ipIfStatsTable:ipIfStatsTable_release_data",
        "called\n" ) );
...
{
    DEBUG_MSGTL( ( "verbose:ipIfStatsTable:ipIfStatsTable_indexes_set_tbl_idx", "called\n" ) );
...
int ipIfStatsTable_indexes_set( ipIfStatsTable_rowreq_ctx* rowreq_ctx,
    ...
    long ipIfStatsIfIndex_val )
{
    DEBUG_MSGTL( ( "verbose:ipIfStatsTable:ipIfStatsTable_indexes_set",
        "called\n" ) );

    if ( MFD_SUCCESS != ipIfStatsTable_indexes_set_tbl_idx( &rowreq_ctx->tbl_idx,
    ...
    u_long* ipIfStatsInReceives_val_ptr )
{
    ...
    Assert_assert( NULL != ipIfStatsInReceives_val_ptr );

    DEBUG_MSGTL( ( "verbose:ipIfStatsTable:ipIfStatsInReceives_get",
        "called\n" ) );
...
int ipIfStatsHCInReceives_get( ipIfStatsTable_rowreq_ctx* rowreq_ctx,
    Integer64* ipIfStatsHCInReceives_val_ptr )
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ipIfStatsHCInReceives_val_ptr );
    ...
    ( *ipIfStatsHCInReceives_val_ptr ).low = rowreq_ctx->data->stats.HCInReceives.low;
    ( *ipIfStatsHCInReceives_val_ptr ).high = rowreq_ctx->data->stats.HCInReceives.high;
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ipIfStatsInOctets_val_ptr );

    DEBUG_MSGTL( ( "verbose:ipIfStatsTable:ipIfStatsInOctets_get",
        "called\n" ) );
...
int ipIfStatsHCInOctets_get( ipIfStatsTable_rowreq_ctx* rowreq_ctx,
    Integer64* ipIfStatsHCInOctets_val_ptr )
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ipIfStatsHCInOctets_val_ptr );
    ...
    ( *ipIfStatsHCInOctets_val_ptr ).high = rowreq_ctx->data->stats.HCInOctets.high;
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ipIfStatsInHdrErrors_val_ptr );

    DEBUG_MSGTL( ( "verbose:ipIfStatsTable:ipIfStatsInHdrErrors_get",
        "called\n" ) );
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ipIfStatsInNoRoutes_val_ptr );

    DEBUG_MSGTL( ( "verbose:ipIfStatsTable:ipIfStatsInNoRoutes_get",
        "called\n" ) );
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ipIfStatsInAddrErrors_val_ptr );

    DEBUG_MSGTL( ( "verbose:ipIfStatsTable:ipIfStatsInAddrErrors_get",
        "called\n" ) );
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ipIfStatsInUnknownProtos_val_ptr );

    DEBUG_MSGTL( ( "verbose:ipIfStatsTable:ipIfStatsInUnknownProtos_get",
        "called\n" ) );
    ...
    ( *ipIfStatsInUnknownProtos_val_ptr ) = rowreq_ctx->data->stats.InUnknownProtos;
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ipIfStatsInTruncatedPkts_val_ptr );

    DEBUG_MSGTL( ( "verbose:ipIfStatsTable:ipIfStatsInTruncatedPkts_get",
        "called\n" ) );
    ...
    ( *ipIfStatsInTruncatedPkts_val_ptr ) = rowreq_ctx->data->stats.InTruncatedPkts;
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ipIfStatsInForwDatagrams_val_ptr );

    DEBUG_MSGTL( ( "verbose:ipIfStatsTable:ipIfStatsInForwDatagrams_get",
        "called\n" ) );
    ...
    ( *ipIfStatsInForwDatagrams_val_ptr ) = rowreq_ctx->data->stats.HCInForwDatagrams.low;
 ...
 * @retval MFD_ERROR           : Any other error
 */
int ipIfStatsHCInForwDatagrams_get( ipIfStatsTable_rowreq_ctx* rowreq_ctx,
    Integer64* ipIfStatsHCInForwDatagrams_val_ptr )
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ipIfStatsHCInForwDatagrams_val_ptr );
    ...
    ( *ipIfStatsHCInForwDatagrams_val_ptr ).low = rowreq_ctx->data->stats.HCInForwDatagrams.low;
    ( *ipIfStatsHCInForwDatagrams_val_ptr ).high = rowreq_ctx->data->stats.HCInForwDatagrams.high;
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ipIfStatsReasmReqds_val_ptr );

    DEBUG_MSGTL( ( "verbose:ipIfStatsTable:ipIfStatsReasmReqds_get",
        "called\n" ) );
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ipIfStatsReasmOKs_val_ptr );

    DEBUG_MSGTL( ( "verbose:ipIfStatsTable:ipIfStatsReasmOKs_get",
        "called\n" ) );
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ipIfStatsReasmFails_val_ptr );

    DEBUG_MSGTL( ( "verbose:ipIfStatsTable:ipIfStatsReasmFails_get",
        "called\n" ) );
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ipIfStatsInDiscards_val_ptr );

    DEBUG_MSGTL( ( "verbose:ipIfStatsTable:ipIfStatsInDiscards_get",
        "called\n" ) );
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ipIfStatsInDelivers_val_ptr );

    DEBUG_MSGTL( ( "verbose:ipIfStatsTable:ipIfStatsInDelivers_get",
        "called\n" ) );
...
int ipIfStatsHCInDelivers_get( ipIfStatsTable_rowreq_ctx* rowreq_ctx,
    Integer64* ipIfStatsHCInDelivers_val_ptr )
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ipIfStatsHCInDelivers_val_ptr );
    ...
    ( *ipIfStatsHCInDelivers_val_ptr ).low = rowreq_ctx->data->stats.HCInDelivers.low;
    ( *ipIfStatsHCInDelivers_val_ptr ).high = rowreq_ctx->data->stats.HCInDelivers.high;
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ipIfStatsOutRequests_val_ptr );

    DEBUG_MSGTL( ( "verbose:ipIfStatsTable:ipIfStatsOutRequests_get",
        "called\n" ) );
...
int ipIfStatsHCOutRequests_get( ipIfStatsTable_rowreq_ctx* rowreq_ctx,
    Integer64* ipIfStatsHCOutRequests_val_ptr )
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ipIfStatsHCOutRequests_val_ptr );
    ...
    ( *ipIfStatsHCOutRequests_val_ptr ).low = rowreq_ctx->data->stats.HCOutRequests.low;
    ( *ipIfStatsHCOutRequests_val_ptr ).high = rowreq_ctx->data->stats.HCOutRequests.high;
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ipIfStatsOutForwDatagrams_val_ptr );

    DEBUG_MSGTL( ( "verbose:ipIfStatsTable:ipIfStatsOutForwDatagrams_get",
        "called\n" ) );
    ...
    ( *ipIfStatsOutForwDatagrams_val_ptr ) = rowreq_ctx->data->stats.HCOutForwDatagrams.low;
 ...
 * @retval MFD_ERROR           : Any other error
 */
int ipIfStatsHCOutForwDatagrams_get( ipIfStatsTable_rowreq_ctx* rowreq_ctx,
    Integer64* ipIfStatsHCOutForwDatagrams_val_ptr )
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ipIfStatsHCOutForwDatagrams_val_ptr );
    ...
    ( *ipIfStatsHCOutForwDatagrams_val_ptr ).low = rowreq_ctx->data->stats.HCOutForwDatagrams.low;
    ( *ipIfStatsHCOutForwDatagrams_val_ptr ).high = rowreq_ctx->data->stats.HCOutForwDatagrams.high;
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ipIfStatsOutDiscards_val_ptr );

    DEBUG_MSGTL( ( "verbose:ipIfStatsTable:ipIfStatsOutDiscards_get",
        "called\n" ) );
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ipIfStatsOutFragReqds_val_ptr );

    DEBUG_MSGTL( ( "verbose:ipIfStatsTable:ipIfStatsOutFragReqds_get",
        "called\n" ) );
    ...
    ( *ipIfStatsOutFragReqds_val_ptr ) = rowreq_ctx->data->stats.HCOutFragReqds.low;
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ipIfStatsOutFragOKs_val_ptr );

    DEBUG_MSGTL( ( "verbose:ipIfStatsTable:ipIfStatsOutFragOKs_get",
        "called\n" ) );
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ipIfStatsOutFragFails_val_ptr );

    DEBUG_MSGTL( ( "verbose:ipIfStatsTable:ipIfStatsOutFragFails_get",
        "called\n" ) );
    ...
    ( *ipIfStatsOutFragFails_val_ptr ) = rowreq_ctx->data->stats.HCOutFragFails.low;
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ipIfStatsOutFragCreates_val_ptr );

    DEBUG_MSGTL( ( "verbose:ipIfStatsTable:ipIfStatsOutFragCreates_get",
        "called\n" ) );
    ...
    ( *ipIfStatsOutFragCreates_val_ptr ) = rowreq_ctx->data->stats.HCOutFragCreates.low;
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ipIfStatsOutTransmits_val_ptr );

    DEBUG_MSGTL( ( "verbose:ipIfStatsTable:ipIfStatsOutTransmits_get",
        "called\n" ) );
    ...
    ( *ipIfStatsOutTransmits_val_ptr ) = rowreq_ctx->data->stats.HCOutTransmits.low;
 ...
 * @retval MFD_ERROR           : Any other error
 */
int ipIfStatsHCOutTransmits_get( ipIfStatsTable_rowreq_ctx* rowreq_ctx,
    Integer64* ipIfStatsHCOutTransmits_val_ptr )
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ipIfStatsHCOutTransmits_val_ptr );
    ...
    ( *ipIfStatsHCOutTransmits_val_ptr ).low = rowreq_ctx->data->stats.HCOutTransmits.low;
    ( *ipIfStatsHCOutTransmits_val_ptr ).high = rowreq_ctx->data->stats.HCOutTransmits.high;
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ipIfStatsOutOctets_val_ptr );

    DEBUG_MSGTL( ( "verbose:ipIfStatsTable:ipIfStatsOutOctets_get",
        "called\n" ) );
...
int ipIfStatsHCOutOctets_get( ipIfStatsTable_rowreq_ctx* rowreq_ctx,
    Integer64* ipIfStatsHCOutOctets_val_ptr )
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ipIfStatsHCOutOctets_val_ptr );
    ...
    ( *ipIfStatsHCOutOctets_val_ptr ).low = rowreq_ctx->data->stats.HCOutOctets.low;
    ( *ipIfStatsHCOutOctets_val_ptr ).high = rowreq_ctx->data->stats.HCOutOctets.high;
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ipIfStatsInMcastPkts_val_ptr );

    DEBUG_MSGTL( ( "verbose:ipIfStatsTable:ipIfStatsInMcastPkts_get",
        "called\n" ) );
...
int ipIfStatsHCInMcastPkts_get( ipIfStatsTable_rowreq_ctx* rowreq_ctx,
    Integer64* ipIfStatsHCInMcastPkts_val_ptr )
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ipIfStatsHCInMcastPkts_val_ptr );
    ...
    ( *ipIfStatsHCInMcastPkts_val_ptr ).low = rowreq_ctx->data->stats.HCInMcastPkts.low;
    ( *ipIfStatsHCInMcastPkts_val_ptr ).high = rowreq_ctx->data->stats.HCInMcastPkts.high;
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ipIfStatsInMcastOctets_val_ptr );

    DEBUG_MSGTL( ( "verbose:ipIfStatsTable:ipIfStatsInMcastOctets_get",
        "called\n" ) );
    ...
    ( *ipIfStatsInMcastOctets_val_ptr ) = rowreq_ctx->data->stats.HCInMcastOctets.low;
 ...
 * @retval MFD_ERROR           : Any other error
 */
int ipIfStatsHCInMcastOctets_get( ipIfStatsTable_rowreq_ctx* rowreq_ctx,
    Integer64* ipIfStatsHCInMcastOctets_val_ptr )
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ipIfStatsHCInMcastOctets_val_ptr );
    ...
    ( *ipIfStatsHCInMcastOctets_val_ptr ).low = rowreq_ctx->data->stats.HCInMcastOctets.low;
    ( *ipIfStatsHCInMcastOctets_val_ptr ).high = rowreq_ctx->data->stats.HCInMcastOctets.high;
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ipIfStatsOutMcastPkts_val_ptr );

    DEBUG_MSGTL( ( "verbose:ipIfStatsTable:ipIfStatsOutMcastPkts_get",
        "called\n" ) );
    ...
    ( *ipIfStatsOutMcastPkts_val_ptr ) = rowreq_ctx->data->stats.HCOutMcastPkts.low;
 ...
 * @retval MFD_ERROR           : Any other error
 */
int ipIfStatsHCOutMcastPkts_get( ipIfStatsTable_rowreq_ctx* rowreq_ctx,
    Integer64* ipIfStatsHCOutMcastPkts_val_ptr )
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ipIfStatsHCOutMcastPkts_val_ptr );
    ...
    ( *ipIfStatsHCOutMcastPkts_val_ptr ).low = rowreq_ctx->data->stats.HCOutMcastPkts.low;
    ( *ipIfStatsHCOutMcastPkts_val_ptr ).high = rowreq_ctx->data->stats.HCOutMcastPkts.high;
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ipIfStatsOutMcastOctets_val_ptr );

    DEBUG_MSGTL( ( "verbose:ipIfStatsTable:ipIfStatsOutMcastOctets_get",
        "called\n" ) );
    ...
    ( *ipIfStatsOutMcastOctets_val_ptr ) = rowreq_ctx->data->stats.HCOutMcastOctets.low;
 ...
 * @retval MFD_ERROR           : Any other error
 */
int ipIfStatsHCOutMcastOctets_get( ipIfStatsTable_rowreq_ctx* rowreq_ctx,
    Integer64* ipIfStatsHCOutMcastOctets_val_ptr )
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ipIfStatsHCOutMcastOctets_val_ptr );
    ...
    ( *ipIfStatsHCOutMcastOctets_val_ptr ).low = rowreq_ctx->data->stats.HCOutMcastOctets.low;
    ( *ipIfStatsHCOutMcastOctets_val_ptr ).high = rowreq_ctx->data->stats.HCOutMcastOctets.high;
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ipIfStatsInBcastPkts_val_ptr );

    DEBUG_MSGTL( ( "verbose:ipIfStatsTable:ipIfStatsInBcastPkts_get",
        "called\n" ) );
...
int ipIfStatsHCInBcastPkts_get( ipIfStatsTable_rowreq_ctx* rowreq_ctx,
    Integer64* ipIfStatsHCInBcastPkts_val_ptr )
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ipIfStatsHCInBcastPkts_val_ptr );
    ...
    ( *ipIfStatsHCInBcastPkts_val_ptr ).low = rowreq_ctx->data->stats.HCInBcastPkts.low;
    ( *ipIfStatsHCInBcastPkts_val_ptr ).high = rowreq_ctx->data->stats.HCInBcastPkts.high;
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ipIfStatsOutBcastPkts_val_ptr );

    DEBUG_MSGTL( ( "verbose:ipIfStatsTable:ipIfStatsOutBcastPkts_get",
        "called\n" ) );
    ...
    ( *ipIfStatsOutBcastPkts_val_ptr ) = rowreq_ctx->data->stats.HCOutBcastPkts.low;
 ...
 * @retval MFD_ERROR           : Any other error
 */
int ipIfStatsHCOutBcastPkts_get( ipIfStatsTable_rowreq_ctx* rowreq_ctx,
    Integer64* ipIfStatsHCOutBcastPkts_val_ptr )
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ipIfStatsHCOutBcastPkts_val_ptr );
    ...
    ( *ipIfStatsHCOutBcastPkts_val_ptr ).low = rowreq_ctx->data->stats.HCOutBcastPkts.low;
    ( *ipIfStatsHCOutBcastPkts_val_ptr ).high = rowreq_ctx->data->stats.HCOutBcastPkts.high;
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ipIfStatsDiscontinuityTime_val_ptr );

    DEBUG_MSGTL( ( "verbose:ipIfStatsTable:ipIfStatsDiscontinuityTime_get",
        "called\n" ) );
    ...
    ( *ipIfStatsDiscontinuityTime_val_ptr ) = rowreq_ctx->ipIfStatsDiscontinuityTime;
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ipIfStatsRefreshRate_val_ptr );

    DEBUG_MSGTL( ( "verbose:ipIfStatsTable:ipIfStatsRefreshRate_get",
        "called\n" ) );
