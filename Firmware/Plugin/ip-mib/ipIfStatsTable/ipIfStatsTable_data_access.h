...
#define IPIFSTATSTABLE_CACHE_TIMEOUT   60
    ...
    void            ipIfStatsTable_container_init(Container_Container **
                                                  container_ptr_ptr,
                                                  Cache * cache);
    void            ipIfStatsTable_container_shutdown(Container_Container *
                                                      container_ptr);

    int             ipIfStatsTable_container_load(Container_Container *
                                                  container);
    void            ipIfStatsTable_container_free(Container_Container *
                                                  container);

    int             ipIfStatsTable_cache_load(Container_Container *
                                              container);
    void            ipIfStatsTable_cache_free(Container_Container *
                                              container);
