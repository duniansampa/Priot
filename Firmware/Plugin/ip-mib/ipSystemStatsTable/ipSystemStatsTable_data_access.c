 ...
 */
int ipSystemStatsTable_init_data( ipSystemStatsTable_registration*
        ipSystemStatsTable_reg )
{
    DEBUG_MSGTL( ( "verbose:ipSystemStatsTable:ipSystemStatsTable_init_data",
        "called\n" ) );
 ...
 */
void ipSystemStatsTable_container_init( Container_Container** container_ptr_ptr,
    Cache* cache )
{
    DEBUG_MSGTL( ( "verbose:ipSystemStatsTable:ipSystemStatsTable_container_init", "called\n" ) );
    ...
    *container_ptr_ptr = Container_find( "ipSystemStatsTable:tableContainer" );
    if ( NULL != *container_ptr_ptr )
        ( *container_ptr_ptr )->containerName = strdup( "ipSystemStatsTable" );
    ...
    Container_Container* stats )
{
    ...
    if ( NULL == systemstats_entry ) {
        DEBUG_MSGTL( ( "ipSystemStatsTable:access",
        ...
        if ( 1 == rowreq_ctx->known_missing ) {
            ...
            rowreq_ctx->ipSystemStatsDiscontinuityTime = Agent_getAgentUptime();
        }
    ...
    Container_Container* container )
{
    ...
    DEBUG_MSGTL( ( "ipSystemStatsTable:access", "creating new entry\n" ) );

    Assert_assert( NULL != systemstats_entry );
    Assert_assert( NULL != container );

    /*
     * allocate an row context and set the index(es)
     */
    rowreq_ctx = ipSystemStatsTable_allocate_rowreq_ctx( systemstats_entry, NULL );
    if ( ( NULL != rowreq_ctx )
        && ( MFD_SUCCESS == ipSystemStatsTable_indexes_set( rowreq_ctx,
                                systemstats_entry->index[ 0 ] ) ) ) {
 ...
 */
void ipSystemStatsTable_container_shutdown( Container_Container* container_ptr )
{
    DEBUG_MSGTL( ( "verbose:ipSystemStatsTable:ipSystemStatsTable_container_shutdown", "called\n" ) );
 ...
 *
 */
int ipSystemStatsTable_container_load( Container_Container* container )
{
    Container_Container* stats = netsnmp_access_systemstats_container_load( NULL, 0 );

    DEBUG_MSGTL( ( "verbose:ipSystemStatsTable:ipSystemStatsTable_cache_load",
        "called\n" ) );
     ...
     */
    CONTAINER_FOR_EACH( stats, ( Container_FuncObjFunc* )
                                   _add_new,
        container );
    ...
    DEBUG_MSGT( ( "verbose:ipSystemStatsTable:ipSystemStatsTable_cache_load",
 ...
 *
 */
void ipSystemStatsTable_container_free( Container_Container* container )
{
    DEBUG_MSGTL( ( "verbose:ipSystemStatsTable:ipSystemStatsTable_container_free", "called\n" ) );
...
{
    DEBUG_MSGTL( ( "verbose:ipSystemStatsTable:ipSystemStatsTable_row_prep",
        "called\n" ) );
