...
#include "Table.h"
    ...
    Container_Container *ipSystemStatsTable_container_get(void);
    ...
    int             ipSystemStatsTable_index_to_oid(Types_Index *
                                                    oid_idx,
                                                    ipSystemStatsTable_mib_index
                                                    * mib_idx);
    int             ipSystemStatsTable_index_from_oid(Types_Index *
                                                      oid_idx,
                                                      ipSystemStatsTable_mib_index
                                                      * mib_idx);
    ...
    void
             ...
             ipSystemStatsTable_valid_columns_set(ColumnInfo *vc);
