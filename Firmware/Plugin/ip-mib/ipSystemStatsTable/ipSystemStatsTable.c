...
{
    DEBUG_MSGTL( ( "verbose:ipSystemStatsTable:init_ipSystemStatsTable",
        "called\n" ) );
...
void initialize_table_ipSystemStatsTable( void )
{
    ...
    DEBUG_MSGTL( ( "verbose:ipSystemStatsTable:initialize_table_ipSystemStatsTable", "called\n" ) );
     ...
     */
    _ipSystemStatsTable_initialize_interface( ipSystemStatsTable_user_context_p, flags );
} /* initialize_table_ipSystemStatsTable */
...
int ipSystemStatsTable_rowreq_ctx_init( ipSystemStatsTable_rowreq_ctx*
    ...
    void* user_init_ctx )
{
    DEBUG_MSGTL( ( "verbose:ipSystemStatsTable:ipSystemStatsTable_rowreq_ctx_init", "called\n" ) );
 ...
 *
 */
void ipSystemStatsTable_rowreq_ctx_cleanup( ipSystemStatsTable_rowreq_ctx*
        rowreq_ctx )
{
    DEBUG_MSGTL( ( "verbose:ipSystemStatsTable:ipSystemStatsTable_rowreq_ctx_cleanup", "called\n" ) );
...
int ipSystemStatsTable_pre_request( ipSystemStatsTable_registration*
        user_context )
{
    DEBUG_MSGTL( ( "verbose:ipSystemStatsTable:ipSystemStatsTable_pre_request", "called\n" ) );
...
int ipSystemStatsTable_post_request( ipSystemStatsTable_registration*
    ...
    int rc )
{
    DEBUG_MSGTL( ( "verbose:ipSystemStatsTable:ipSystemStatsTable_post_request", "called\n" ) );
...
{
    DEBUG_MSGTL( ( "verbose:ipSystemStatsTable:ipSystemStatsTable_release_data", "called\n" ) );
...
{
    DEBUG_MSGTL( ( "verbose:ipSystemStatsTable:ipSystemStatsTable_indexes_set_tbl_idx", "called\n" ) );
...
int ipSystemStatsTable_indexes_set( ipSystemStatsTable_rowreq_ctx* rowreq_ctx,
    u_long ipSystemStatsIPVersion_val )
{
    DEBUG_MSGTL( ( "verbose:ipSystemStatsTable:ipSystemStatsTable_indexes_set", "called\n" ) );

    if ( MFD_SUCCESS != ipSystemStatsTable_indexes_set_tbl_idx( &rowreq_ctx->tbl_idx,
 ...
 * The net-snmp type is ASN01_COUNTER. The C type decl is u_long (u_long)
 */
/**
    ...
    u_long* ipSystemStatsInReceives_val_ptr )
{
    ...
    Assert_assert( NULL != ipSystemStatsInReceives_val_ptr );

    DEBUG_MSGTL( ( "verbose:ipSystemStatsTable:ipSystemStatsInReceives_get",
        "called\n" ) );
    ...
    ( *ipSystemStatsInReceives_val_ptr ) = rowreq_ctx->data->stats.HCInReceives.low;
 ...
 * The net-snmp type is ASN01_COUNTER64. The C type decl is Int64_U64 (Int64_U64)
 */
/**
 ...
 *        Pointer to storage for a Int64_U64 variable
 *
 * @retval MFD_SUCCESS         : success
 * @retval MFD_SKIP            : skip this node (no value for now)
 * @retval MFD_ERROR           : Any other error
    ...
    Integer64* ipSystemStatsHCInReceives_val_ptr )
{
    ...
    ( *ipSystemStatsHCInReceives_val_ptr ).low = rowreq_ctx->data->stats.HCInReceives.low;
    ( *ipSystemStatsHCInReceives_val_ptr ).high = rowreq_ctx->data->stats.HCInReceives.high;
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ipSystemStatsInOctets_val_ptr );

    DEBUG_MSGTL( ( "verbose:ipSystemStatsTable:ipSystemStatsInOctets_get",
        "called\n" ) );
    ...
    Integer64* ipSystemStatsHCInOctets_val_ptr )
{
    ...
    ( *ipSystemStatsHCInOctets_val_ptr ).low = rowreq_ctx->data->stats.HCInOctets.low;
    ( *ipSystemStatsHCInOctets_val_ptr ).high = rowreq_ctx->data->stats.HCInOctets.high;
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ipSystemStatsInHdrErrors_val_ptr );

    DEBUG_MSGTL( ( "verbose:ipSystemStatsTable:ipSystemStatsInHdrErrors_get",
        "called\n" ) );
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ipSystemStatsInNoRoutes_val_ptr );

    DEBUG_MSGTL( ( "verbose:ipSystemStatsTable:ipSystemStatsInNoRoutes_get",
        "called\n" ) );
    ...
    ( *ipSystemStatsInNoRoutes_val_ptr ) = rowreq_ctx->data->stats.HCInNoRoutes.low;
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ipSystemStatsInAddrErrors_val_ptr );

    DEBUG_MSGTL( ( "verbose:ipSystemStatsTable:ipSystemStatsInAddrErrors_get",
        "called\n" ) );
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ipSystemStatsInUnknownProtos_val_ptr );

    DEBUG_MSGTL( ( "verbose:ipSystemStatsTable:ipSystemStatsInUnknownProtos_get", "called\n" ) );
    ...
    ( *ipSystemStatsInUnknownProtos_val_ptr ) = rowreq_ctx->data->stats.InUnknownProtos;
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ipSystemStatsInTruncatedPkts_val_ptr );

    DEBUG_MSGTL( ( "verbose:ipSystemStatsTable:ipSystemStatsInTruncatedPkts_get", "called\n" ) );
    ...
    ( *ipSystemStatsInTruncatedPkts_val_ptr ) = rowreq_ctx->data->stats.InTruncatedPkts;
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ipSystemStatsInForwDatagrams_val_ptr );

    DEBUG_MSGTL( ( "verbose:ipSystemStatsTable:ipSystemStatsInForwDatagrams_get", "called\n" ) );
    ...
    ( *ipSystemStatsInForwDatagrams_val_ptr ) = rowreq_ctx->data->stats.HCInForwDatagrams.low;
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ipSystemStatsHCInForwDatagrams_val_ptr );
    ...
    ( *ipSystemStatsHCInForwDatagrams_val_ptr ).low = rowreq_ctx->data->stats.HCInForwDatagrams.low;
    ( *ipSystemStatsHCInForwDatagrams_val_ptr ).high = rowreq_ctx->data->stats.HCInForwDatagrams.high;
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ipSystemStatsReasmReqds_val_ptr );

    DEBUG_MSGTL( ( "verbose:ipSystemStatsTable:ipSystemStatsReasmReqds_get",
        "called\n" ) );
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ipSystemStatsReasmOKs_val_ptr );

    DEBUG_MSGTL( ( "verbose:ipSystemStatsTable:ipSystemStatsReasmOKs_get",
        "called\n" ) );
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ipSystemStatsReasmFails_val_ptr );

    DEBUG_MSGTL( ( "verbose:ipSystemStatsTable:ipSystemStatsReasmFails_get",
        "called\n" ) );
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ipSystemStatsInDiscards_val_ptr );

    DEBUG_MSGTL( ( "verbose:ipSystemStatsTable:ipSystemStatsInDiscards_get",
        "called\n" ) );
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ipSystemStatsInDelivers_val_ptr );

    DEBUG_MSGTL( ( "verbose:ipSystemStatsTable:ipSystemStatsInDelivers_get",
        "called\n" ) );
    ...
    ( *ipSystemStatsInDelivers_val_ptr ) = rowreq_ctx->data->stats.HCInDelivers.low;
    ...
    Integer64* ipSystemStatsHCInDelivers_val_ptr )
{
    ...
    ( *ipSystemStatsHCInDelivers_val_ptr ).low = rowreq_ctx->data->stats.HCInDelivers.low;
    ( *ipSystemStatsHCInDelivers_val_ptr ).high = rowreq_ctx->data->stats.HCInDelivers.high;
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ipSystemStatsOutRequests_val_ptr );

    DEBUG_MSGTL( ( "verbose:ipSystemStatsTable:ipSystemStatsOutRequests_get",
        "called\n" ) );
    ...
    ( *ipSystemStatsOutRequests_val_ptr ) = rowreq_ctx->data->stats.HCOutRequests.low;
    ...
    Integer64* ipSystemStatsHCOutRequests_val_ptr )
{
    ...
    ( *ipSystemStatsHCOutRequests_val_ptr ).low = rowreq_ctx->data->stats.HCOutRequests.low;
    ( *ipSystemStatsHCOutRequests_val_ptr ).high = rowreq_ctx->data->stats.HCOutRequests.high;
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ipSystemStatsOutNoRoutes_val_ptr );

    DEBUG_MSGTL( ( "verbose:ipSystemStatsTable:ipSystemStatsOutNoRoutes_get",
        "called\n" ) );
    ...
    ( *ipSystemStatsOutNoRoutes_val_ptr ) = rowreq_ctx->data->stats.HCOutNoRoutes.low;
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ipSystemStatsOutForwDatagrams_val_ptr );

    DEBUG_MSGTL( ( "verbose:ipSystemStatsTable:ipSystemStatsOutForwDatagrams_get", "called\n" ) );
    ...
    ( *ipSystemStatsOutForwDatagrams_val_ptr ) = rowreq_ctx->data->stats.HCOutForwDatagrams.low;
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ipSystemStatsHCOutForwDatagrams_val_ptr );
    ...
    ( *ipSystemStatsHCOutForwDatagrams_val_ptr ).low = rowreq_ctx->data->stats.HCOutForwDatagrams.low;
    ( *ipSystemStatsHCOutForwDatagrams_val_ptr ).high = rowreq_ctx->data->stats.HCOutForwDatagrams.high;
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ipSystemStatsOutDiscards_val_ptr );

    DEBUG_MSGTL( ( "verbose:ipSystemStatsTable:ipSystemStatsOutDiscards_get",
        "called\n" ) );
    ...
    ( *ipSystemStatsOutDiscards_val_ptr ) = rowreq_ctx->data->stats.HCOutDiscards.low;
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ipSystemStatsOutFragReqds_val_ptr );

    DEBUG_MSGTL( ( "verbose:ipSystemStatsTable:ipSystemStatsOutFragReqds_get",
        "called\n" ) );
    ...
    ( *ipSystemStatsOutFragReqds_val_ptr ) = rowreq_ctx->data->stats.HCOutFragReqds.low;
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ipSystemStatsOutFragOKs_val_ptr );

    DEBUG_MSGTL( ( "verbose:ipSystemStatsTable:ipSystemStatsOutFragOKs_get",
        "called\n" ) );
    ...
    ( *ipSystemStatsOutFragOKs_val_ptr ) = rowreq_ctx->data->stats.HCOutFragOKs.low;
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ipSystemStatsOutFragFails_val_ptr );

    DEBUG_MSGTL( ( "verbose:ipSystemStatsTable:ipSystemStatsOutFragFails_get",
        "called\n" ) );
    ...
    ( *ipSystemStatsOutFragFails_val_ptr ) = rowreq_ctx->data->stats.HCOutFragFails.low;
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ipSystemStatsOutFragCreates_val_ptr );

    DEBUG_MSGTL( ( "verbose:ipSystemStatsTable:ipSystemStatsOutFragCreates_get", "called\n" ) );
    ...
    ( *ipSystemStatsOutFragCreates_val_ptr ) = rowreq_ctx->data->stats.HCOutFragCreates.low;
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ipSystemStatsOutTransmits_val_ptr );

    DEBUG_MSGTL( ( "verbose:ipSystemStatsTable:ipSystemStatsOutTransmits_get",
        "called\n" ) );
    ...
    ( *ipSystemStatsOutTransmits_val_ptr ) = rowreq_ctx->data->stats.HCOutTransmits.low;
    ...
    Integer64* ipSystemStatsHCOutTransmits_val_ptr )
{
    ...
    ( *ipSystemStatsHCOutTransmits_val_ptr ).low = rowreq_ctx->data->stats.HCOutTransmits.low;
    ( *ipSystemStatsHCOutTransmits_val_ptr ).high = rowreq_ctx->data->stats.HCOutTransmits.high;
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ipSystemStatsOutOctets_val_ptr );

    DEBUG_MSGTL( ( "verbose:ipSystemStatsTable:ipSystemStatsOutOctets_get",
        "called\n" ) );
    ...
    Integer64* ipSystemStatsHCOutOctets_val_ptr )
{
    ...
    ( *ipSystemStatsHCOutOctets_val_ptr ).low = rowreq_ctx->data->stats.HCOutOctets.low;
    ( *ipSystemStatsHCOutOctets_val_ptr ).high = rowreq_ctx->data->stats.HCOutOctets.high;
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ipSystemStatsInMcastPkts_val_ptr );

    DEBUG_MSGTL( ( "verbose:ipSystemStatsTable:ipSystemStatsInMcastPkts_get",
        "called\n" ) );
    ...
    ( *ipSystemStatsInMcastPkts_val_ptr ) = rowreq_ctx->data->stats.HCInMcastPkts.low;
    ...
    Integer64* ipSystemStatsHCInMcastPkts_val_ptr )
{
    ...
    ( *ipSystemStatsHCInMcastPkts_val_ptr ).low = rowreq_ctx->data->stats.HCInMcastPkts.low;
    ( *ipSystemStatsHCInMcastPkts_val_ptr ).high = rowreq_ctx->data->stats.HCInMcastPkts.high;
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ipSystemStatsInMcastOctets_val_ptr );

    DEBUG_MSGTL( ( "verbose:ipSystemStatsTable:ipSystemStatsInMcastOctets_get", "called\n" ) );
    ...
    ( *ipSystemStatsInMcastOctets_val_ptr ) = rowreq_ctx->data->stats.HCInMcastOctets.low;
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ipSystemStatsHCInMcastOctets_val_ptr );
    ...
    ( *ipSystemStatsHCInMcastOctets_val_ptr ).low = rowreq_ctx->data->stats.HCInMcastOctets.low;
    ( *ipSystemStatsHCInMcastOctets_val_ptr ).high = rowreq_ctx->data->stats.HCInMcastOctets.high;
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ipSystemStatsOutMcastPkts_val_ptr );

    DEBUG_MSGTL( ( "verbose:ipSystemStatsTable:ipSystemStatsOutMcastPkts_get",
        "called\n" ) );
    ...
    ( *ipSystemStatsOutMcastPkts_val_ptr ) = rowreq_ctx->data->stats.HCOutMcastPkts.low;
    ...
    Integer64* ipSystemStatsHCOutMcastPkts_val_ptr )
{
    ...
    ( *ipSystemStatsHCOutMcastPkts_val_ptr ).low = rowreq_ctx->data->stats.HCOutMcastPkts.low;
    ( *ipSystemStatsHCOutMcastPkts_val_ptr ).high = rowreq_ctx->data->stats.HCOutMcastPkts.high;
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ipSystemStatsOutMcastOctets_val_ptr );

    DEBUG_MSGTL( ( "verbose:ipSystemStatsTable:ipSystemStatsOutMcastOctets_get", "called\n" ) );
    ...
    ( *ipSystemStatsOutMcastOctets_val_ptr ) = rowreq_ctx->data->stats.HCOutMcastOctets.low;
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ipSystemStatsHCOutMcastOctets_val_ptr );
    ...
    ( *ipSystemStatsHCOutMcastOctets_val_ptr ).low = rowreq_ctx->data->stats.HCOutMcastOctets.low;
    ( *ipSystemStatsHCOutMcastOctets_val_ptr ).high = rowreq_ctx->data->stats.HCOutMcastOctets.high;
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ipSystemStatsInBcastPkts_val_ptr );

    DEBUG_MSGTL( ( "verbose:ipSystemStatsTable:ipSystemStatsInBcastPkts_get",
        "called\n" ) );
    ...
    ( *ipSystemStatsInBcastPkts_val_ptr ) = rowreq_ctx->data->stats.HCInBcastPkts.low;
    ...
    Integer64* ipSystemStatsHCInBcastPkts_val_ptr )
{
    ...
    ( *ipSystemStatsHCInBcastPkts_val_ptr ).low = rowreq_ctx->data->stats.HCInBcastPkts.low;
    ( *ipSystemStatsHCInBcastPkts_val_ptr ).high = rowreq_ctx->data->stats.HCInBcastPkts.high;
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ipSystemStatsOutBcastPkts_val_ptr );

    DEBUG_MSGTL( ( "verbose:ipSystemStatsTable:ipSystemStatsOutBcastPkts_get",
        "called\n" ) );
    ...
    ( *ipSystemStatsOutBcastPkts_val_ptr ) = rowreq_ctx->data->stats.HCOutBcastPkts.low;
    ...
    Integer64* ipSystemStatsHCOutBcastPkts_val_ptr )
{
    ...
    ( *ipSystemStatsHCOutBcastPkts_val_ptr ).low = rowreq_ctx->data->stats.HCOutBcastPkts.low;
    ( *ipSystemStatsHCOutBcastPkts_val_ptr ).high = rowreq_ctx->data->stats.HCOutBcastPkts.high;
 ...
 * The net-snmp type is ASN01_TIMETICKS. The C type decl is u_long (u_long)
 */
/**
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ipSystemStatsDiscontinuityTime_val_ptr );

    DEBUG_MSGTL( ( "verbose:ipSystemStatsTable:ipSystemStatsDiscontinuityTime_get", "called\n" ) );
    ...
    ( *ipSystemStatsDiscontinuityTime_val_ptr ) = rowreq_ctx->ipSystemStatsDiscontinuityTime;
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ipSystemStatsRefreshRate_val_ptr );

    DEBUG_MSGTL( ( "verbose:ipSystemStatsTable:ipSystemStatsRefreshRate_get",
        "called\n" ) );
