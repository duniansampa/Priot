...
#define IPADDRESSTABLE_CACHE_TIMEOUT   60
    ...
    void            ipAddressTable_container_init(Container_Container
                                                  **container_ptr_ptr,
                                                  Cache * cache);
    void            ipAddressTable_container_shutdown(Container_Container
                                                      *container_ptr);

    int             ipAddressTable_container_load(Container_Container
                                                  *container);
    void            ipAddressTable_container_free(Container_Container
                                                  *container);

    int             ipAddressTable_cache_load(Container_Container
                                              *container);
    void            ipAddressTable_cache_free(Container_Container
                                              *container);
