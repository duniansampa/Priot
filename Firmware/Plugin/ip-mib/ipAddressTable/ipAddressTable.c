...
{
    DEBUG_MSGTL( ( "verbose:ipAddressTable:init_ipAddressTable", "called\n" ) );
...
void initialize_table_ipAddressTable( void )
{
    ...
    DEBUG_MSGTL( ( "verbose:ipAddressTable:initialize_table_ipAddressTable",
        "called\n" ) );
...
int ipAddressTable_rowreq_ctx_init( ipAddressTable_rowreq_ctx* rowreq_ctx,
    void* user_init_ctx )
{
    DEBUG_MSGTL( ( "verbose:ipAddressTable:ipAddressTable_rowreq_ctx_init",
        "called\n" ) );
...
{
    DEBUG_MSGTL( ( "verbose:ipAddressTable:ipAddressTable_rowreq_ctx_cleanup",
        "called\n" ) );
...
{
    DEBUG_MSGTL( ( "verbose:ipAddressTable:ipAddressTable_pre_request",
        "called\n" ) );
...
int ipAddressTable_post_request( ipAddressTable_registration* user_context,
    int rc )
{
    DEBUG_MSGTL( ( "verbose:ipAddressTable:ipAddressTable_post_request",
        "called\n" ) );
...
ipAddressTable_allocate_data( void )
{
    ...
    DEBUG_MSGTL( ( "verbose:ipAddressTable:ipAddressTable_allocate_data",
        "called\n" ) );
...
{
    DEBUG_MSGTL( ( "verbose:ipAddressTable:ipAddressTable_release_data",
        "called\n" ) );
...
{
    Assert_assert( NULL != mib_ipAddressAddrType_val_ptr );

    DEBUG_MSGTL( ( "verbose:ipAddressTable:ipAddressAddrType_map",
        "called\n" ) );
    ...
    default:
        Logger_log( LOGGER_PRIORITY_ERR, "couldn't map value %ld for ipAddressAddrType\n",
...
{
    DEBUG_MSGTL( ( "verbose:ipAddressTable:ipAddressTable_indexes_set_tbl_idx", "called\n" ) );
...
int ipAddressTable_indexes_set( ipAddressTable_rowreq_ctx* rowreq_ctx,
    ...
    size_t ipAddressAddr_val_ptr_len )
{
    DEBUG_MSGTL( ( "verbose:ipAddressTable:ipAddressTable_indexes_set",
        "called\n" ) );

    if ( MFD_SUCCESS != ipAddressTable_indexes_set_tbl_idx( &rowreq_ctx->tbl_idx,
                            ipAddressAddrType_val,
    ...
    long* ipAddressIfIndex_val_ptr )
{
    ...
    Assert_assert( NULL != ipAddressIfIndex_val_ptr );

    DEBUG_MSGTL( ( "verbose:ipAddressTable:ipAddressIfIndex_get",
        "called\n" ) );
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ipAddressType_val_ptr );

    DEBUG_MSGTL( ( "verbose:ipAddressTable:ipAddressType_get", "called\n" ) );
    ...
    size_t* ipAddressPrefix_val_ptr_len_ptr )
{
    ...
    Assert_assert( ( NULL != ipAddressPrefix_val_ptr_ptr )
        && ( NULL != *ipAddressPrefix_val_ptr_ptr ) );
    Assert_assert( NULL != ipAddressPrefix_val_ptr_len_ptr );

    DEBUG_MSGTL( ( "verbose:ipAddressTable:ipAddressPrefix_get", "called\n" ) );
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ipAddressOrigin_val_ptr );

    DEBUG_MSGTL( ( "verbose:ipAddressTable:ipAddressOrigin_get", "called\n" ) );
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ipAddressStatus_val_ptr );

    DEBUG_MSGTL( ( "verbose:ipAddressTable:ipAddressStatus_get", "called\n" ) );
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ipAddressCreated_val_ptr );

    DEBUG_MSGTL( ( "verbose:ipAddressTable:ipAddressCreated_get",
        "called\n" ) );
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ipAddressLastChanged_val_ptr );

    DEBUG_MSGTL( ( "verbose:ipAddressTable:ipAddressLastChanged_get",
        "called\n" ) );
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ipAddressRowStatus_val_ptr );
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ipAddressStorageType_val_ptr );

    DEBUG_MSGTL( ( "verbose:ipAddressTable:ipAddressStorageType_get",
        "called\n" ) );
...
int ipAddressTable_undo_setup( ipAddressTable_rowreq_ctx* rowreq_ctx )
{
    ...
    DEBUG_MSGTL( ( "verbose:ipAddressTable:ipAddressTable_undo_setup",
        "called\n" ) );
    ...
    if ( STORAGETYPE_READONLY == rowreq_ctx->data->ia_storagetype ) {
        DEBUG_MSGTL( ( "ipAddressTable", "can't change readonly row\n" ) );
...
int ipAddressTable_undo( ipAddressTable_rowreq_ctx* rowreq_ctx )
{
    ...
    DEBUG_MSGTL( ( "verbose:ipAddressTable:ipAddressTable_undo", "called\n" ) );
...
int ipAddressTable_undo_cleanup( ipAddressTable_rowreq_ctx* rowreq_ctx )
{
    ...
    DEBUG_MSGTL( ( "verbose:ipAddressTable:ipAddressTable_undo_cleanup",
        "called\n" ) );
...
int ipAddressTable_commit( ipAddressTable_rowreq_ctx* rowreq_ctx )
{
    ...
    DEBUG_MSGTL( ( "verbose:ipAddressTable:ipAddressTable_commit",
        "called\n" ) );
    ...
    if ( rowreq_ctx->column_set_flags & COLUMN_IPADDRESSROWSTATUS_FLAG ) {
        if ( rowreq_ctx->rowreq_flags & MFD_ROW_CREATED ) {
            ...
            rowreq_ctx->ipAddressCreated = Agent_getAgentUptime();
    ...
    if ( rc ) {
        ...
        rowreq_ctx->ipAddressLastChanged = Agent_getAgentUptime();
    }
...
int ipAddressTable_undo_commit( ipAddressTable_rowreq_ctx* rowreq_ctx )
{
    ...
    DEBUG_MSGTL( ( "verbose:ipAddressTable:ipAddressTable_undo_commit",
        "called\n" ) );
...
{
    DEBUG_MSGTL( ( "verbose:ipAddressTable:ipAddressIfIndex_check_value",
        "called\n" ) );
    ...
    if ( NULL == netsnmp_access_interface_name_find( ipAddressIfIndex_val ) ) {
        DEBUG_MSGT( ( "ipAddressTable", "cant find name for index %ld\n",
...
{
    DEBUG_MSGTL( ( "verbose:ipAddressTable:ipAddressIfIndex_undo_setup",
        "called\n" ) );
    ...
    long ipAddressIfIndex_val )
{
    ...
    DEBUG_MSGTL( ( "verbose:ipAddressTable:ipAddressIfIndex_set",
        "called\n" ) );
...
int ipAddressIfIndex_undo( ipAddressTable_rowreq_ctx* rowreq_ctx )
{
    ...
    DEBUG_MSGTL( ( "verbose:ipAddressTable:ipAddressIfIndex_undo",
        "called\n" ) );
...
{
    DEBUG_MSGTL( ( "verbose:ipAddressTable:ipAddressType_check_value",
        "called\n" ) );
...
{
    DEBUG_MSGTL( ( "verbose:ipAddressTable:ipAddressType_undo_setup",
        "called\n" ) );
    ...
    u_long ipAddressType_val )
{
    ...
    DEBUG_MSGTL( ( "verbose:ipAddressTable:ipAddressType_set", "called\n" ) );
...
int ipAddressType_undo( ipAddressTable_rowreq_ctx* rowreq_ctx )
{
    ...
    DEBUG_MSGTL( ( "verbose:ipAddressTable:ipAddressType_undo", "called\n" ) );
...
{
    DEBUG_MSGTL( ( "verbose:ipAddressTable:ipAddressStatus_check_value",
        "called\n" ) );
...
{
    DEBUG_MSGTL( ( "verbose:ipAddressTable:ipAddressStatus_undo_setup",
        "called\n" ) );
    ...
    u_long ipAddressStatus_val )
{
    ...
    DEBUG_MSGTL( ( "verbose:ipAddressTable:ipAddressStatus_set", "called\n" ) );
...
int ipAddressStatus_undo( ipAddressTable_rowreq_ctx* rowreq_ctx )
{
    ...
    DEBUG_MSGTL( ( "verbose:ipAddressTable:ipAddressStatus_undo",
        "called\n" ) );
    ...
    u_long ipAddressRowStatus_val )
{
    ...
    DEBUG_MSGTL( ( "verbose:ipAddressTable:ipAddressRowStatus_check_value",
        "called\n" ) );
    ...
    if ( ROWSTATUS_CREATEANDWAIT == ipAddressRowStatus_val ) {
        DEBUG_MSGTL( ( "ipAddressTable", "createAndWait not supported\n" ) );
        return MFD_NOT_VALID_EVER;
    }
...
{
    DEBUG_MSGTL( ( "verbose:ipAddressTable:ipAddressRowStatus_undo_setup",
        "called\n" ) );
    ...
    u_long ipAddressRowStatus_val )
{
    ...
    DEBUG_MSGTL( ( "verbose:ipAddressTable:ipAddressRowStatus_set",
        "called\n" ) );
...
int ipAddressRowStatus_undo( ipAddressTable_rowreq_ctx* rowreq_ctx )
{
    ...
    DEBUG_MSGTL( ( "verbose:ipAddressTable:ipAddressRowStatus_undo",
        "called\n" ) );
    ...
    u_long ipAddressStorageType_val )
{
    ...
    DEBUG_MSGTL( ( "verbose:ipAddressTable:ipAddressStorageType_check_value",
        "called\n" ) );
...
{
    DEBUG_MSGTL( ( "verbose:ipAddressTable:ipAddressStorageType_undo_setup",
        "called\n" ) );
    ...
    u_long ipAddressStorageType_val )
{
    ...
    DEBUG_MSGTL( ( "verbose:ipAddressTable:ipAddressStorageType_set",
        "called\n" ) );
...
int ipAddressStorageType_undo( ipAddressTable_rowreq_ctx* rowreq_ctx )
{
    ...
    DEBUG_MSGTL( ( "verbose:ipAddressTable:ipAddressStorageType_undo",
        "called\n" ) );
...
int ipAddressTable_check_dependencies( ipAddressTable_rowreq_ctx* rowreq_ctx )
{
    ...
    DEBUG_MSGTL( ( "internal:ipAddressTable:ipAddressTable_check_dependencies", "called\n" ) );
    ...
    if ( rowreq_ctx->column_set_flags & COLUMN_IPADDRESSROWSTATUS_FLAG ) {
        ...
        if ( rowreq_ctx->rowreq_flags & MFD_ROW_CREATED ) {
            if ( ROWSTATUS_DESTROY == rowreq_ctx->ipAddressRowStatus ) {
                ...
                if ( ( rowreq_ctx->column_set_flags & IPADDRESSTABLE_REQUIRED_COLS )
