...
#include "Table.h"
    ...
    Container_Container *ipv6ScopeZoneIndexTable_container_get(void);
    ...
    int             ipv6ScopeZoneIndexTable_index_to_oid(Types_Index *
                                                         oid_idx,
                                                         ipv6ScopeZoneIndexTable_mib_index
                                                         * mib_idx);
    int             ipv6ScopeZoneIndexTable_index_from_oid(Types_Index *
                                                           oid_idx,
                                                           ipv6ScopeZoneIndexTable_mib_index
                                                           * mib_idx);
     ...
     */
    void           
        ipv6ScopeZoneIndexTable_valid_columns_set(ColumnInfo *vc);
