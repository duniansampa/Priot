...
{
    DEBUG_MSGTL( ( "verbose:ipv6ScopeZoneIndexTable:init_ipv6ScopeZoneIndexTable", "called\n" ) );
...
void initialize_table_ipv6ScopeZoneIndexTable( void )
{
    ...
    DEBUG_MSGTL( ( "verbose:ipv6ScopeZoneIndexTable:initialize_table_ipv6ScopeZoneIndexTable", "called\n" ) );
     ...
     */
    _ipv6ScopeZoneIndexTable_initialize_interface( ipv6ScopeZoneIndexTable_user_context_p, flags );
} /* initialize_table_ipv6ScopeZoneIndexTable */
 ...
 */
int ipv6ScopeZoneIndexTable_rowreq_ctx_init( ipv6ScopeZoneIndexTable_rowreq_ctx* rowreq_ctx, void* user_init_ctx )
{
    DEBUG_MSGTL( ( "verbose:ipv6ScopeZoneIndexTable:ipv6ScopeZoneIndexTable_rowreq_ctx_init", "called\n" ) );
 ...
 *
 */
void ipv6ScopeZoneIndexTable_rowreq_ctx_cleanup( ipv6ScopeZoneIndexTable_rowreq_ctx* rowreq_ctx )
{
    DEBUG_MSGTL( ( "verbose:ipv6ScopeZoneIndexTable:ipv6ScopeZoneIndexTable_rowreq_ctx_cleanup", "called\n" ) );
 ...
 */
int ipv6ScopeZoneIndexTable_pre_request( ipv6ScopeZoneIndexTable_registration*
        user_context )
{
    DEBUG_MSGTL( ( "verbose:ipv6ScopeZoneIndexTable:ipv6ScopeZoneIndexTable_pre_request", "called\n" ) );
 ...
 */
int ipv6ScopeZoneIndexTable_post_request( ipv6ScopeZoneIndexTable_registration*
                                              user_context,
    int rc )
{
    DEBUG_MSGTL( ( "verbose:ipv6ScopeZoneIndexTable:ipv6ScopeZoneIndexTable_post_request", "called\n" ) );
...
ipv6ScopeZoneIndexTable_allocate_data( void )
{
    ...
    DEBUG_MSGTL( ( "verbose:ipv6ScopeZoneIndexTable:ipv6ScopeZoneIndexTable_allocate_data", "called\n" ) );
...
{
    DEBUG_MSGTL( ( "verbose:ipv6ScopeZoneIndexTable:ipv6ScopeZoneIndexTable_release_data", "called\n" ) );
 ...
 */
int ipv6ScopeZoneIndexTable_indexes_set_tbl_idx( ipv6ScopeZoneIndexTable_mib_index* tbl_idx,
    long ipv6ScopeZoneIndexIfIndex_val )
{
    DEBUG_MSGTL( ( "verbose:ipv6ScopeZoneIndexTable:ipv6ScopeZoneIndexTable_indexes_set_tbl_idx", "called\n" ) );
 ...
 *  from the mib index.
 */
int ipv6ScopeZoneIndexTable_indexes_set( ipv6ScopeZoneIndexTable_rowreq_ctx*
                                             rowreq_ctx,
    long ipv6ScopeZoneIndexIfIndex_val )
{
    DEBUG_MSGTL( ( "verbose:ipv6ScopeZoneIndexTable:ipv6ScopeZoneIndexTable_indexes_set", "called\n" ) );

    if ( MFD_SUCCESS != ipv6ScopeZoneIndexTable_indexes_set_tbl_idx( &rowreq_ctx->tbl_idx,
 ...
 */
int ipv6ScopeZoneIndexLinkLocal_get( ipv6ScopeZoneIndexTable_rowreq_ctx*
                                         rowreq_ctx,
    u_long*
        ipv6ScopeZoneIndexLinkLocal_val_ptr )
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ipv6ScopeZoneIndexLinkLocal_val_ptr );

    DEBUG_MSGTL( ( "verbose:ipv6ScopeZoneIndexTable:ipv6ScopeZoneIndexLinkLocal_get", "called\n" ) );
     ...
     */
    ( *ipv6ScopeZoneIndexLinkLocal_val_ptr ) = rowreq_ctx->data->scopezone_linklocal;
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ipv6ScopeZoneIndex3_val_ptr );

    DEBUG_MSGTL( ( "verbose:ipv6ScopeZoneIndexTable:ipv6ScopeZoneIndex3_get",
        "called\n" ) );
 ...
 * @retval MFD_ERROR           : Any other error
 */
int ipv6ScopeZoneIndexAdminLocal_get( ipv6ScopeZoneIndexTable_rowreq_ctx*
                                          rowreq_ctx,
    u_long*
        ipv6ScopeZoneIndexAdminLocal_val_ptr )
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ipv6ScopeZoneIndexAdminLocal_val_ptr );

    DEBUG_MSGTL( ( "verbose:ipv6ScopeZoneIndexTable:ipv6ScopeZoneIndexAdminLocal_get", "called\n" ) );
 ...
 * @retval MFD_ERROR           : Any other error
 */
int ipv6ScopeZoneIndexSiteLocal_get( ipv6ScopeZoneIndexTable_rowreq_ctx*
                                         rowreq_ctx,
    u_long*
        ipv6ScopeZoneIndexSiteLocal_val_ptr )
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ipv6ScopeZoneIndexSiteLocal_val_ptr );

    DEBUG_MSGTL( ( "verbose:ipv6ScopeZoneIndexTable:ipv6ScopeZoneIndexSiteLocal_get", "called\n" ) );
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ipv6ScopeZoneIndex6_val_ptr );

    DEBUG_MSGTL( ( "verbose:ipv6ScopeZoneIndexTable:ipv6ScopeZoneIndex6_get",
        "called\n" ) );
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ipv6ScopeZoneIndex7_val_ptr );

    DEBUG_MSGTL( ( "verbose:ipv6ScopeZoneIndexTable:ipv6ScopeZoneIndex7_get",
        "called\n" ) );
 ...
 * @retval MFD_ERROR           : Any other error
 */
int ipv6ScopeZoneIndexOrganizationLocal_get( ipv6ScopeZoneIndexTable_rowreq_ctx* rowreq_ctx,
    u_long*
        ipv6ScopeZoneIndexOrganizationLocal_val_ptr )
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ipv6ScopeZoneIndexOrganizationLocal_val_ptr );

    DEBUG_MSGTL( ( "verbose:ipv6ScopeZoneIndexTable:ipv6ScopeZoneIndexOrganizationLocal_get", "called\n" ) );
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ipv6ScopeZoneIndex9_val_ptr );

    DEBUG_MSGTL( ( "verbose:ipv6ScopeZoneIndexTable:ipv6ScopeZoneIndex9_get",
        "called\n" ) );
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ipv6ScopeZoneIndexA_val_ptr );

    DEBUG_MSGTL( ( "verbose:ipv6ScopeZoneIndexTable:ipv6ScopeZoneIndexA_get",
        "called\n" ) );
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ipv6ScopeZoneIndexB_val_ptr );

    DEBUG_MSGTL( ( "verbose:ipv6ScopeZoneIndexTable:ipv6ScopeZoneIndexB_get",
        "called\n" ) );
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ipv6ScopeZoneIndexC_val_ptr );

    DEBUG_MSGTL( ( "verbose:ipv6ScopeZoneIndexTable:ipv6ScopeZoneIndexC_get",
        "called\n" ) );
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ipv6ScopeZoneIndexD_val_ptr );

    DEBUG_MSGTL( ( "verbose:ipv6ScopeZoneIndexTable:ipv6ScopeZoneIndexD_get",
        "called\n" ) );
