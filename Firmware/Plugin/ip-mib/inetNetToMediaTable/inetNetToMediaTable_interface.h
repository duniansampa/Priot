...
#include "inetNetToMediaTable.h"
    ...
    Container_Container *inetNetToMediaTable_container_get(void);
    ...
    int             inetNetToMediaTable_index_to_oid(Types_Index *
                                                     oid_idx,
                                                     inetNetToMediaTable_mib_index
                                                     * mib_idx);
    int             inetNetToMediaTable_index_from_oid(Types_Index *
                                                       oid_idx,
                                                       inetNetToMediaTable_mib_index
                                                       * mib_idx);
     ...
     */
    void
            inetNetToMediaTable_valid_columns_set(ColumnInfo *vc);
