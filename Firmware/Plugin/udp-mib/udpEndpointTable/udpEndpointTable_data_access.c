 ...
 */
int udpEndpointTable_init_data( udpEndpointTable_registration*
        udpEndpointTable_reg )
{
    DEBUG_MSGTL( ( "verbose:udpEndpointTable:udpEndpointTable_init_data",
        "called\n" ) );
 ...
 */
void udpEndpointTable_container_init( Container_Container** container_ptr_ptr,
    Cache* cache )
{
    DEBUG_MSGTL( ( "verbose:udpEndpointTable:udpEndpointTable_container_init",
        "called\n" ) );
 ...
 */
void udpEndpointTable_container_shutdown( Container_Container* container_ptr )
{
    DEBUG_MSGTL( ( "verbose:udpEndpointTable:udpEndpointTable_container_shutdown", "called\n" ) );
...
int udpEndpointTable_container_load( Container_Container* container )
{
    udpEndpointTable_rowreq_ctx* rowreq_ctx;
    Container_Container* ep_c;
    Container_Iterator* ep_it;
    ...
    DEBUG_MSGTL( ( "verbose:udpEndpointTable:udpEndpointTable_container_load",
        "called\n" ) );
    ...
    for ( ep = ( netsnmp_udp_endpoint_entry* )CONTAINER_ITERATOR_FIRST( ep_it ); ep;
          ep = ( netsnmp_udp_endpoint_entry* )CONTAINER_ITERATOR_NEXT( ep_it ) ) {
        ...
        if ( MFD_SUCCESS != udpEndpointTable_indexes_set( rowreq_ctx,
    ...
    CONTAINER_ITERATOR_RELEASE( ep_it );

    netsnmp_access_udp_endpoint_container_free( ep_c, 0 );

    DEBUG_MSGT( ( "verbose:udpEndpointTable:udpEndpointTable_container_load",
 ...
 *
 */
void udpEndpointTable_container_free( Container_Container* container )
{
    DEBUG_MSGTL( ( "verbose:udpEndpointTable:udpEndpointTable_container_free",
        "called\n" ) );
...
{
    DEBUG_MSGTL( ( "verbose:udpEndpointTable:udpEndpointTable_row_prep",
        "called\n" ) );
