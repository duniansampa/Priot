...
{
    DEBUG_MSGTL( ( "verbose:udpEndpointTable:init_udpEndpointTable",
        "called\n" ) );
...
void initialize_table_udpEndpointTable( void )
{
    ...
    DEBUG_MSGTL( ( "verbose:udpEndpointTable:initialize_table_udpEndpointTable", "called\n" ) );
     ...
     */
    _udpEndpointTable_initialize_interface( udpEndpointTable_user_context_p, flags );
} /* initialize_table_udpEndpointTable */
...
{
    DEBUG_MSGTL( ( "verbose:udpEndpointTable:udpEndpointTable_pre_request",
        "called\n" ) );
...
int udpEndpointTable_post_request( udpEndpointTable_registration* user_context,
    int rc )
{
    DEBUG_MSGTL( ( "verbose:udpEndpointTable:udpEndpointTable_post_request",
        "called\n" ) );
 ...
 */
int udpEndpointTable_indexes_set_tbl_idx( udpEndpointTable_mib_index* tbl_idx,
    u_long
...
{
    DEBUG_MSGTL( ( "verbose:udpEndpointTable:udpEndpointTable_indexes_set_tbl_idx", "called\n" ) );
     ...
     */
    if ( ( NULL == tbl_idx->udpEndpointLocalAddress ) || ( tbl_idx->udpEndpointLocalAddress_len < ( udpEndpointLocalAddress_val_ptr_len ) ) ) {
    ...
    memcpy( tbl_idx->udpEndpointLocalAddress,
        ...
        udpEndpointLocalAddress_val_ptr_len * sizeof( udpEndpointLocalAddress_val_ptr[ 0 ] ) );
     ...
     */
    if ( ( NULL == tbl_idx->udpEndpointRemoteAddress ) || ( tbl_idx->udpEndpointRemoteAddress_len < ( udpEndpointRemoteAddress_val_ptr_len ) ) ) {
        Logger_log( LOGGER_PRIORITY_ERR, "not enough space for value\n" );
        return MFD_ERROR;
    }
    tbl_idx->udpEndpointRemoteAddress_len = udpEndpointRemoteAddress_val_ptr_len;
    memcpy( tbl_idx->udpEndpointRemoteAddress,
        udpEndpointRemoteAddress_val_ptr,
        udpEndpointRemoteAddress_val_ptr_len * sizeof( udpEndpointRemoteAddress_val_ptr[ 0 ] ) );
...
int udpEndpointTable_indexes_set( udpEndpointTable_rowreq_ctx* rowreq_ctx,
    ...
    u_long udpEndpointProcess_val )
{
    DEBUG_MSGTL( ( "verbose:udpEndpointTable:udpEndpointTable_indexes_set",
        "called\n" ) );

    if ( MFD_SUCCESS != udpEndpointTable_indexes_set_tbl_idx( &rowreq_ctx->tbl_idx,
                            udpEndpointLocalAddressType_val,
                            udpEndpointLocalAddress_val_ptr,
                            udpEndpointLocalAddress_val_ptr_len,
    ...
    u_long* udpEndpointProcess_val_ptr )
{
    ...
    Assert_assert( NULL != udpEndpointProcess_val_ptr );

    DEBUG_MSGTL( ( "verbose:udpEndpointTable:udpEndpointProcess_get",
        "called\n" ) );
