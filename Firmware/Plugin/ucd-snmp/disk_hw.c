...
struct Variable2_s extensible_disk_variables[] = {
    ...
    { DISKDEVICE, ASN01_OCTET_STR, IMPL_OLDAPI_RONLY,
        var_extensible_disk, 1, { DISKDEVICE } },
    { DISKMINIMUM, ASN01_INTEGER, IMPL_OLDAPI_RONLY,
        var_extensible_disk, 1, { DISKMINIMUM } },
    { DISKMINPERCENT, ASN01_INTEGER, IMPL_OLDAPI_RONLY,
        var_extensible_disk, 1, { DISKMINPERCENT } },
    { DISKTOTAL, ASN01_INTEGER, IMPL_OLDAPI_RONLY,
        var_extensible_disk, 1, { DISKTOTAL } },
    { DISKAVAIL, ASN01_INTEGER, IMPL_OLDAPI_RONLY,
        var_extensible_disk, 1, { DISKAVAIL } },
    { DISKUSED, ASN01_INTEGER, IMPL_OLDAPI_RONLY,
        var_extensible_disk, 1, { DISKUSED } },
    { DISKPERCENT, ASN01_INTEGER, IMPL_OLDAPI_RONLY,
        var_extensible_disk, 1, { DISKPERCENT } },
    { DISKPERCENTNODE, ASN01_INTEGER, IMPL_OLDAPI_RONLY,
    ...
    { DISKTOTALLOW, ASN01_UNSIGNED, IMPL_OLDAPI_RONLY,
        var_extensible_disk, 1, { DISKTOTALLOW } },
    { DISKTOTALHIGH, ASN01_UNSIGNED, IMPL_OLDAPI_RONLY,
        var_extensible_disk, 1, { DISKTOTALHIGH } },
    { DISKAVAILLOW, ASN01_UNSIGNED, IMPL_OLDAPI_RONLY,
        var_extensible_disk, 1, { DISKAVAILLOW } },
    { DISKAVAILHIGH, ASN01_UNSIGNED, IMPL_OLDAPI_RONLY,
        var_extensible_disk, 1, { DISKAVAILHIGH } },
    { DISKUSEDLOW, ASN01_UNSIGNED, IMPL_OLDAPI_RONLY,
        var_extensible_disk, 1, { DISKUSEDLOW } },
    { DISKUSEDHIGH, ASN01_UNSIGNED, IMPL_OLDAPI_RONLY,
