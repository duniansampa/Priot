...
#include "Vars.h"
   ...
   */
       ...
       int             store_snmpTargetParamsEntry(int majorID, int minorID,
                                                   void *serverarg,
                                                   void *clientarg);
       extern FindVarMethodFT var_snmpTargetParamsEntry;
 
       void            snmpd_parse_config_targetParams(const char *, char *);
 
     WriteMethodFT     write_snmpTargetParamsMPModel;
     WriteMethodFT     write_snmpTargetParamsSecModel;
     WriteMethodFT     write_snmpTargetParamsSecName;
     WriteMethodFT     write_snmpTargetParamsSecLevel;
     WriteMethodFT     write_snmpTargetParamsStorageType;
     WriteMethodFT     write_snmpTargetParamsRowStatus;
