...
#include "Table.h"
    ...
    Container_Container *snmpNotifyFilterTable_container_get(void);
    ...
    int             snmpNotifyFilterTable_index_to_oid(Types_Index *
                                                       oid_idx,
                                                       snmpNotifyFilterTable_mib_index
                                                       * mib_idx);
    int             snmpNotifyFilterTable_index_from_oid(Types_Index *
                                                         oid_idx,
                                                         snmpNotifyFilterTable_mib_index
                                                         * mib_idx);
...
#define LINE_TERM_CHAR '$'
    ...
    void
                    snmpNotifyFilterTable_container_init_persistence(Container_Container
                                                                     *container);
    int
    ...
    void
          ...
          snmpNotifyFilterTable_valid_columns_set(ColumnInfo *vc);
