...
const int ifXTable_oid_size = ASN01_OID_LENGTH( ifXTable_oid );
...
{
    DEBUG_MSGTL( ( "verbose:ifXTable:init_ifXTable", "called\n" ) );
...
void initialize_table_ifXTable( void )
{
    ...
    DEBUG_MSGTL( ( "verbose:ifXTable:initialize_table_ifXTable", "called\n" ) );
...
int ifXTable_rowreq_ctx_init( ifXTable_rowreq_ctx* rowreq_ctx,
    void* user_init_ctx )
{
    DEBUG_MSGTL( ( "verbose:ifXTable:ifXTable_rowreq_ctx_init", "called\n" ) );
...
{
    DEBUG_MSGTL( ( "verbose:ifXTable:ifXTable_rowreq_ctx_cleanup",
        "called\n" ) );
...
{
    DEBUG_MSGTL( ( "verbose:ifXTable:ifXTable_pre_request", "called\n" ) );
...
{
    DEBUG_MSGTL( ( "verbose:ifXTable:ifXTable_post_request", "called\n" ) );
...
int ifXTable_indexes_set_tbl_idx( ifXTable_mib_index* tbl_idx,
    long ifIndex_val )
{
    DEBUG_MSGTL( ( "verbose:ifXTable:ifXTable_indexes_set_tbl_idx",
        "called\n" ) );
...
{
    DEBUG_MSGTL( ( "verbose:ifXTable:ifXTable_indexes_set", "called\n" ) );

    if ( MFD_SUCCESS != ifXTable_indexes_set_tbl_idx( &rowreq_ctx->tbl_idx, ifIndex_val ) )
        return MFD_ERROR;
    ...
    size_t* ifName_val_ptr_len_ptr )
{
    ...
    Assert_assert( ( NULL != ifName_val_ptr_ptr )
        && ( NULL != *ifName_val_ptr_ptr ) );
    Assert_assert( NULL != ifName_val_ptr_len_ptr );

    DEBUG_MSGTL( ( "verbose:ifXTable:ifName_get", "called\n" ) );
    ...
    if ( ( NULL == ( *ifName_val_ptr_ptr ) ) || ( ( *ifName_val_ptr_len_ptr ) < tmp_len ) ) {
        /*
    ...
    u_long* ifInMulticastPkts_val_ptr )
{
    ...
    Assert_assert( NULL != ifInMulticastPkts_val_ptr );

    DEBUG_MSGTL( ( "verbose:ifXTable:ifInMulticastPkts_get", "called\n" ) );
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ifInBroadcastPkts_val_ptr );

    DEBUG_MSGTL( ( "verbose:ifXTable:ifInBroadcastPkts_get", "called\n" ) );
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ifOutMulticastPkts_val_ptr );

    DEBUG_MSGTL( ( "verbose:ifXTable:ifOutMulticastPkts_get", "called\n" ) );
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ifOutBroadcastPkts_val_ptr );

    DEBUG_MSGTL( ( "verbose:ifXTable:ifOutBroadcastPkts_get", "called\n" ) );
    ...
    Int64_U64* ifHCInMulticastPkts_val_ptr )
{
     ...
     */
    ( *ifHCInMulticastPkts_val_ptr ).high = rowreq_ctx->data.ifHCInMulticastPkts.high;
    ( *ifHCInMulticastPkts_val_ptr ).low = rowreq_ctx->data.ifHCInMulticastPkts.low;
    ...
    Int64_U64* ifHCInBroadcastPkts_val_ptr )
{
     ...
     */
    ( *ifHCInBroadcastPkts_val_ptr ).high = rowreq_ctx->data.ifHCInBroadcastPkts.high;
    ( *ifHCInBroadcastPkts_val_ptr ).low = rowreq_ctx->data.ifHCInBroadcastPkts.low;
    ...
    Int64_U64* ifHCOutMulticastPkts_val_ptr )
{
     ...
     */
    ( *ifHCOutMulticastPkts_val_ptr ).high = rowreq_ctx->data.ifHCOutMulticastPkts.high;
    ( *ifHCOutMulticastPkts_val_ptr ).low = rowreq_ctx->data.ifHCOutMulticastPkts.low;
    ...
    Int64_U64* ifHCOutBroadcastPkts_val_ptr )
{
     ...
     */
    ( *ifHCOutBroadcastPkts_val_ptr ).high = rowreq_ctx->data.ifHCOutBroadcastPkts.high;
    ( *ifHCOutBroadcastPkts_val_ptr ).low = rowreq_ctx->data.ifHCOutBroadcastPkts.low;
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ifLinkUpDownTrapEnable_val_ptr );

    DEBUG_MSGTL( ( "verbose:ifXTable:ifLinkUpDownTrapEnable_get",
        "called\n" ) );
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ifHighSpeed_val_ptr );

    DEBUG_MSGTL( ( "verbose:ifXTable:ifHighSpeed_get", "called\n" ) );
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ifPromiscuousMode_val_ptr );

    DEBUG_MSGTL( ( "verbose:ifXTable:ifPromiscuousMode_get", "called\n" ) );
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ifConnectorPresent_val_ptr );

    DEBUG_MSGTL( ( "verbose:ifXTable:ifConnectorPresent_get", "called\n" ) );
...
{
    /** we should have a non-NULL pointer and enough storage */
    Assert_assert( ( NULL != ifAlias_val_ptr_ptr )
        && ( NULL != *ifAlias_val_ptr_ptr ) );
    Assert_assert( NULL != ifAlias_val_ptr_len_ptr );

    DEBUG_MSGTL( ( "verbose:ifXTable:ifAlias_get", "called\n" ) );
     ...
     */
    if ( ( NULL == ( *ifAlias_val_ptr_ptr ) ) || ( ( *ifAlias_val_ptr_len_ptr ) < ( rowreq_ctx->data.ifAlias_len * sizeof( rowreq_ctx->data.ifAlias[ 0 ] ) ) ) ) {
        /*
         * allocate space for ifAlias data
         */
        ( *ifAlias_val_ptr_ptr ) = ( char* )
            malloc( rowreq_ctx->data.ifAlias_len * sizeof( rowreq_ctx->data.ifAlias[ 0 ] ) );
        if ( NULL == ( *ifAlias_val_ptr_ptr ) ) {
            Logger_log( LOGGER_PRIORITY_ERR, "could not allocate memory\n" );
            return MFD_ERROR;
        }
    }
    ( *ifAlias_val_ptr_len_ptr ) = rowreq_ctx->data.ifAlias_len * sizeof( rowreq_ctx->data.ifAlias[ 0 ] );
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ifCounterDiscontinuityTime_val_ptr );

    DEBUG_MSGTL( ( "verbose:ifXTable:ifCounterDiscontinuityTime_get",
        "called\n" ) );
     ...
     */
    ( *ifCounterDiscontinuityTime_val_ptr ) = rowreq_ctx->data.ifCounterDiscontinuityTime;
...
int ifXTable_undo_setup( ifXTable_rowreq_ctx* rowreq_ctx )
{
    ...
    DEBUG_MSGTL( ( "verbose:ifXTable:ifXTable_undo_setup", "called\n" ) );
...
int ifXTable_undo( ifXTable_rowreq_ctx* rowreq_ctx )
{
    ...
    DEBUG_MSGTL( ( "verbose:ifXTable:ifXTable_undo", "called\n" ) );
...
int ifXTable_undo_cleanup( ifXTable_rowreq_ctx* rowreq_ctx )
{
    ...
    DEBUG_MSGTL( ( "verbose:ifXTable:ifXTable_undo_cleanup", "called\n" ) );
...
int ifXTable_commit( ifXTable_rowreq_ctx* rowreq_ctx )
{
    ...
    DEBUG_MSGTL( ( "verbose:ifXTable:ifXTable_commit", "called\n" ) );
...
int ifXTable_undo_commit( ifXTable_rowreq_ctx* rowreq_ctx )
{
    ...
    DEBUG_MSGTL( ( "verbose:ifXTable:ifXTable_undo_commit", "called\n" ) );
...
{
    DEBUG_MSGTL( ( "verbose:ifXTable:ifLinkUpDownTrapEnable_check_value",
        "called\n" ) );
...
{
    DEBUG_MSGTL( ( "verbose:ifXTable:ifLinkUpDownTrapEnable_undo_setup",
        "called\n" ) );
    ...
    u_long ifLinkUpDownTrapEnable_val )
{
    ...
    DEBUG_MSGTL( ( "verbose:ifXTable:ifLinkUpDownTrapEnable_set",
        "called\n" ) );
...
int ifLinkUpDownTrapEnable_undo( ifXTable_rowreq_ctx* rowreq_ctx )
{
    ...
    DEBUG_MSGTL( ( "verbose:ifXTable:ifLinkUpDownTrapEnable_undo",
        "called\n" ) );
...
{
    DEBUG_MSGTL( ( "verbose:ifXTable:ifPromiscuousMode_check_value",
        "called\n" ) );
...
{
    DEBUG_MSGTL( ( "verbose:ifXTable:ifPromiscuousMode_undo_setup",
        "called\n" ) );
    ...
    u_long ifPromiscuousMode_val )
{
    ...
    DEBUG_MSGTL( ( "verbose:ifXTable:ifPromiscuousMode_set", "called\n" ) );
...
int ifPromiscuousMode_undo( ifXTable_rowreq_ctx* rowreq_ctx )
{
    ...
    DEBUG_MSGTL( ( "verbose:ifXTable:ifPromiscuousMode_undo", "called\n" ) );
...
{
    DEBUG_MSGTL( ( "verbose:ifXTable:ifAlias_check_value", "called\n" ) );

    /** should never get a NULL pointer */
    Assert_assert( NULL != rowreq_ctx );
    Assert_assert( NULL != ifAlias_val_ptr );
...
{
    DEBUG_MSGTL( ( "verbose:ifXTable:ifAlias_undo_setup", "called\n" ) );
    ...
    size_t ifAlias_val_ptr_len )
{
    ...
    DEBUG_MSGTL( ( "verbose:ifXTable:ifAlias_set", "called\n" ) );
...
int ifAlias_undo( ifXTable_rowreq_ctx* rowreq_ctx )
{
    ...
    DEBUG_MSGTL( ( "verbose:ifXTable:ifAlias_undo", "called\n" ) );
...
int ifXTable_check_dependencies( ifXTable_rowreq_ctx* rowreq_ctx )
{
    ...
    DEBUG_MSGTL( ( "internal:ifXTable:ifXTable_check_dependencies",
        "called\n" ) );
