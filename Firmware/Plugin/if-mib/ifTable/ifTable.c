...
static int
_if_number_handler( MibHandler* handler,
...
void init_ifTable( void )
{
    ...
    DEBUG_MSGTL( ( "verbose:ifTable:init_ifTable", "called\n" ) );

    /*
     * TODO:300:o: Perform ifTable one-time module initialization.
     */
    if ( ++ifTable_did_init != 1 ) {
        DEBUG_MSGTL( ( "ifTable:init_ifTable", "ignoring duplicate call\n" ) );
        return;
    }
...
void initialize_table_ifTable( void )
{
    ...
    DEBUG_MSGTL( ( "verbose:ifTable:initialize_table_ifTable", "called\n" ) );
...
int ifTable_rowreq_ctx_init( ifTable_rowreq_ctx* rowreq_ctx,
    void* user_init_ctx )
{
    DEBUG_MSGTL( ( "verbose:ifTable:ifTable_rowreq_ctx_init", "called\n" ) );
    ...
    if ( NULL == user_init_ctx )
        rowreq_ctx->data.ifentry = netsnmp_access_interface_entry_create( NULL, 0 );
    else
...
{
    DEBUG_MSGTL( ( "verbose:ifTable:ifTable_rowreq_ctx_cleanup", "called\n" ) );
...
{
    DEBUG_MSGTL( ( "verbose:ifTable:ifTable_pre_request", "called\n" ) );
...
{
    DEBUG_MSGTL( ( "verbose:ifTable:ifTable_post_request", "called\n" ) );
...
{
    DEBUG_MSGTL( ( "verbose:ifTable:ifTable_indexes_set_tbl_idx",
        "called\n" ) );
...
{
    DEBUG_MSGTL( ( "verbose:ifTable:ifTable_indexes_set", "called\n" ) );

    if ( MFD_SUCCESS != ifTable_indexes_set_tbl_idx( &rowreq_ctx->tbl_idx, ifIndex_val ) )
        return MFD_ERROR;
    ...
    size_t* ifDescr_val_ptr_len_ptr )
{
    ...
    Assert_assert( ( NULL != ifDescr_val_ptr_ptr )
        && ( NULL != *ifDescr_val_ptr_ptr ) );
    Assert_assert( NULL != ifDescr_val_ptr_len_ptr );

    DEBUG_MSGTL( ( "verbose:ifTable:ifDescr_get", "called\n" ) );
     ...
     */
    if ( ( NULL == ( *ifDescr_val_ptr_ptr ) ) || ( ( *ifDescr_val_ptr_len_ptr ) < tmp_len ) ) {
        /*
         * allocate space for ifDescr data
         */
        ( *ifDescr_val_ptr_ptr ) = ( char* )malloc( tmp_len * sizeof( rowreq_ctx->data.ifDescr[ 0 ] ) );
...
int ifType_get( ifTable_rowreq_ctx* rowreq_ctx, u_long* ifType_val_ptr )
{
    ...
    Assert_assert( NULL != ifType_val_ptr );

    DEBUG_MSGTL( ( "verbose:ifTable:ifType_get", "called\n" ) );
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ifMtu_val_ptr );

    DEBUG_MSGTL( ( "verbose:ifTable:ifMtu_get", "called\n" ) );
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ifSpeed_val_ptr );

    DEBUG_MSGTL( ( "verbose:ifTable:ifSpeed_get", "called\n" ) );
...
{
    /** we should have a non-NULL pointer and enough storage */
    Assert_assert( ( NULL != ifPhysAddress_val_ptr_ptr )
        && ( NULL != *ifPhysAddress_val_ptr_ptr ) );
    Assert_assert( NULL != ifPhysAddress_val_ptr_len_ptr );

    DEBUG_MSGTL( ( "verbose:ifTable:ifPhysAddress_get", "called\n" ) );

    Assert_assert( NULL != rowreq_ctx );

    if ( ( rowreq_ctx->data.ifPhysAddress[ 0 ] == 0 ) && ( rowreq_ctx->data.ifPhysAddress[ 1 ] == 0 ) && ( rowreq_ctx->data.ifPhysAddress[ 2 ] == 0 ) && ( rowreq_ctx->data.ifPhysAddress[ 3 ] == 0 ) && ( rowreq_ctx->data.ifPhysAddress[ 4 ] == 0 ) && ( rowreq_ctx->data.ifPhysAddress[ 5 ] == 0 ) ) {
        /*
         * all 0s = empty string
         */
     ...
     */
    if ( ( NULL == ( *ifPhysAddress_val_ptr_ptr ) ) || ( ( *ifPhysAddress_val_ptr_len_ptr ) < ( rowreq_ctx->data.ifPhysAddress_len * sizeof( rowreq_ctx->data.ifPhysAddress[ 0 ] ) ) ) ) {
        /*
         * allocate space for ifPhysAddress data
         */
        ( *ifPhysAddress_val_ptr_ptr ) = ( char* )malloc( rowreq_ctx->data.ifPhysAddress_len * sizeof( rowreq_ctx->data.ifPhysAddress[ 0 ] ) );
        if ( NULL == ( *ifPhysAddress_val_ptr_ptr ) ) {
            Logger_log( LOGGER_PRIORITY_ERR, "could not allocate memory\n" );
            return MFD_ERROR;
        }
    }
    ( *ifPhysAddress_val_ptr_len_ptr ) = rowreq_ctx->data.ifPhysAddress_len * sizeof( rowreq_ctx->data.ifPhysAddress[ 0 ] );
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ifAdminStatus_val_ptr );

    DEBUG_MSGTL( ( "verbose:ifTable:ifAdminStatus_get", "called\n" ) );
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ifOperStatus_val_ptr );

    DEBUG_MSGTL( ( "verbose:ifTable:ifOperStatus_get", "called\n" ) );
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ifLastChange_val_ptr );

    DEBUG_MSGTL( ( "verbose:ifTable:ifLastChange_get", "called\n" ) );
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ifInOctets_val_ptr );

    DEBUG_MSGTL( ( "verbose:ifTable:ifInOctets_get", "called\n" ) );
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ifInUcastPkts_val_ptr );

    DEBUG_MSGTL( ( "verbose:ifTable:ifInUcastPkts_get", "called\n" ) );
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ifInNUcastPkts_val_ptr );

    DEBUG_MSGTL( ( "verbose:ifTable:ifInNUcastPkts_get", "called\n" ) );
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ifInDiscards_val_ptr );

    DEBUG_MSGTL( ( "verbose:ifTable:ifInDiscards_get", "called\n" ) );
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ifInErrors_val_ptr );

    DEBUG_MSGTL( ( "verbose:ifTable:ifInErrors_get", "called\n" ) );
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ifInUnknownProtos_val_ptr );

    DEBUG_MSGTL( ( "verbose:ifTable:ifInUnknownProtos_get", "called\n" ) );
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ifOutOctets_val_ptr );

    DEBUG_MSGTL( ( "verbose:ifTable:ifOutOctets_get", "called\n" ) );
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ifOutUcastPkts_val_ptr );

    DEBUG_MSGTL( ( "verbose:ifTable:ifOutUcastPkts_get", "called\n" ) );
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ifOutNUcastPkts_val_ptr );

    DEBUG_MSGTL( ( "verbose:ifTable:ifOutNUcastPkts_get", "called\n" ) );
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ifOutDiscards_val_ptr );

    DEBUG_MSGTL( ( "verbose:ifTable:ifOutDiscards_get", "called\n" ) );
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ifOutErrors_val_ptr );

    DEBUG_MSGTL( ( "verbose:ifTable:ifOutErrors_get", "called\n" ) );
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ifOutQLen_val_ptr );

    DEBUG_MSGTL( ( "verbose:ifTable:ifOutQLen_get", "called\n" ) );
...
{
    /** we should have a non-NULL pointer and enough storage */
    Assert_assert( ( NULL != ifSpecific_val_ptr_ptr )
        && ( NULL != *ifSpecific_val_ptr_ptr ) );
    Assert_assert( NULL != ifSpecific_val_ptr_len_ptr );

    DEBUG_MSGTL( ( "verbose:ifTable:ifSpecific_get", "called\n" ) );
     ...
     * hard coded
     */
    Assert_assert( ( *ifSpecific_val_ptr_len_ptr ) > ( size_t )vars_nullOidLen );
    ( *ifSpecific_val_ptr_len_ptr ) = ( size_t )vars_nullOidLen;
    memcpy( *ifSpecific_val_ptr_ptr, &vars_nullOid, ( size_t )vars_nullOidLen );
...
int ifTable_undo_setup( ifTable_rowreq_ctx* rowreq_ctx )
{
    ...
    DEBUG_MSGTL( ( "verbose:ifTable:ifTable_undo_setup", "called\n" ) );
...
int ifTable_undo( ifTable_rowreq_ctx* rowreq_ctx )
{
    ...
    DEBUG_MSGTL( ( "verbose:ifTable:ifTable_undo", "called\n" ) );
...
int ifTable_undo_cleanup( ifTable_rowreq_ctx* rowreq_ctx )
{
    ...
    DEBUG_MSGTL( ( "verbose:ifTable:ifTable_undo_cleanup", "called\n" ) );
...
int ifTable_commit( ifTable_rowreq_ctx* rowreq_ctx )
{
    ...
    DEBUG_MSGTL( ( "verbose:ifTable:ifTable_commit", "called\n" ) );
...
int ifTable_undo_commit( ifTable_rowreq_ctx* rowreq_ctx )
{
    ...
    DEBUG_MSGTL( ( "verbose:ifTable:ifTable_undo_commit", "called\n" ) );
...
{
    DEBUG_MSGTL( ( "verbose:ifTable:ifAdminStatus_check_value", "called\n" ) );
...
{
    DEBUG_MSGTL( ( "verbose:ifTable:ifAdminStatus_undo_setup", "called\n" ) );
    ...
    u_long ifAdminStatus_val )
{
    ...
    DEBUG_MSGTL( ( "verbose:ifTable:ifAdminStatus_set", "called\n" ) );
...
int ifAdminStatus_undo( ifTable_rowreq_ctx* rowreq_ctx )
{
    ...
    DEBUG_MSGTL( ( "verbose:ifTable:ifAdminStatus_undo", "called\n" ) );
...
int ifTable_check_dependencies( ifTable_rowreq_ctx* rowreq_ctx )
{
    ...
    DEBUG_MSGTL( ( "internal:ifTable:ifTable_check_dependencies",
        "called\n" ) );
