 ...
 */
#define MFD_SUCCESS              PRIOT_ERR_NOERROR
#define MFD_ERROR                PRIOT_ERR_GENERR

/*
 * object not currently available
 */
#define MFD_SKIP                 PRIOT_NOSUCHINSTANCE

/*
 * no more data in table (get-next)
 */
#define MFD_END_OF_DATA          PRIOT_ENDOFMIBVIEW
 ...
 * row creation errors
 */
#define MFD_CANNOT_CREATE_NOW    PRIOT_ERR_INCONSISTENTNAME
#define MFD_CANNOT_CREATE_EVER   PRIOT_ERR_NOCREATION

/*
 * not writable or resource unavailable
 */
#define MFD_NOT_WRITABLE         PRIOT_ERR_NOTWRITABLE
#define MFD_RESOURCE_UNAVAILABLE PRIOT_ERR_RESOURCEUNAVAILABLE

/*
 * new value errors
 */
#define MFD_NOT_VALID_NOW        PRIOT_ERR_INCONSISTENTVALUE
#define MFD_NOT_VALID_EVER       PRIOT_ERR_WRONGVALUE
