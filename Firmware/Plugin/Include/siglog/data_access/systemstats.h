 ...
 * init
 */
Container_Container * netsnmp_access_systemstats_container_init(u_int init_flags);
 ...
 */
Container_Container*
netsnmp_access_systemstats_container_load(Container_Container* container,
                                    u_int load_flags);
#define NETSNMP_ACCESS_SYSTEMSTATS_LOAD_NOFLAGS               0x0000
#define NETSNMP_ACCESS_SYSTEMSTATS_LOAD_IFTABLE               0x0001 

void netsnmp_access_systemstats_container_free(Container_Container *container,
                                         u_int free_flags);
