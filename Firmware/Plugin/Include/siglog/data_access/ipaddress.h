 ...
 * ifcontainer init
 */
Container_Container * netsnmp_access_ipaddress_container_init(u_int init_flags);
...
void netsnmp_access_ipaddress_container_free(Container_Container *container,
                                         u_int free_flags);
