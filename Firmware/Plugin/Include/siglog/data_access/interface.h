 ...
 * ifcontainer init
 */
Container_Container * netsnmp_access_interface_container_init(u_int init_flags);
 ...
 */
Container_Container*
netsnmp_access_interface_container_load(Container_Container* container,
                                        u_int load_flags);
...
void netsnmp_access_interface_container_free(Container_Container *container,
                                             u_int free_flags);
...
netsnmp_access_interface_entry_get_by_name(Container_Container *container,
                                           const char *name);
netsnmp_interface_entry *
netsnmp_access_interface_entry_get_by_index(Container_Container *container,
                                            oid index);
