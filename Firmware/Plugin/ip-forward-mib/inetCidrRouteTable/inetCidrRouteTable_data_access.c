 ...
 */
int inetCidrRouteTable_init_data( inetCidrRouteTable_registration*
        inetCidrRouteTable_reg )
{
    DEBUG_MSGTL( ( "verbose:inetCidrRouteTable:inetCidrRouteTable_init_data",
        "called\n" ) );
 ...
 */
void inetCidrRouteTable_container_init( Container_Container** container_ptr_ptr,
    Cache* cache )
{
    DEBUG_MSGTL( ( "verbose:inetCidrRouteTable:inetCidrRouteTable_container_init", "called\n" ) );
    ...
    Container_Container* container )
{
    ...
    Assert_assert( NULL != route_entry );
    ...
    if ( route_entry->rt_type == 0 ) { /* set when route not up */
        DEBUG_MSGT( ( "verbose:inetCidrRouteTable:inetCidrRouteTable_cache_load", "skipping route\n" ) );
 ...
 */
void inetCidrRouteTable_container_shutdown( Container_Container* container_ptr )
{
    DEBUG_MSGTL( ( "verbose:inetCidrRouteTable:inetCidrRouteTable_container_shutdown", "called\n" ) );
 ...
 *
 */
int inetCidrRouteTable_container_load( Container_Container* container )
{
    Container_Container* route_container;

    DEBUG_MSGTL( ( "verbose:inetCidrRouteTable:inetCidrRouteTable_container_load", "called\n" ) );
     ...
     */
    route_container = netsnmp_access_route_container_load( NULL,
        NETSNMP_ACCESS_ROUTE_LOAD_NOFLAGS );
    DEBUG_MSGT( ( "verbose:inetCidrRouteTable:inetCidrRouteTable_cache_load",
    ...
    CONTAINER_FOR_EACH( route_container,
        ( Container_FuncObjFunc* )_snarf_route_entry,
        container );
 ...
 *
 */
void inetCidrRouteTable_container_free( Container_Container* container )
{
    DEBUG_MSGTL( ( "verbose:inetCidrRouteTable:inetCidrRouteTable_container_free", "called\n" ) );
...
{
    DEBUG_MSGTL( ( "verbose:inetCidrRouteTable:inetCidrRouteTable_row_prep",
        "called\n" ) );
    ...
    if ( MFD_ROW_CREATED & rowreq_ctx->rowreq_flags ) {
        ...
        rowreq_ctx->data->rt_dest_len = rowreq_ctx->tbl_idx.inetCidrRouteDest_len;
        rowreq_ctx->data->rt_dest_type = rowreq_ctx->tbl_idx.inetCidrRouteDestType;

        memcpy( rowreq_ctx->data->rt_nexthop,
            rowreq_ctx->tbl_idx.inetCidrRouteNextHop,
            rowreq_ctx->tbl_idx.inetCidrRouteNextHop_len );
        rowreq_ctx->data->rt_nexthop_len = rowreq_ctx->tbl_idx.inetCidrRouteNextHop_len;
        rowreq_ctx->data->rt_nexthop_type = rowreq_ctx->tbl_idx.inetCidrRouteNextHopType;

        rowreq_ctx->data->rt_pfx_len = rowreq_ctx->tbl_idx.inetCidrRoutePfxLen;

        rowreq_ctx->data->rt_policy_len = rowreq_ctx->tbl_idx.inetCidrRoutePolicy_len;
 ...
 */
int inetCidrRouteDestType_check_index( inetCidrRouteTable_rowreq_ctx*
        rowreq_ctx )
{
    DEBUG_MSGTL( ( "verbose:inetCidrRouteTable:inetCidrRouteDestType_check_index", "called\n" ) );
...
{
    DEBUG_MSGTL( ( "verbose:inetCidrRouteTable:inetCidrRouteDest_check_index",
        "called\n" ) );
...
{
    DEBUG_MSGTL( ( "verbose:inetCidrRouteTable:inetCidrRoutePfxLen_check_index", "called\n" ) );
...
{
    DEBUG_MSGTL( ( "verbose:inetCidrRouteTable:inetCidrRoutePolicy_check_index", "called\n" ) );
 ...
 * If there a no other checks you need to do, simply return MFD_SUCCESS.
 */
int inetCidrRouteNextHopType_check_index( inetCidrRouteTable_rowreq_ctx*
        rowreq_ctx )
{
    DEBUG_MSGTL( ( "verbose:inetCidrRouteTable:inetCidrRouteNextHopType_check_index", "called\n" ) );
 ...
 * If there a no other checks you need to do, simply return MFD_SUCCESS.
 */
int inetCidrRouteNextHop_check_index( inetCidrRouteTable_rowreq_ctx*
        rowreq_ctx )
{
    DEBUG_MSGTL( ( "verbose:inetCidrRouteTable:inetCidrRouteNextHop_check_index", "called\n" ) );
 ...
 */
int inetCidrRouteTable_validate_index( inetCidrRouteTable_registration*
                                           inetCidrRouteTable_reg,
        ...
        rowreq_ctx )
{
    ...
    DEBUG_MSGTL( ( "verbose:inetCidrRouteTable:inetCidrRouteTable_validate_index", "called\n" ) );
     ...
     */
    if ( rowreq_ctx->tbl_idx.inetCidrRouteDestType != rowreq_ctx->tbl_idx.inetCidrRouteNextHopType ) {
        DEBUG_MSGTL( ( "inetCidrRouteTable:validate_index",
