...
#define INETCIDRROUTETABLE_CACHE_TIMEOUT   60
    ...
    void            inetCidrRouteTable_container_init(Container_Container
                                                      **container_ptr_ptr,
                                                      Cache *
                                                      cache);
    void            inetCidrRouteTable_container_shutdown(Container_Container
                                                          *container_ptr);

    int             inetCidrRouteTable_container_load(Container_Container
                                                      *container);
    void            inetCidrRouteTable_container_free(Container_Container
                                                      *container);

    int             inetCidrRouteTable_cache_load(Container_Container
                                                  *container);
    void            inetCidrRouteTable_cache_free(Container_Container
                                                  *container);
