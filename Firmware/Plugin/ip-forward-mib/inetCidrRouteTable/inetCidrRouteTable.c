...
int _route_number_handler( MibHandler* handler,
...
{
    DEBUG_MSGTL( ( "verbose:inetCidrRouteTable:init_inetCidrRouteTable",
        "called\n" ) );
...
void initialize_table_inetCidrRouteTable( void )
{
    ...
    DEBUG_MSGTL( ( "verbose:inetCidrRouteTable:initialize_table_inetCidrRouteTable", "called\n" ) );
     ...
     */
    _inetCidrRouteTable_initialize_interface( inetCidrRouteTable_user_context_p, flags );
     ...
     */
    {
         ...
         */
        Assert_assert( NULL != inetCidrRouteTable_get_cache() );
        handler = CacheHandler_handlerGet( inetCidrRouteTable_get_cache() );
        AgentHandler_injectHandler( myreg, handler );

        Instance_registerInstance( myreg );
    }
} /* initialize_table_inetCidrRouteTable */
 ...
 */
int inetCidrRouteTable_rowreq_ctx_init( inetCidrRouteTable_rowreq_ctx*
                                            rowreq_ctx,
    void* user_init_ctx )
{
    DEBUG_MSGTL( ( "verbose:inetCidrRouteTable:inetCidrRouteTable_rowreq_ctx_init", "called\n" ) );
 ...
 *
 */
void inetCidrRouteTable_rowreq_ctx_cleanup( inetCidrRouteTable_rowreq_ctx*
        rowreq_ctx )
{
    DEBUG_MSGTL( ( "verbose:inetCidrRouteTable:inetCidrRouteTable_rowreq_ctx_cleanup", "called\n" ) );
 ...
 */
int inetCidrRouteTable_pre_request( inetCidrRouteTable_registration*
        user_context )
{
    DEBUG_MSGTL( ( "verbose:inetCidrRouteTable:inetCidrRouteTable_pre_request", "called\n" ) );
 ...
 */
int inetCidrRouteTable_post_request( inetCidrRouteTable_registration*
                                         user_context,
    int rc )
{
    DEBUG_MSGTL( ( "verbose:inetCidrRouteTable:inetCidrRouteTable_post_request", "called\n" ) );
...
inetCidrRouteTable_allocate_data( void )
{
    ...
    DEBUG_MSGTL( ( "verbose:inetCidrRouteTable:inetCidrRouteTable_allocate_data", "called\n" ) );
...
{
    DEBUG_MSGTL( ( "verbose:inetCidrRouteTable:inetCidrRouteTable_release_data", "called\n" ) );
 ...
 */
int inetCidrRouteTable_indexes_set_tbl_idx( inetCidrRouteTable_mib_index*
                                                tbl_idx,
...
{
    DEBUG_MSGTL( ( "verbose:inetCidrRouteTable:inetCidrRouteTable_indexes_set_tbl_idx", "called\n" ) );
     ...
     */
    if ( ( NULL == tbl_idx->inetCidrRouteDest ) || ( tbl_idx->inetCidrRouteDest_len < ( inetCidrRouteDest_val_ptr_len ) ) ) {
    ...
    memcpy( tbl_idx->inetCidrRouteDest, inetCidrRouteDest_val_ptr,
        inetCidrRouteDest_val_ptr_len * sizeof( inetCidrRouteDest_val_ptr[ 0 ] ) );
     ...
     */
    if ( ( NULL == tbl_idx->inetCidrRoutePolicy ) || ( tbl_idx->inetCidrRoutePolicy_len < ( inetCidrRoutePolicy_val_ptr_len / sizeof( inetCidrRoutePolicy_val_ptr[ 0 ] ) ) ) ) {
    ...
    if ( 0 == inetCidrRoutePolicy_val_ptr_len ) {
        inetCidrRoutePolicy_val_ptr_len = vars_nullOidLen;
        inetCidrRoutePolicy_val_ptr = vars_nullOid;
    }
     ...
     */
    if ( ( NULL == tbl_idx->inetCidrRouteNextHop ) || ( tbl_idx->inetCidrRouteNextHop_len < ( inetCidrRouteNextHop_val_ptr_len / sizeof( inetCidrRouteNextHop_val_ptr[ 0 ] ) ) ) ) {
        Logger_log( LOGGER_PRIORITY_ERR,
 ...
 *  from the mib index.
 */
int inetCidrRouteTable_indexes_set( inetCidrRouteTable_rowreq_ctx* rowreq_ctx,
    u_long inetCidrRouteDestType_val,
    char* inetCidrRouteDest_val_ptr,
...
{
    DEBUG_MSGTL( ( "verbose:inetCidrRouteTable:inetCidrRouteTable_indexes_set", "called\n" ) );

    if ( MFD_SUCCESS != inetCidrRouteTable_indexes_set_tbl_idx( &rowreq_ctx->tbl_idx,
 ...
 * The net-snmp type is ASN01_INTEGER. The C type decl is long (long)
 */
/**
    ...
    long* inetCidrRouteIfIndex_val_ptr )
{
    ...
    Assert_assert( NULL != inetCidrRouteIfIndex_val_ptr );

    DEBUG_MSGTL( ( "verbose:inetCidrRouteTable:inetCidrRouteIfIndex_get",
        "called\n" ) );
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != inetCidrRouteType_val_ptr );

    DEBUG_MSGTL( ( "verbose:inetCidrRouteTable:inetCidrRouteType_get",
        "called\n" ) );
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != inetCidrRouteProto_val_ptr );

    DEBUG_MSGTL( ( "verbose:inetCidrRouteTable:inetCidrRouteProto_get",
        "called\n" ) );
 ...
 * The net-snmp type is ASN01_GAUGE. The C type decl is u_long (u_long)
 */
/**
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != inetCidrRouteAge_val_ptr );

    DEBUG_MSGTL( ( "verbose:inetCidrRouteTable:inetCidrRouteAge_get",
        "called\n" ) );
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != inetCidrRouteNextHopAS_val_ptr );

    DEBUG_MSGTL( ( "verbose:inetCidrRouteTable:inetCidrRouteNextHopAS_get",
        "called\n" ) );
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != inetCidrRouteMetric1_val_ptr );

    DEBUG_MSGTL( ( "verbose:inetCidrRouteTable:inetCidrRouteMetric1_get",
        "called\n" ) );
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != inetCidrRouteMetric2_val_ptr );

    DEBUG_MSGTL( ( "verbose:inetCidrRouteTable:inetCidrRouteMetric2_get",
        "called\n" ) );
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != inetCidrRouteMetric3_val_ptr );

    DEBUG_MSGTL( ( "verbose:inetCidrRouteTable:inetCidrRouteMetric3_get",
        "called\n" ) );
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != inetCidrRouteMetric4_val_ptr );

    DEBUG_MSGTL( ( "verbose:inetCidrRouteTable:inetCidrRouteMetric4_get",
        "called\n" ) );
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != inetCidrRouteMetric5_val_ptr );

    DEBUG_MSGTL( ( "verbose:inetCidrRouteTable:inetCidrRouteMetric5_get",
        "called\n" ) );
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != inetCidrRouteStatus_val_ptr );
...
int inetCidrRouteTable_undo_setup( inetCidrRouteTable_rowreq_ctx* rowreq_ctx )
{
    ...
    DEBUG_MSGTL( ( "verbose:inetCidrRouteTable:inetCidrRouteTable_undo_setup",
        "called\n" ) );
...
int inetCidrRouteTable_undo( inetCidrRouteTable_rowreq_ctx* rowreq_ctx )
{
    ...
    DEBUG_MSGTL( ( "verbose:inetCidrRouteTable:inetCidrRouteTable_undo",
        "called\n" ) );
...
int inetCidrRouteTable_undo_cleanup( inetCidrRouteTable_rowreq_ctx* rowreq_ctx )
{
    ...
    DEBUG_MSGTL( ( "verbose:inetCidrRouteTable:inetCidrRouteTable_undo_cleanup", "called\n" ) );
...
int inetCidrRouteTable_commit( inetCidrRouteTable_rowreq_ctx* rowreq_ctx )
{
    ...
    DEBUG_MSGTL( ( "verbose:inetCidrRouteTable:inetCidrRouteTable_commit",
        "called\n" ) );
     ...
     */
    if ( 0 == save_flags ) {
        DEBUG_MSGTL( ( "ipAddressTable:ipAddressTable_commit",
            "no change\n" ) );
        return MFD_SUCCESS;
    }
    ...
    if ( save_flags & COLUMN_INETCIDRROUTESTATUS_FLAG ) {
        if ( rowreq_ctx->rowreq_flags & MFD_ROW_CREATED ) {
            ...
            Assert_assert( ROWSTATUS_ACTIVE == rowreq_ctx->row_status );
     ...
     */
    rowreq_ctx->data->flags |= ( save_flags & NETSNMP_ACCESS_ROUTE_RESERVED_BITS );
...
int inetCidrRouteTable_undo_commit( inetCidrRouteTable_rowreq_ctx* rowreq_ctx )
{
    ...
    DEBUG_MSGTL( ( "verbose:inetCidrRouteTable:inetCidrRouteTable_undo_commit", "called\n" ) );
 ...
 *
 */
int inetCidrRouteIfIndex_check_value( inetCidrRouteTable_rowreq_ctx*
                                          rowreq_ctx,
    long inetCidrRouteIfIndex_val )
{
    DEBUG_MSGTL( ( "verbose:inetCidrRouteTable:inetCidrRouteIfIndex_check_value", "called\n" ) );
    ...
    long inetCidrRouteIfIndex_val )
{
    ...
    DEBUG_MSGTL( ( "verbose:inetCidrRouteTable:inetCidrRouteIfIndex_set",
        "called\n" ) );
...
{
    DEBUG_MSGTL( ( "verbose:inetCidrRouteTable:inetCidrRouteType_check_value",
        "called\n" ) );
    ...
    u_long inetCidrRouteType_val )
{
    ...
    DEBUG_MSGTL( ( "verbose:inetCidrRouteTable:inetCidrRouteType_set",
        "called\n" ) );
 ...
 *
 * The following checks have already been done for you:
 *    The syntax is ASN01_UNSIGNED
 *
 * If there a no other checks you need to do, simply return MFD_SUCCESS.
 *
 */
int inetCidrRouteNextHopAS_check_value( inetCidrRouteTable_rowreq_ctx*
                                            rowreq_ctx,
    u_long inetCidrRouteNextHopAS_val )
{
    DEBUG_MSGTL( ( "verbose:inetCidrRouteTable:inetCidrRouteNextHopAS_check_value", "called\n" ) );
    ...
    u_long inetCidrRouteNextHopAS_val )
{
    ...
    DEBUG_MSGTL( ( "verbose:inetCidrRouteTable:inetCidrRouteNextHopAS_set",
        "called\n" ) );
 ...
 *
 */
int inetCidrRouteMetric1_check_value( inetCidrRouteTable_rowreq_ctx*
                                          rowreq_ctx,
    long inetCidrRouteMetric1_val )
{
    DEBUG_MSGTL( ( "verbose:inetCidrRouteTable:inetCidrRouteMetric1_check_value", "called\n" ) );
    ...
    long inetCidrRouteMetric1_val )
{
    ...
    DEBUG_MSGTL( ( "verbose:inetCidrRouteTable:inetCidrRouteMetric1_set",
        "called\n" ) );
 ...
 *
 */
int inetCidrRouteMetric2_check_value( inetCidrRouteTable_rowreq_ctx*
                                          rowreq_ctx,
    long inetCidrRouteMetric2_val )
{
    DEBUG_MSGTL( ( "verbose:inetCidrRouteTable:inetCidrRouteMetric2_check_value", "called\n" ) );
    ...
    long inetCidrRouteMetric2_val )
{
    ...
    DEBUG_MSGTL( ( "verbose:inetCidrRouteTable:inetCidrRouteMetric2_set",
        "called\n" ) );
 ...
 *
 */
int inetCidrRouteMetric3_check_value( inetCidrRouteTable_rowreq_ctx*
                                          rowreq_ctx,
    long inetCidrRouteMetric3_val )
{
    DEBUG_MSGTL( ( "verbose:inetCidrRouteTable:inetCidrRouteMetric3_check_value", "called\n" ) );
    ...
    long inetCidrRouteMetric3_val )
{
    ...
    DEBUG_MSGTL( ( "verbose:inetCidrRouteTable:inetCidrRouteMetric3_set",
        "called\n" ) );
 ...
 *
 */
int inetCidrRouteMetric4_check_value( inetCidrRouteTable_rowreq_ctx*
                                          rowreq_ctx,
    long inetCidrRouteMetric4_val )
{
    DEBUG_MSGTL( ( "verbose:inetCidrRouteTable:inetCidrRouteMetric4_check_value", "called\n" ) );
    ...
    long inetCidrRouteMetric4_val )
{
    ...
    DEBUG_MSGTL( ( "verbose:inetCidrRouteTable:inetCidrRouteMetric4_set",
        "called\n" ) );
 ...
 *
 */
int inetCidrRouteMetric5_check_value( inetCidrRouteTable_rowreq_ctx*
                                          rowreq_ctx,
    long inetCidrRouteMetric5_val )
{
    DEBUG_MSGTL( ( "verbose:inetCidrRouteTable:inetCidrRouteMetric5_check_value", "called\n" ) );
    ...
    long inetCidrRouteMetric5_val )
{
    ...
    DEBUG_MSGTL( ( "verbose:inetCidrRouteTable:inetCidrRouteMetric5_set",
        "called\n" ) );
...
{
    DEBUG_MSGTL( ( "verbose:inetCidrRouteTable:inetCidrRouteStatus_check_value", "called\n" ) );
    ...
    u_long inetCidrRouteStatus_val )
{
    ...
    DEBUG_MSGTL( ( "verbose:inetCidrRouteTable:inetCidrRouteStatus_set",
        "called\n" ) );
 ...
 */
int inetCidrRouteTable_check_dependencies( inetCidrRouteTable_rowreq_ctx*
        rowreq_ctx )
{
    int rc = MFD_SUCCESS;

    DEBUG_MSGTL( ( "internal:inetCidrRouteTable:inetCidrRouteTable_check_dependencies", "called\n" ) );
     ...
     */
    if ( ( ROWSTATUS_ACTIVE == rowreq_ctx->row_status ) && ( ROWSTATUS_ACTIVE == rowreq_ctx->row_status_undo ) ) {
        DEBUG_MSGTL( ( "inetCidrRouteTable",
    ...
    if ( rowreq_ctx->column_set_flags & COLUMN_INETCIDRROUTESTATUS_FLAG ) {
        ...
        if ( rowreq_ctx->rowreq_flags & MFD_ROW_CREATED ) {
            if ( ROWSTATUS_DESTROY == rowreq_ctx->row_status ) {
                ...
                if ( ( rowreq_ctx->column_set_flags & INETCIDRROUTETABLE_REQUIRED_COLS )
