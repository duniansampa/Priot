 ...
 */
int ipCidrRouteTable_init_data( ipCidrRouteTable_registration*
        ipCidrRouteTable_reg )
{
    DEBUG_MSGTL( ( "verbose:ipCidrRouteTable:ipCidrRouteTable_init_data",
        "called\n" ) );
 ...
 */
void ipCidrRouteTable_container_init( Container_Container** container_ptr_ptr,
    Cache* cache )
{
    DEBUG_MSGTL( ( "verbose:ipCidrRouteTable:ipCidrRouteTable_container_init",
        "called\n" ) );
    ...
    Container_Container* container )
{
    ...
    if ( ( NULL != rowreq_ctx ) && ( MFD_SUCCESS == ipCidrRouteTable_indexes_set( rowreq_ctx, *( ( in_addr_t* )route_entry->rt_dest ),
 ...
 */
void ipCidrRouteTable_container_shutdown( Container_Container* container_ptr )
{
    DEBUG_MSGTL( ( "verbose:ipCidrRouteTable:ipCidrRouteTable_container_shutdown", "called\n" ) );
 ...
 *
 */
int ipCidrRouteTable_container_load( Container_Container* container )
{
    Container_Container* route_container;

    DEBUG_MSGTL( ( "verbose:ipCidrRouteTable:ipCidrRouteTable_cache_load",
        "called\n" ) );
    ...
    DEBUG_MSGT( ( "verbose:ipCidrRouteTable:ipCidrRouteTable_cache_load",
 ...
 *
 */
void ipCidrRouteTable_container_free( Container_Container* container )
{
    DEBUG_MSGTL( ( "verbose:ipCidrRouteTable:ipCidrRouteTable_container_free",
        "called\n" ) );
...
{
    DEBUG_MSGTL( ( "verbose:ipCidrRouteTable:ipCidrRouteTable_row_prep",
        "called\n" ) );
 ...
 * The net-snmp type is ASN01_IPADDRESS. The C type decl is u_long (u_long)
 */
/**
...
{
    DEBUG_MSGTL( ( "verbose:ipCidrRouteTable:ipCidrRouteDest_check_index",
        "called\n" ) );
...
{
    DEBUG_MSGTL( ( "verbose:ipCidrRouteTable:ipCidrRouteMask_check_index",
        "called\n" ) );
...
{
    DEBUG_MSGTL( ( "verbose:ipCidrRouteTable:ipCidrRouteTos_check_index",
        "called\n" ) );
...
{
    DEBUG_MSGTL( ( "verbose:ipCidrRouteTable:ipCidrRouteNextHop_check_index",
        "called\n" ) );
 ...
 */
int ipCidrRouteTable_validate_index( ipCidrRouteTable_registration*
                                         ipCidrRouteTable_reg,
    ipCidrRouteTable_rowreq_ctx* rowreq_ctx )
{
    int rc = MFD_SUCCESS;

    DEBUG_MSGTL( ( "verbose:ipCidrRouteTable:ipCidrRouteTable_validate_index",
        "called\n" ) );
