...
{
    DEBUG_MSGTL( ( "verbose:ipCidrRouteTable:init_ipCidrRouteTable",
        "called\n" ) );
...
void initialize_table_ipCidrRouteTable( void )
{
    ...
    DEBUG_MSGTL( ( "verbose:ipCidrRouteTable:initialize_table_ipCidrRouteTable", "called\n" ) );
     ...
     */
    _ipCidrRouteTable_initialize_interface( ipCidrRouteTable_user_context_p, flags );
} /* initialize_table_ipCidrRouteTable */
...
int ipCidrRouteTable_rowreq_ctx_init( ipCidrRouteTable_rowreq_ctx* rowreq_ctx,
    void* user_init_ctx )
{
    DEBUG_MSGTL( ( "verbose:ipCidrRouteTable:ipCidrRouteTable_rowreq_ctx_init", "called\n" ) );
 ...
 *
 */
void ipCidrRouteTable_rowreq_ctx_cleanup( ipCidrRouteTable_rowreq_ctx*
        rowreq_ctx )
{
    DEBUG_MSGTL( ( "verbose:ipCidrRouteTable:ipCidrRouteTable_rowreq_ctx_cleanup", "called\n" ) );
...
{
    DEBUG_MSGTL( ( "verbose:ipCidrRouteTable:ipCidrRouteTable_pre_request",
        "called\n" ) );
...
int ipCidrRouteTable_post_request( ipCidrRouteTable_registration* user_context,
    int rc )
{
    DEBUG_MSGTL( ( "verbose:ipCidrRouteTable:ipCidrRouteTable_post_request",
        "called\n" ) );
...
ipCidrRouteTable_allocate_data( void )
{
    ...
    DEBUG_MSGTL( ( "verbose:ipCidrRouteTable:ipCidrRouteTable_allocate_data",
        "called\n" ) );
...
{
    DEBUG_MSGTL( ( "verbose:ipCidrRouteTable:ipCidrRouteTable_release_data",
        "called\n" ) );
...
{
    DEBUG_MSGTL( ( "verbose:ipCidrRouteTable:ipCidrRouteTable_indexes_set_tbl_idx", "called\n" ) );
...
int ipCidrRouteTable_indexes_set( ipCidrRouteTable_rowreq_ctx* rowreq_ctx,
    ...
    in_addr_t ipCidrRouteNextHop_val )
{
    DEBUG_MSGTL( ( "verbose:ipCidrRouteTable:ipCidrRouteTable_indexes_set",
        "called\n" ) );

    if ( MFD_SUCCESS != ipCidrRouteTable_indexes_set_tbl_idx( &rowreq_ctx->tbl_idx,
                            ipCidrRouteDest_val,
                            ipCidrRouteMask_val,
                            ipCidrRouteTos_val,
    ...
    long* ipCidrRouteIfIndex_val_ptr )
{
    ...
    Assert_assert( NULL != ipCidrRouteIfIndex_val_ptr );

    DEBUG_MSGTL( ( "verbose:ipCidrRouteTable:ipCidrRouteIfIndex_get",
        "called\n" ) );
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ipCidrRouteType_val_ptr );

    DEBUG_MSGTL( ( "verbose:ipCidrRouteTable:ipCidrRouteType_get",
        "called\n" ) );
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ipCidrRouteProto_val_ptr );

    DEBUG_MSGTL( ( "verbose:ipCidrRouteTable:ipCidrRouteProto_get",
        "called\n" ) );
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ipCidrRouteAge_val_ptr );

    DEBUG_MSGTL( ( "verbose:ipCidrRouteTable:ipCidrRouteAge_get",
        "called\n" ) );
    ...
    size_t* ipCidrRouteInfo_val_ptr_len_ptr )
{
    ...
    Assert_assert( ( NULL != ipCidrRouteInfo_val_ptr_ptr )
        && ( NULL != *ipCidrRouteInfo_val_ptr_ptr ) );
    Assert_assert( NULL != ipCidrRouteInfo_val_ptr_len_ptr );

    DEBUG_MSGTL( ( "verbose:ipCidrRouteTable:ipCidrRouteInfo_get",
        "called\n" ) );
     ...
     */
    /** vars_nullOidLen is in bytes, so not sizeof(oid) needed */
    if ( ( *ipCidrRouteInfo_val_ptr_len_ptr ) < ( size_t )vars_nullOidLen ) {
        ( *ipCidrRouteInfo_val_ptr_ptr ) = ( oid* )malloc( vars_nullOidLen );
        if ( NULL == ( *ipCidrRouteInfo_val_ptr_ptr ) )
            return MFD_ERROR;
    }
    ( *ipCidrRouteInfo_val_ptr_len_ptr ) = ( size_t )vars_nullOidLen;
    memcpy( ( *ipCidrRouteInfo_val_ptr_ptr ), vars_nullOid, ( size_t )vars_nullOidLen );
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ipCidrRouteNextHopAS_val_ptr );

    DEBUG_MSGTL( ( "verbose:ipCidrRouteTable:ipCidrRouteNextHopAS_get",
        "called\n" ) );
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ipCidrRouteMetric1_val_ptr );

    DEBUG_MSGTL( ( "verbose:ipCidrRouteTable:ipCidrRouteMetric1_get",
        "called\n" ) );
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ipCidrRouteMetric2_val_ptr );

    DEBUG_MSGTL( ( "verbose:ipCidrRouteTable:ipCidrRouteMetric2_get",
        "called\n" ) );
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ipCidrRouteMetric3_val_ptr );

    DEBUG_MSGTL( ( "verbose:ipCidrRouteTable:ipCidrRouteMetric3_get",
        "called\n" ) );
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ipCidrRouteMetric4_val_ptr );

    DEBUG_MSGTL( ( "verbose:ipCidrRouteTable:ipCidrRouteMetric4_get",
        "called\n" ) );
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ipCidrRouteMetric5_val_ptr );

    DEBUG_MSGTL( ( "verbose:ipCidrRouteTable:ipCidrRouteMetric5_get",
        "called\n" ) );
...
{
    /** we should have a non-NULL pointer */
    Assert_assert( NULL != ipCidrRouteStatus_val_ptr );
...
int ipCidrRouteTable_undo_setup( ipCidrRouteTable_rowreq_ctx* rowreq_ctx )
{
    ...
    DEBUG_MSGTL( ( "verbose:ipCidrRouteTable:ipCidrRouteTable_undo_setup",
        "called\n" ) );
...
int ipCidrRouteTable_undo( ipCidrRouteTable_rowreq_ctx* rowreq_ctx )
{
    ...
    DEBUG_MSGTL( ( "verbose:ipCidrRouteTable:ipCidrRouteTable_undo",
        "called\n" ) );
...
int ipCidrRouteTable_undo_cleanup( ipCidrRouteTable_rowreq_ctx* rowreq_ctx )
{
    ...
    DEBUG_MSGTL( ( "verbose:ipCidrRouteTable:ipCidrRouteTable_undo_cleanup",
        "called\n" ) );
...
int ipCidrRouteTable_commit( ipCidrRouteTable_rowreq_ctx* rowreq_ctx )
{
    ...
    DEBUG_MSGTL( ( "verbose:ipCidrRouteTable:ipCidrRouteTable_commit",
        "called\n" ) );
    ...
    if ( save_flags ) {
        Logger_log( LOGGER_PRIORITY_ERR, "unhandled columns (0x%x) in commit\n",
            save_flags );
        return MFD_ERROR;
    }
...
int ipCidrRouteTable_undo_commit( ipCidrRouteTable_rowreq_ctx* rowreq_ctx )
{
    ...
    DEBUG_MSGTL( ( "verbose:ipCidrRouteTable:ipCidrRouteTable_undo_commit",
        "called\n" ) );
...
{
    DEBUG_MSGTL( ( "verbose:ipCidrRouteTable:ipCidrRouteIfIndex_check_value",
        "called\n" ) );
...
{
    DEBUG_MSGTL( ( "verbose:ipCidrRouteTable:ipCidrRouteIfIndex_undo_setup",
        "called\n" ) );
    ...
    long ipCidrRouteIfIndex_val )
{
    ...
    DEBUG_MSGTL( ( "verbose:ipCidrRouteTable:ipCidrRouteIfIndex_set",
        "called\n" ) );
...
int ipCidrRouteIfIndex_undo( ipCidrRouteTable_rowreq_ctx* rowreq_ctx )
{
    ...
    DEBUG_MSGTL( ( "verbose:ipCidrRouteTable:ipCidrRouteIfIndex_undo",
        "called\n" ) );
...
{
    DEBUG_MSGTL( ( "verbose:ipCidrRouteTable:ipCidrRouteType_check_value",
        "called\n" ) );
...
{
    DEBUG_MSGTL( ( "verbose:ipCidrRouteTable:ipCidrRouteType_undo_setup",
        "called\n" ) );
    ...
    u_long ipCidrRouteType_val )
{
    ...
    DEBUG_MSGTL( ( "verbose:ipCidrRouteTable:ipCidrRouteType_set",
        "called\n" ) );
...
int ipCidrRouteType_undo( ipCidrRouteTable_rowreq_ctx* rowreq_ctx )
{
    ...
    DEBUG_MSGTL( ( "verbose:ipCidrRouteTable:ipCidrRouteType_undo",
        "called\n" ) );
...
{
    DEBUG_MSGTL( ( "verbose:ipCidrRouteTable:ipCidrRouteInfo_check_value",
        "called\n" ) );

    /** should never get a NULL pointer */
    Assert_assert( NULL != rowreq_ctx );
    Assert_assert( NULL != ipCidrRouteInfo_val_ptr );
...
{
    DEBUG_MSGTL( ( "verbose:ipCidrRouteTable:ipCidrRouteInfo_undo_setup",
        "called\n" ) );
    ...
    size_t ipCidrRouteInfo_val_ptr_len )
{
    ...
    DEBUG_MSGTL( ( "verbose:ipCidrRouteTable:ipCidrRouteInfo_set",
        "called\n" ) );
...
int ipCidrRouteInfo_undo( ipCidrRouteTable_rowreq_ctx* rowreq_ctx )
{
    ...
    DEBUG_MSGTL( ( "verbose:ipCidrRouteTable:ipCidrRouteInfo_undo",
        "called\n" ) );
...
{
    DEBUG_MSGTL( ( "verbose:ipCidrRouteTable:ipCidrRouteNextHopAS_check_value", "called\n" ) );
...
{
    DEBUG_MSGTL( ( "verbose:ipCidrRouteTable:ipCidrRouteNextHopAS_undo_setup",
        "called\n" ) );
    ...
    long ipCidrRouteNextHopAS_val )
{
    ...
    DEBUG_MSGTL( ( "verbose:ipCidrRouteTable:ipCidrRouteNextHopAS_set",
        "called\n" ) );
...
int ipCidrRouteNextHopAS_undo( ipCidrRouteTable_rowreq_ctx* rowreq_ctx )
{
    ...
    DEBUG_MSGTL( ( "verbose:ipCidrRouteTable:ipCidrRouteNextHopAS_undo",
        "called\n" ) );
...
{
    DEBUG_MSGTL( ( "verbose:ipCidrRouteTable:ipCidrRouteMetric1_check_value",
        "called\n" ) );
...
{
    DEBUG_MSGTL( ( "verbose:ipCidrRouteTable:ipCidrRouteMetric1_undo_setup",
        "called\n" ) );
    ...
    long ipCidrRouteMetric1_val )
{
    ...
    DEBUG_MSGTL( ( "verbose:ipCidrRouteTable:ipCidrRouteMetric1_set",
        "called\n" ) );
...
int ipCidrRouteMetric1_undo( ipCidrRouteTable_rowreq_ctx* rowreq_ctx )
{
    ...
    DEBUG_MSGTL( ( "verbose:ipCidrRouteTable:ipCidrRouteMetric1_undo",
        "called\n" ) );
...
{
    DEBUG_MSGTL( ( "verbose:ipCidrRouteTable:ipCidrRouteMetric2_check_value",
        "called\n" ) );
...
{
    DEBUG_MSGTL( ( "verbose:ipCidrRouteTable:ipCidrRouteMetric2_undo_setup",
        "called\n" ) );
    ...
    long ipCidrRouteMetric2_val )
{
    ...
    DEBUG_MSGTL( ( "verbose:ipCidrRouteTable:ipCidrRouteMetric2_set",
        "called\n" ) );
...
int ipCidrRouteMetric2_undo( ipCidrRouteTable_rowreq_ctx* rowreq_ctx )
{
    ...
    DEBUG_MSGTL( ( "verbose:ipCidrRouteTable:ipCidrRouteMetric2_undo",
        "called\n" ) );
...
{
    DEBUG_MSGTL( ( "verbose:ipCidrRouteTable:ipCidrRouteMetric3_check_value",
        "called\n" ) );
...
{
    DEBUG_MSGTL( ( "verbose:ipCidrRouteTable:ipCidrRouteMetric3_undo_setup",
        "called\n" ) );
    ...
    long ipCidrRouteMetric3_val )
{
    ...
    DEBUG_MSGTL( ( "verbose:ipCidrRouteTable:ipCidrRouteMetric3_set",
        "called\n" ) );
...
int ipCidrRouteMetric3_undo( ipCidrRouteTable_rowreq_ctx* rowreq_ctx )
{
    ...
    DEBUG_MSGTL( ( "verbose:ipCidrRouteTable:ipCidrRouteMetric3_undo",
        "called\n" ) );
...
{
    DEBUG_MSGTL( ( "verbose:ipCidrRouteTable:ipCidrRouteMetric4_check_value",
        "called\n" ) );
...
{
    DEBUG_MSGTL( ( "verbose:ipCidrRouteTable:ipCidrRouteMetric4_undo_setup",
        "called\n" ) );
    ...
    long ipCidrRouteMetric4_val )
{
    ...
    DEBUG_MSGTL( ( "verbose:ipCidrRouteTable:ipCidrRouteMetric4_set",
        "called\n" ) );
...
int ipCidrRouteMetric4_undo( ipCidrRouteTable_rowreq_ctx* rowreq_ctx )
{
    ...
    DEBUG_MSGTL( ( "verbose:ipCidrRouteTable:ipCidrRouteMetric4_undo",
        "called\n" ) );
...
{
    DEBUG_MSGTL( ( "verbose:ipCidrRouteTable:ipCidrRouteMetric5_check_value",
        "called\n" ) );
...
{
    DEBUG_MSGTL( ( "verbose:ipCidrRouteTable:ipCidrRouteMetric5_undo_setup",
        "called\n" ) );
    ...
    long ipCidrRouteMetric5_val )
{
    ...
    DEBUG_MSGTL( ( "verbose:ipCidrRouteTable:ipCidrRouteMetric5_set",
        "called\n" ) );
...
int ipCidrRouteMetric5_undo( ipCidrRouteTable_rowreq_ctx* rowreq_ctx )
{
    ...
    DEBUG_MSGTL( ( "verbose:ipCidrRouteTable:ipCidrRouteMetric5_undo",
        "called\n" ) );
...
{
    DEBUG_MSGTL( ( "verbose:ipCidrRouteTable:ipCidrRouteStatus_check_value",
        "called\n" ) );
...
{
    DEBUG_MSGTL( ( "verbose:ipCidrRouteTable:ipCidrRouteStatus_undo_setup",
        "called\n" ) );
    ...
    u_long ipCidrRouteStatus_val )
{
    ...
    DEBUG_MSGTL( ( "verbose:ipCidrRouteTable:ipCidrRouteStatus_set",
        "called\n" ) );
...
int ipCidrRouteStatus_undo( ipCidrRouteTable_rowreq_ctx* rowreq_ctx )
{
    ...
    DEBUG_MSGTL( ( "verbose:ipCidrRouteTable:ipCidrRouteStatus_undo",
        "called\n" ) );
