...
#include "Table.h"
    ...
    Container_Container *ipCidrRouteTable_container_get(void);
    ...
    int             ipCidrRouteTable_index_to_oid(Types_Index * oid_idx,
                                                  ...
                                                  * mib_idx);
    int             ipCidrRouteTable_index_from_oid(Types_Index *
                                                    oid_idx,
                                                    ipCidrRouteTable_mib_index
                                                    * mib_idx);
     ...
     */
    void            ipCidrRouteTable_valid_columns_set(ColumnInfo
                                                       *vc);
