...
typedef void  (Alarm_CallbackFT) (unsigned int clientreg,
                                     void *clientarg);
...
unsigned int Alarm_register(unsigned int when,
                                    unsigned int flags,
                                    Alarm_CallbackFT * thecallback,
                                    void *clientarg);

unsigned int Alarm_registerHr(struct timeval t,
                                       unsigned int flags,
                                       Alarm_CallbackFT * cb,
                                       void *cd);
...
int  Alarm_initAlarmPostConfig(int majorid, int minorid,
                               void *serverarg,
                               void *clientarg);
