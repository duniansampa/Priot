    ...
    void** opaque, int* olength )
{
    ...
    if ( opaque != NULL && *opaque != NULL && ( ( *olength == sizeof( struct Transport_IndexedAddrPair_s ) || ( *olength == sizeof( struct sockaddr_in ) ) ) ) ) {
        addr_pair = ( struct Transport_IndexedAddrPair_s* )( *opaque );
    } else if ( t != NULL && t->data != NULL && t->data_length == sizeof( struct Transport_IndexedAddrPair_s ) ) {
