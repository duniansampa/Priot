...
#define REGISTER_MIB(descr, var, vartype, theoid)                       \
  if (AgentRegistry_registerMib(                                        \
          descr, (const struct Variable_s*)var, sizeof(struct vartype), \
...
Subtree* AgentRegistry_subtreeFind(const oid*,
                                   size_t,
                                   Subtree*,
                                   const char* context_name);

Subtree* AgentRegistry_subtreeFindNext(const oid*,
                                       size_t,
                                       Subtree*,
                                       const char* context_name);

Subtree* AgentRegistry_subtreeFindPrev(const oid*,
                                       size_t,
                                       Subtree*,
                                       const char* context_name);

Subtree* AgentRegistry_subtreeFindFirst(const char* context_name);

Types_Session* AgentRegistry_getSessionForOid(const oid*,
                                              size_t,
                                              const char* context_name);

SubtreeContextCache* AgentRegistry_getTopContextCache(void);

void AgentRegistry_setLookupCacheSize(int newsize);

int AgentRegistry_getLookupCacheSize(void);

int AgentRegistry_registerMib(const char*,
...
int AgentRegistry_registerMibPriority(const char*,
                                      const struct Variable_s*,
                                      size_t,
                                      size_t,
                                      const oid*,
...
int AgentRegistry_registerMibRange(const char*,
                                   const struct Variable_s*,
                                   size_t,
                                   size_t,
                                   const oid*,
...
int AgentRegistry_registerMibContext(const char*,
                                     const struct Variable_s*,
                                     size_t,
                                     size_t,
                                     const oid*,
...
int AgentRegistry_unregisterMib(oid*, size_t);

int AgentRegistry_unregisterMibPriority(oid*, size_t, int);

int AgentRegistry_unregisterMibRange(oid*, size_t, int, int, oid);

int AgentRegistry_unregisterMibContext(oid*,
                                       size_t,
                                       int,
                                       int,
                                       oid,
...
void AgentRegistry_unregisterMibsBySession(Types_Session*);

int AgentRegistry_unregisterMibTableRow(oid* mibloc,
                                        size_t mibloclen,
                                        int priority,
                                        int var_subid,
                                        oid range_ubound,
...
int AgentRegistry_inAView(oid*, size_t*, Types_Pdu*, int);

int AgentRegistry_checkAccess(Types_Pdu* pdu);

int AgentRegistry_acmCheckSubtree(Types_Pdu*, oid*, size_t);
...
int AgentRegistry_registerSignal(int, void (*func)(int));

int AgentRegistry_unregisterSignal(int);
...
int AgentRegistry_registerMib2(const char*,
                               struct Variable_s*,
                               size_t,
                               size_t,
                               oid*,
