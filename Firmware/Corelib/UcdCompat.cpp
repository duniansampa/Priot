...
UcdCompat_setDumpPacket(int x)
{
    DefaultStore_setBoolean(DEFAULTSTORE_STORAGE::LIBRARY_ID,
               DEFAULTSTORE_LIB_BOOLEAN::DUMP_PACKET, x);
}

int
UcdCompat_getDumpPacket(void)
{
    return DefaultStore_getBoolean(DEFAULTSTORE_STORAGE::LIBRARY_ID,
...
{
    DefaultStore_setBoolean(DEFAULTSTORE_STORAGE::LIBRARY_ID,
               DEFAULTSTORE_LIB_BOOLEAN::QUICK_PRINT, x);
}
...
{
    return DefaultStore_getBoolean(DEFAULTSTORE_STORAGE::LIBRARY_ID,
                  DEFAULTSTORE_LIB_BOOLEAN::QUICK_PRINT);
}
...
UcdCompat_setSuffixOnly(int x)
{
    DefaultStore_setInt(DEFAULTSTORE_STORAGE::LIBRARY_ID,
               DEFAULTSTORE_LIB_INTEGER::OID_OUTPUT_FORMAT, x);
}

int
UcdCompat_getSuffixOnly(void)
{
    return DefaultStore_getInt(DEFAULTSTORE_STORAGE::LIBRARY_ID,
                  DEFAULTSTORE_LIB_INTEGER::OID_OUTPUT_FORMAT);
}
...
{
    DefaultStore_setBoolean(DEFAULTSTORE_STORAGE::LIBRARY_ID,
               DEFAULTSTORE_LIB_BOOLEAN::RANDOM_ACCESS, x);
}
...
{
    return DefaultStore_getBoolean(DEFAULTSTORE_STORAGE::LIBRARY_ID,
                  DEFAULTSTORE_LIB_BOOLEAN::RANDOM_ACCESS);
}
...
{
    DefaultStore_setBoolean(DEFAULTSTORE_STORAGE::LIBRARY_ID,
               DEFAULTSTORE_LIB_BOOLEAN::MIB_ERRORS, err);
}
...
{
    DefaultStore_setInt(DEFAULTSTORE_STORAGE::LIBRARY_ID,
               DEFAULTSTORE_LIB_INTEGER::MIB_WARNINGS, warn);
}
...
{
    DefaultStore_setBoolean(DEFAULTSTORE_STORAGE::LIBRARY_ID,
               DEFAULTSTORE_LIB_BOOLEAN::SAVE_MIB_DESCRS, save);
}
...
UcdCompat_setMibCommentTerm(int save)
{
     ...
     */
    DefaultStore_setBoolean(DEFAULTSTORE_STORAGE::LIBRARY_ID,
               DEFAULTSTORE_LIB_BOOLEAN::MIB_COMMENT_TERM, save);
}
...
UcdCompat_setMibParseLabel(int save)
{
     ...
     */
    DefaultStore_setBoolean(DEFAULTSTORE_STORAGE::LIBRARY_ID,
               DEFAULTSTORE_LIB_BOOLEAN::MIB_PARSE_LABEL, save);
}
