 ...
 */
typedef Transport_IndexedAddrPair_s TPCDomain_UdpAddrPair;

_oid tPCDomain_priotTCPDomain[] = { TRANSPORT_DOMAIN_TCP_IP };
...
void TPCDomain_ctor(void)
{
    ...
    tPCDomain_tcpDomain.name_length = sizeof(tPCDomain_priotTCPDomain) / sizeof(_oid);
