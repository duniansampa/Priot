...
_oid aliasDomain_priotALIASDomain[] = { 1,3,6,1,4,1,8072,3,3,7 };
static Transport_Tdomain aliasDomain_aliasDomain;

/* simple storage mechanism */
static DataList_DataList_s *alias_memory = NULL;
...
AliasDomain_ctor(void)
{
    ...
    aliasDomain_aliasDomain.name_length = sizeof(aliasDomain_priotALIASDomain) / sizeof(_oid);
