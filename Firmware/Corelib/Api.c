...
Api_pduParse(Types_Pdu *pdu, u_char * data, size_t * length)
{
    ...
    case PRIOT_MSG_TRAP:
        ...
        if (data == NULL)
            return -1;
        pdu->enterprise =
            (oid *) malloc(pdu->enterpriseLength * sizeof(oid));
        if (pdu->enterprise == NULL) {
            return -1;
        }
                     ...
                     u_char * packetptr, int length)
{
  ...
  if (pdu->flags & PRIOT_UCD_MSG_FLAG_RESPONSE_PDU) {
    ...
    if (pdu->command == PRIOT_MSG_REPORT) {
      if (sp->s_snmp_errno == ErrorCode_NOT_IN_TIME_WINDOW ||
 ...
 */
int
Api_oidNcompare(const oid * in_name1,
                  size_t len1,
 ...
 */
int
Api_oidCompare(const oid * in_name1,
 ...
 */
int
Api_oidCompareLl(const oid * in_name1,
                       size_t len1, const oid * in_name2, size_t len2,
                       size_t *offpt)
{
    register int    len;
 ...
 */
int
Api_oidtreeCompare(const oid * in_name1,
                     size_t len1, const oid * in_name2, size_t len2)
{
...
int
Api_oidsubtreeCompare(const oid * in_name1,
                     size_t len1, const oid * in_name2, size_t len2)
{
    int             len = ((len1 < len2) ? len1 : len2);
 ...
 */
int
Api_oidEquals(const oid * in_name1,
                   size_t len1, const oid * in_name2, size_t len2)
{
    register const oid *name1 = in_name1;
    register const oid *name2 = in_name2;
 ...
 */
int
Api_oidIsSubtree(const oid * in_name1,
                       size_t len1, const oid * in_name2, size_t len2)
{
    if (len1 > len2)
        return 1;
 ...
 */
int
Api_oidFindPrefix(const oid * in_name1, size_t len1,
 ...
 */
oid *
Api_duplicateObjid(const oid * objToCopy, size_t objToCopyLen)
{
    oid            *returnOid;
