...
#define KEYTOOLS_USM_LENGTH_P_MIN            8       /* In characters. */
     ...
     * Prototypes.h
     */
    int Keytools_generateKu(const _oid * hashtype, u_int hashtype_len,
                            const u_char * P, size_t pplen,
                            u_char * Ku, size_t * kulen);


    int Keytools_generateKul(const _oid * hashtype, u_int hashtype_len,
                            const u_char * engineID, size_t engineID_len,
                            const u_char * Ku, size_t ku_len,
                            u_char * Kul, size_t * kul_len);


    int Keytools_encodeKeychange(const _oid * hashtype,
    ...
    int Keytools_decodeKeychange(const _oid * hashtype,
                                u_int hashtype_len, u_char * oldkey,
