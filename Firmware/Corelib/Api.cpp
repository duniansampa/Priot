...
static _oid      api_defaultEnterprise[] = { 1, 3, 6, 1, 4, 1, 3, 1, 1 };
/*
...
static const char *api_errors[-API_ERR_MAX + 1] = {
    "No error",                 /* API_ERR_SUCCESS */
    "Generic error",            /* API_ERR_GENERR */
    "Invalid local port",       /* SNMPERR_BAD_LOCPORT */
    "Unknown host",             /* API_ERR_BAD_ADDRESS */
    "Unknown session",          /* API_ERR_BAD_SESSION */
    "Too long",                 /* API_ERR_TOO_LONG */
    "No socket",                /* SNMPERR_NO_SOCKET */
    "Cannot send V2 PDU on V1 session", /* API_ERR_V2_IN_V1 */
    "Cannot send V1 PDU on V2 session", /* API_ERR_V1_IN_V2 */
    "Bad value for non-repeaters",      /* API_ERR_BAD_REPEATERS */
    "Bad value for max-repetitions",    /* API_ERR_BAD_REPETITIONS */
    "Error building ASN.1 representation",      /* SNMPERR_BAD_ASN1_BUILD */
    "Failure in sendto",        /* API_ERR_BAD_SENDTO */
    "Bad parse of ASN.1 type",  /* API_ERR_BAD_PARSE */
    "Bad version specified",    /* API_ERR_BAD_VERSION */
    "Bad source party specified",       /* SNMPERR_BAD_SRC_PARTY */
    "Bad destination party specified",  /* SNMPERR_BAD_DST_PARTY */
    "Bad context specified",    /* API_ERR_BAD_CONTEXT */
    ...
    "Unknown PDU type",         /* API_ERR_UNKNOWN_PDU */
    "Timeout",                  /* SNMPERR_TIMEOUT */
    "Failure in recvfrom",      /* API_ERR_BAD_RECVFROM */
    "Unable to determine contextEngineID",      /* SNMPERR_BAD_ENG_ID */
    "No securityName specified",        /* SNMPERR_BAD_SEC_NAME */
    "Unable to determine securityLevel",        /* API_ERR_BAD_SEC_LEVEL  */
    "ASN.1 parse error in message",     /* API_ERR_ASN_PARSE_ERR */
    "Unknown security model in message",        /* API_ERR_UNKNOWN_SEC_MODEL */
    "Invalid message (e.g. msgFlags)",  /* API_ERR_INVALID_MSG */
    ...
    "Authentication failure (incorrect password, community or key)",    /* API_ERR_AUTHENTICATION_FAILURE */
    "Not in time window",       /* API_ERR_NOT_IN_TIME_WINDOW */
    ...
    "Unknown Report message",   /* API_ERR_UNKNOWN_REPORT */
    "USM generic error",        /* SNMPERR_USM_GENERICERROR */
    "USM unknown security name (no such user exists)",  /* SNMPERR_USM_UNKNOWNSECURITYNAME */
    "USM unsupported security level (this user has not been configured for that level of security)",    /* API_ERR_USM_UNSUPPORTEDSECURITYLEVEL */
    ...
    "USM unknown engineID",     /* API_ERR_USM_UNKNOWNENGINEID */
    "USM not in time window",   /* API_ERR_USM_NOTINTIMEWINDOW */
    "USM decryption error",     /* SNMPERR_USM_DECRYPTIONERROR */
    "MIB not initialized",      /* SNMPERR_NOMIB */
    "Value out of range",       /* API_ERR_RANGE */
    ...
    "Configuration data found but the transport can't be configured", /* API_ERR_TRANSPORT_NO_CONFIG */
    "Transport configuration failed", /* API_ERR_TRANSPORT_CONFIG_ERROR */
};
...
Api_getNextReqid(void)
{
    ...
    if (!retVal)
        retVal = 2;
    api_reqid = retVal;
    if (DefaultStore_getBoolean(DEFAULTSTORE_STORAGE::LIBRARY_ID, DEFAULTSTORE_LIB_BOOLEAN::LIB16BIT_IDS))
...
void
Api_perror(const char *prog_string)
{
    const char     *str;
    int             xerr;
...
Api_errstring(int snmp_errnumber)
{
    ...
    if (snmp_errnumber >= API_ERR_MAX && snmp_errnumber <= API_ERR_GENERR) {
        msg = api_errors[-snmp_errnumber];
    } else if (snmp_errnumber != API_ERR_SUCCESS) {
        msg = NULL;
    }
    if (!msg) {
 ...
 */
void
Api_sessError(void *sessp, int *p_errno, int *p_snmp_errno, char **p_str)
{
 ...
 */
void
Api_sessPerror(const char *prog_string, Types_Session * ss)
{
...
Api_init2(void)
{
    ...
    DefaultStore_setInt(DEFAULTSTORE_STORAGE::LIBRARY_ID,
                       DEFAULTSTORE_LIB_INTEGER::HEX_OUTPUT_LENGTH, 16);
    DefaultStore_setInt(DEFAULTSTORE_STORAGE::LIBRARY_ID, DEFAULTSTORE_LIB_INTEGER::RETRIES,
                       DEFAULT_RETRIES);

    DefaultStore_setBoolean(DEFAULTSTORE_STORAGE::LIBRARY_ID,
               DEFAULTSTORE_LIB_BOOLEAN::REVERSE_ENCODE,
...
Api_registerDefaultHandlers(void)
{
    DefaultStore_registerConfig(ASN01_BOOLEAN, "snmp", "dumpPacket",
              DEFAULTSTORE_STORAGE::LIBRARY_ID, DEFAULTSTORE_LIB_BOOLEAN::DUMP_PACKET);
    DefaultStore_registerConfig(ASN01_BOOLEAN, "snmp", "reverseEncodeBER",
              DEFAULTSTORE_STORAGE::LIBRARY_ID, DEFAULTSTORE_LIB_BOOLEAN::REVERSE_ENCODE);
    DefaultStore_registerConfig(ASN01_INTEGER, "snmp", "defaultPort",
              DEFAULTSTORE_STORAGE::LIBRARY_ID, DEFAULTSTORE_LIB_INTEGER::DEFAULT_PORT);
    DefaultStore_registerConfig(ASN01_OCTET_STR, "snmp", "defCommunity",
                      DEFAULTSTORE_STORAGE::LIBRARY_ID, DEFAULTSTORE_LIB_STRING::COMMUNITY);
    DefaultStore_registerPremib(ASN01_BOOLEAN, "snmp", "noTokenWarnings",
                      DEFAULTSTORE_STORAGE::LIBRARY_ID, DEFAULTSTORE_LIB_BOOLEAN::NO_TOKEN_WARNINGS);
    DefaultStore_registerConfig(ASN01_BOOLEAN, "snmp", "noRangeCheck",
              DEFAULTSTORE_STORAGE::LIBRARY_ID, DEFAULTSTORE_LIB_BOOLEAN::DONT_CHECK_RANGE);
    DefaultStore_registerPremib(ASN01_OCTET_STR, "snmp", "persistentDir",
                  DEFAULTSTORE_STORAGE::LIBRARY_ID, DEFAULTSTORE_LIB_STRING::PERSISTENT_DIR);
    DefaultStore_registerConfig(ASN01_OCTET_STR, "snmp", "tempFilePattern",
                  DEFAULTSTORE_STORAGE::LIBRARY_ID, DEFAULTSTORE_LIB_STRING::TEMP_FILE_PATTERN);
    DefaultStore_registerConfig(ASN01_BOOLEAN, "snmp", "noDisplayHint",
                  DEFAULTSTORE_STORAGE::LIBRARY_ID, DEFAULTSTORE_LIB_BOOLEAN::NO_DISPLAY_HINT);
    DefaultStore_registerConfig(ASN01_BOOLEAN, "snmp", "16bitIDs",
                  DEFAULTSTORE_STORAGE::LIBRARY_ID, DEFAULTSTORE_LIB_BOOLEAN::LIB16BIT_IDS);
    DefaultStore_registerPremib(ASN01_OCTET_STR, "snmp", "clientaddr",
                      DEFAULTSTORE_STORAGE::LIBRARY_ID, DEFAULTSTORE_LIB_STRING::CLIENT_ADDR);
    DefaultStore_registerConfig(ASN01_INTEGER, "snmp", "serverSendBuf",
              DEFAULTSTORE_STORAGE::LIBRARY_ID, DEFAULTSTORE_LIB_INTEGER::SERVERSENDBUF);
    DefaultStore_registerConfig(ASN01_INTEGER, "snmp", "serverRecvBuf",
              DEFAULTSTORE_STORAGE::LIBRARY_ID, DEFAULTSTORE_LIB_INTEGER::SERVERRECVBUF);
    DefaultStore_registerConfig(ASN01_INTEGER, "snmp", "clientSendBuf",
              DEFAULTSTORE_STORAGE::LIBRARY_ID, DEFAULTSTORE_LIB_INTEGER::CLIENTSENDBUF);
    DefaultStore_registerConfig(ASN01_INTEGER, "snmp", "clientRecvBuf",
              DEFAULTSTORE_STORAGE::LIBRARY_ID, DEFAULTSTORE_LIB_INTEGER::CLIENTRECVBUF);
    DefaultStore_registerConfig(ASN01_BOOLEAN, "snmp", "noPersistentLoad",
              DEFAULTSTORE_STORAGE::LIBRARY_ID, DEFAULTSTORE_LIB_BOOLEAN::DISABLE_PERSISTENT_LOAD);
    DefaultStore_registerConfig(ASN01_BOOLEAN, "snmp", "noPersistentSave",
              DEFAULTSTORE_STORAGE::LIBRARY_ID, DEFAULTSTORE_LIB_BOOLEAN::DISABLE_PERSISTENT_SAVE);
    DefaultStore_registerConfig(ASN01_BOOLEAN, "snmp",
                               "noContextEngineIDDiscovery",
                               DEFAULTSTORE_STORAGE::LIBRARY_ID,
                               DEFAULTSTORE_LIB_BOOLEAN::NO_DISCOVERY);
    DefaultStore_registerConfig(ASN01_INTEGER, "snmp", "timeout",
                       DEFAULTSTORE_STORAGE::LIBRARY_ID, DEFAULTSTORE_LIB_INTEGER::TIMEOUT);
    DefaultStore_registerConfig(ASN01_INTEGER, "snmp", "retries",
                       DEFAULTSTORE_STORAGE::LIBRARY_ID, DEFAULTSTORE_LIB_INTEGER::RETRIES);
...
Api_init(const char *type)
{
     ...
     */
    if (type && !DefaultStore_getString(DEFAULTSTORE_STORAGE::LIBRARY_ID,
                       DEFAULTSTORE_LIB_STRING::APPTYPE)) {
        DefaultStore_setString(DEFAULTSTORE_STORAGE::LIBRARY_ID,
                  DEFAULTSTORE_LIB_STRING::APPTYPE, type);
    }
...
Api_storeIfNeeded(void)
{
    ...
    Api_store(DefaultStore_getString(DEFAULTSTORE_STORAGE::LIBRARY_ID,
                                     DEFAULTSTORE_LIB_STRING::APPTYPE));
...
Api_sessCopy2(Types_Session * in_session)
{
    ...
    if (slp == NULL) {
        in_session->s_snmp_errno = API_ERR_MALLOC;
        return (NULL);
    }
     ...
     */
    if (in_session->communityLen != API_DEFAULT_COMMUNITY_LEN) {
        ucp = (u_char *) malloc(in_session->communityLen);
        if (ucp != NULL)
            memmove(ucp, in_session->community, in_session->communityLen);
    } else {
        if ((cp = DefaultStore_getString(DEFAULTSTORE_STORAGE::LIBRARY_ID,
                    DEFAULTSTORE_LIB_STRING::COMMUNITY)) != NULL) {
            session->communityLen = strlen(cp);
            ucp = (u_char *) malloc(session->communityLen);
            if (ucp)
                memmove(ucp, cp, session->communityLen);
        } else {
    ...
    if (session->securityLevel <= 0) {
        session->securityLevel =
            DefaultStore_getInt(DEFAULTSTORE_STORAGE::LIBRARY_ID, DEFAULTSTORE_LIB_INTEGER::SECLEVEL);
    }
    ...
    if (in_session->contextName) {
        ...
        if ((cp = DefaultStore_getString(DEFAULTSTORE_STORAGE::LIBRARY_ID,
                                        DEFAULTSTORE_LIB_STRING::CONTEXT)) != NULL)
            cp = strdup(cp);
        else
    ...
    } else if ((cp = DefaultStore_getString(DEFAULTSTORE_STORAGE::LIBRARY_ID,
                       DEFAULTSTORE_LIB_STRING::SECNAME)) != NULL) {
        cp = strdup(cp);
        if (cp == NULL) {
            Api_sessClose(slp);
            return (NULL);
    ...
    if (session->retries == API_DEFAULT_RETRIES) {
        int retry = DefaultStore_getInt(DEFAULTSTORE_STORAGE::LIBRARY_ID,
                                       DEFAULTSTORE_LIB_INTEGER::RETRIES);
        if (retry < 0)
    ...
    if (session->timeout == API_DEFAULT_TIMEOUT) {
        int timeout = DefaultStore_getInt(DEFAULTSTORE_STORAGE::LIBRARY_ID,
                                         DEFAULTSTORE_LIB_INTEGER::TIMEOUT);
        if (timeout <= 0)
...
Api_sessCopy(Types_Session * pss)
{
    ...
    if (!psl) {
        if (!pss->s_snmp_errno) {
            pss->s_snmp_errno = API_ERR_GENERR;
        }
 ...
 */
int
Api_v3ProbeContextEngineIDRfc5343(void *slp, Types_Session *session) {
    Types_Pdu    *pdu = NULL, *response = NULL;
    static _oid      snmpEngineIDoid[]   = { 1,3,6,1,6,3,10,2,1,1,0};
    ...
    if (NULL != response->variables &&
        ...
        Api_oidCompare(response->variables->name,
                         response->variables->nameLength,
                         snmpEngineIDoid, snmpEngineIDoid_len) == 0 &&
        ASN01_OCTET_STR == response->variables->type  &&
        NULL != response->variables->val.string &&
        response->variables->valLen > 0) {
        session->contextEngineID =
            (u_char *)Tools_memdup(response->variables->val.string,
 ...
 */
int
Api_v3EngineIDProbe(struct Api_SessionList_s *slp,
 ...
 * Returns:
 *      API_ERR_SUCCESS                     - Yay
 *      API_ERR_GENERR                      - Generic Error
 *      API_ERR_TRANSPORT_CONFIG_ERROR      - Transport rejected config
 *      API_ERR_TRANSPORT_NO_CONFIG         - Transport can't config
 */
int
        ...
        if (transport->f_config) {
            ...
            for(config_data = (Transport_Config*)CONTAINER_ITERATOR_FIRST(iter); config_data;
                ...
                ret = transport->f_config(transport, config_data->key,
                                          config_data->value);
                if (ret) {
                    return API_ERR_TRANSPORT_CONFIG_ERROR;
                }
            }
        } else {
            return API_ERR_TRANSPORT_NO_CONFIG;
        }
    }
    return API_ERR_SUCCESS;
}
 ...
 *
 * @return API_ERR_SUCCESS : on success
 */
                                       ...
                                       Transport_Transport *transport)
{
    ...
    if (transport == NULL) {
        ...
        in_session->s_snmp_errno = API_ERR_BAD_ADDRESS;
        in_session->s_errno = errno;
        Api_setDetail(in_session->peername);
        return API_ERR_BAD_ADDRESS;
    }
...
Api_sessOpen2(Types_Session * in_session)
{
...

    {
        ...
        if (NULL != in_session->localname) {
            clientaddr_save =
                DefaultStore_getString(DEFAULTSTORE_STORAGE::LIBRARY_ID,
                                      DEFAULTSTORE_LIB_STRING::CLIENT_ADDR);
            DefaultStore_setString(DEFAULTSTORE_STORAGE::LIBRARY_ID,
                                  DEFAULTSTORE_LIB_STRING::CLIENT_ADDR,
        ...
        if (NULL != clientaddr_save)
            DefaultStore_setString(DEFAULTSTORE_STORAGE::LIBRARY_ID,
                                  DEFAULTSTORE_LIB_STRING::CLIENT_ADDR, clientaddr_save);
    }
    ...
    if ( in_session->flags & API_FLAGS_UDP_BROADCAST) {
        ...
        if ( rc != 0 ) {
            in_session->s_snmp_errno = API_ERR_BAD_ADDRESS; /* good as any? */
            in_session->s_errno = errno;
...
Api_add(Types_Session * in_session,
         ...
         int (*fpre_parse) (Types_Session *, Transport_Transport *, void *,
                            int), int (*fpost_parse) (Types_Session *,
                                                      Types_Pdu *, int))
{
    struct Api_SessionList_s *slp;
...
Api_addFull(Types_Session * in_session,
              ...
              int (*fbuild) (Types_Session *, Types_Pdu *, u_char *,
                             size_t *), int (*frbuild) (Types_Session *,
                                                        Types_Pdu *,
                                                        u_char **,
                                                        size_t *,
                                                        size_t *),
...
void           *
Api_sessAddEx(Types_Session * in_session,
                 Transport_Transport *transport,
                 int (*fpre_parse) (Types_Session *, Transport_Transport *,
                                    void *, int),
                 int (*fparse) (Types_Session *, Types_Pdu *, u_char *,
...
void           *
Api_sessAdd(Types_Session * in_session,
              Transport_Transport *transport,
              int (*fpre_parse) (Types_Session *, Transport_Transport *,
                                 void *, int),
              int (*fpost_parse) (Types_Session *, Types_Pdu *, int))
...
int
Api_createUserFromSession(Types_Session * session) {
...
int Api_sessClose(void *sessp)
{
    ...
    if (slp->session != NULL &&
        (sptr = Secmod_find(slp->session->securityModel)) != NULL &&
...
int
Api_close(Types_Session * session)
{
...
Api_v3VerifyMsg(Api_requestList *rp, Types_Pdu *pdu)
{
    ...
    if (pdu->securityModel == PRIOT_SEC_MODEL_USM &&
             ...
             Types_Session * session, Types_Pdu *pdu)
{
    ...
    case PRIOT_MSG_GETBULK:
        if (pdu->max_repetitions < 0) {
            session->s_snmp_errno = API_ERR_BAD_REPETITIONS;
            return -1;
        }
        if (pdu->non_repeaters < 0) {
            session->s_snmp_errno = API_ERR_BAD_REPEATERS;
            return -1;
        }
        break;

    case PRIOT_MSG_TRAP:
        session->s_snmp_errno = API_ERR_V1_IN_V2;
        return -1;

    default:
        session->s_snmp_errno = API_ERR_UNKNOWN_PDU;
        return -1;
    }
    ...
    if (pdu->contextName == NULL) {
        if (!session->contextName) {
            session->s_snmp_errno = API_ERR_BAD_CONTEXT;
            return -1;
        }
        pdu->contextName = strdup(session->contextName);
        if (pdu->contextName == NULL) {
            session->s_snmp_errno = API_ERR_GENERR;
            return -1;
        }
    ...
    if (pdu->securityModel == API_DEFAULT_SECMODEL) {
        pdu->securityModel = session->securityModel;
        if (pdu->securityModel == API_DEFAULT_SECMODEL) {
            pdu->securityModel = Enum_seFindValueInSlist("snmp_secmods", DefaultStore_getString(DEFAULTSTORE_STORAGE::LIBRARY_ID, DEFAULTSTORE_LIB_STRING::SECMODEL));
    ...
    if (pdu->securityNameLen == 0 && pdu->securityName == NULL) {
        if (session->securityModel != PRIOT_SEC_MODEL_TSM &&
            session->securityNameLen == 0) {
            session->s_snmp_errno = API_ERR_BAD_SEC_NAME;
            return -1;
        }
        if (session->securityName) {
            pdu->securityName = strdup(session->securityName);
    ...
    if (pdu->securityLevel == 0) {
        if (session->securityLevel == 0) {
            session->s_snmp_errno = API_ERR_BAD_SEC_LEVEL;
            return -1;
        }
    ...
    if (DefaultStore_getBoolean (DEFAULTSTORE_STORAGE::LIBRARY_ID, DEFAULTSTORE_LIB_BOOLEAN::REVERSE_ENCODE)) {
...
int
Api_v3HeaderReallocRbuild(u_char ** pkt, size_t * pkt_len,
                             size_t * offset, Types_Session * session,
                             Types_Pdu *pdu)
{
...
int
Api_v3ScopedPDUHeaderReallocRbuild(u_char ** pkt, size_t * pkt_len,
 ...
 */
int
Api_v3PacketReallocRbuild(u_char ** pkt, size_t * pkt_len,
                             size_t * offset, Types_Session * session,
                             Types_Pdu *pdu, u_char * pdu_data,
                             size_t pdu_data_len)
{
    u_char         *scoped_pdu, *hdrbuf = NULL, *hdr = NULL;
    size_t          hdrbuf_len = API_MAX_MSG_V3_HDRS, hdr_offset =
        0, spdu_offset = 0;
 ...
 */
int
Api_v3PacketBuild(Types_Session * session, Types_Pdu *pdu,
                    u_char * packet, size_t * out_length,
            ...
            Types_Session * session, Types_Pdu *pdu)
{
    ...
    case PRIOT_MSG_INFORM:
         ...
         */
        if (pdu->version == PRIOT_VERSION_1) {
            session->s_snmp_errno = API_ERR_V2_IN_V1;
            return -1;
        }
        if (pdu->errstat == API_DEFAULT_ERRSTAT)
            pdu->errstat = 0;
    ...
    case PRIOT_MSG_TRAP:
        ...
        if (pdu->enterpriseLength == API_DEFAULT_ENTERPRISE_LENGTH) {
            pdu->enterprise = (_oid *) malloc(sizeof(DEFAULT_ENTERPRISE));
            if (pdu->enterprise == NULL) {
                session->s_snmp_errno = API_ERR_MALLOC;
                return -1;
            }
            memmove(pdu->enterprise, DEFAULT_ENTERPRISE,
                    sizeof(DEFAULT_ENTERPRISE));
            pdu->enterpriseLength =
                sizeof(DEFAULT_ENTERPRISE) / sizeof(_oid);
        }
     ...
     */
    switch (pdu->version) {
    case PRIOT_VERSION_1:
    case PRIOT_VERSION_2c:

        if (pdu->communityLen == 0 && pdu->command != PRIOT_MSG_RESPONSE) {
            /*
             * copy session community exactly to pdu community
             */
            if (0 == session->communityLen) {
                TOOLS_FREE(pdu->community);
            } else if (pdu->communityLen == session->communityLen) {
                memmove(pdu->community,
                        session->community, session->communityLen);
            } else {
                TOOLS_FREE(pdu->community);
                pdu->community = (u_char *) malloc(session->communityLen);
            ...
            pdu->communityLen = session->communityLen;
        }

        DEBUG_MSGTL(("Api_send", "Building SNMPv%ld message...\n",
                    (1 + pdu->version)));
        if (DefaultStore_getBoolean (DEFAULTSTORE_STORAGE::LIBRARY_ID, DEFAULTSTORE_LIB_BOOLEAN::REVERSE_ENCODE)) {
            DEBUGPRINTPDUTYPE("send", pdu->command);
            rc = Api_pduReallocRbuild(pkt, pkt_len, offset, pdu);
            ...
            DEBUG_DUMPHEADER("send", "Community String");
            rc = Asn01_reallocRbuildString(pkt, pkt_len, offset, 1,
             ...
             */
            if (pdu->version == PRIOT_VERSION_1) {
                DEBUG_DUMPSECTION("send", "SNMPv1 Message");
            } else {
                DEBUG_DUMPSECTION("send", "SNMPv2c Message");
            }
            rc = Asn01_reallocRbuildSequence(pkt, pkt_len, offset, 1,
                                             (u_char) (ASN01_SEQUENCE |
                                                       ASN01_CONSTRUCTOR),
             ...
             */
            cp = Asn01_buildSequence(*pkt, pkt_len,
                                    (u_char) (ASN01_SEQUENCE |
                                              ASN01_CONSTRUCTOR), 0);
            if (cp == NULL) {
                return -1;
            ...
            version = pdu->version;
            cp = Asn01_buildInt(cp, pkt_len,
                               (u_char) (ASN01_UNIVERSAL | ASN01_PRIMITIVE |
                                         ASN01_INTEGER), (long *) &version,
                               sizeof(version));
            DEBUG_INDENTLESS();
            if (cp == NULL)
                return -1;
             ...
             */
            DEBUG_DUMPHEADER("send", "Community String");
            cp = Asn01_buildString(cp, pkt_len,
                                  (u_char) (ASN01_UNIVERSAL | ASN01_PRIMITIVE |
                                            ASN01_OCTET_STR), pdu->community,
                                  pdu->communityLen);
            DEBUG_INDENTLESS();
            if (cp == NULL)
                return -1;
    ...
    default:
        session->s_snmp_errno = API_ERR_BAD_VERSION;
        return -1;
    }
    ...
    case PRIOT_VERSION_1:
    case PRIOT_VERSION_2c:
        Asn01_buildSequence(*pkt, &length,
                           (u_char) (ASN01_SEQUENCE | ASN01_CONSTRUCTOR),
                           cp - h0e);
        break;
...
int
Api_build(u_char ** pkt, size_t * pkt_len, size_t * offset,
           Types_Session * pss, Types_Pdu *pdu)
{
    ...
    if (rc) {
        if (!pss->s_snmp_errno) {
            ...
            pss->s_snmp_errno = API_ERR_BAD_ASN1_BUILD;
        }
        API_SET_PRIOT_ERROR(pss->s_snmp_errno);
        rc = -1;
    }
...
Api_pduBuild(Types_Pdu *pdu, u_char * cp, size_t * out_length)
{
    ...
    if (pdu->command != PRIOT_MSG_TRAP) {
        ...
        cp = Asn01_buildUnsignedInt(cp, out_length,
                                    (u_char) (ASN01_TIMETICKS |
                                              ASN01_PRIMITIVE), &pdu->time,
                                    sizeof(pdu->time));
        DEBUG_INDENTLESS();
        if (cp == NULL)
            return NULL;
 ...
 */
int
Api_pduReallocRbuild(u_char ** pkt, size_t * pkt_len, size_t * offset,
                        Types_Pdu *pdu)
{
...
{
    u_char          type;
    long            version = API_ERR_BAD_VERSION;
             ...
             u_char ** after_header, Types_Session * sess)
{
    ...
    *length -= data - cp;       /* subtract off the length of the header */
    ...
    data =
        Asn01_parseInt(data, length, &type, &pdu->msgid,
                      sizeof(pdu->msgid));
    DEBUG_INDENTLESS();
    ...
    if (!sptr) {
        ...
        DEBUG_INDENTLESS();
        return API_ERR_UNKNOWN_SEC_MODEL;
    }
    pdu->securityModel = msg_sec_model;

    if (msg_flags & PRIOT_MSG_FLAG_PRIV_BIT &&
        !(msg_flags & PRIOT_MSG_FLAG_AUTH_BIT)) {
        IMPL_ERROR_MSG("invalid message, illegal msgFlags");
        Api_incrementStatistic(API_STAT_SNMPINVALIDMSGS);
        DEBUG_INDENTLESS();
        return API_ERR_INVALID_MSG;
    }
...
int
Api_v3MakeReport(Types_Pdu *pdu, int error)
{

    long            ltmp;
    static _oid      unknownSecurityLevel[] =
        { 1, 3, 6, 1, 6, 3, 15, 1, 1, 1, 0 };
    static _oid      notInTimeWindow[] =
        { 1, 3, 6, 1, 6, 3, 15, 1, 1, 2, 0 };
    static _oid      unknownUserName[] =
        { 1, 3, 6, 1, 6, 3, 15, 1, 1, 3, 0 };
    static _oid      unknownEngineID[] =
        { 1, 3, 6, 1, 6, 3, 15, 1, 1, 4, 0 };
    static _oid      wrongDigest[] = { 1, 3, 6, 1, 6, 3, 15, 1, 1, 5, 0 };
    static _oid      decryptionError[] =
    ...
    pdu->securityEngineID =
        V3_generateEngineID(&pdu->securityEngineIDLen);
    TOOLS_FREE(pdu->contextEngineID);
    pdu->contextEngineID =
        V3_generateEngineID(&pdu->contextEngineIDLen);
    ...
    if (error == API_ERR_USM_NOTINTIMEWINDOW) {
...
int
Api_v3GetReportType(Types_Pdu *pdu)
{
    static _oid      snmpMPDStats[] = { 1, 3, 6, 1, 6, 3, 11, 2, 1 };
    static _oid      targetStats[]  = { 1, 3, 6, 1, 6, 3, 12, 1    };
    static _oid      usmStats[]     = { 1, 3, 6, 1, 6, 3, 15, 1, 1 };
    Types_VariableList *vp;
    int             rpt_type = API_ERR_UNKNOWN_REPORT;
    ...
    if (vp->nameLength == API_REPORT_STATS_LEN + 2) {
        if (memcmp(snmpMPDStats, vp->name, API_REPORT_STATS_LEN * sizeof(_oid)) == 0) {
            switch (vp->name[API_REPORT_STATS_LEN]) {
            case API_REPORT_snmpUnknownSecurityModels_NUM:
                rpt_type = API_ERR_UNKNOWN_SEC_MODEL;
                break;
            case API_REPORT_snmpInvalidMsgs_NUM:
                rpt_type = API_ERR_INVALID_MSG;
                break;
            case API_REPORT_snmpUnknownPDUHandlers_NUM:
                rpt_type = API_ERR_BAD_VERSION;
                break;
            }
        } else if (memcmp(usmStats, vp->name, API_REPORT_STATS_LEN * sizeof(_oid)) == 0) {
            switch (vp->name[API_REPORT_STATS_LEN]) {
            case API_REPORT_usmStatsUnsupportedSecLevels_NUM:
                rpt_type = API_ERR_UNSUPPORTED_SEC_LEVEL;
                break;
            case API_REPORT_usmStatsNotInTimeWindows_NUM:
                rpt_type = API_ERR_NOT_IN_TIME_WINDOW;
                break;
            case API_REPORT_usmStatsUnknownUserNames_NUM:
                rpt_type = API_ERR_UNKNOWN_USER_NAME;
                break;
            case API_REPORT_usmStatsUnknownEngineIDs_NUM:
                rpt_type = API_ERR_UNKNOWN_ENG_ID;
                break;
            case API_REPORT_usmStatsWrongDigests_NUM:
                rpt_type = API_ERR_AUTHENTICATION_FAILURE;
                break;
            case API_REPORT_usmStatsDecryptionErrors_NUM:
                rpt_type = API_ERR_DECRYPTION_ERR;
                break;
            }
        }
    }
    ...
    if (vp->nameLength == API_REPORT_STATS_LEN2 + 2) {
        if (memcmp(targetStats, vp->name, API_REPORT_STATS_LEN2 * sizeof(_oid)) == 0) {
            switch (vp->name[API_REPORT_STATS_LEN2]) {
            case API_REPORT_snmpUnavailableContexts_NUM:
                rpt_type = API_ERR_BAD_CONTEXT;
                break;
...
{
    u_char          community[IMPL_COMMUNITY_MAX_LEN];
    size_t          community_length = IMPL_COMMUNITY_MAX_LEN;
    int             result = -1;
    ...
    case PRIOT_VERSION_1:
    case PRIOT_VERSION_2c:
        DEBUG_MSGTL(("snmp_api", "Parsing SNMPv%ld message...\n",
                    (1 + pdu->version)));
         ...
         */
        if (pdu->version == PRIOT_VERSION_1) {
            DEBUG_DUMPSECTION("recv", "SNMPv1 message\n");
        } else {
            DEBUG_DUMPSECTION("recv", "SNMPv2c message\n");
        }
        data = Auth_comstrParse(data, &length,
        ...
        pdu->securityLevel = PRIOT_SEC_LEVEL_NOAUTH;
        pdu->securityModel =
            (pdu->version == PRIOT_VERSION_1) ? PRIOT_SEC_MODEL_SNMPv1 :
                                               PRIOT_SEC_MODEL_SNMPv2c;
        TOOLS_FREE(pdu->community);
        pdu->communityLen = 0;
        pdu->community = (u_char *) 0;
        if (community_length) {
            pdu->communityLen = community_length;
        ...
        if (session->authenticator) {
            data = session->authenticator(data, &length,
                                          community, community_length);
            if (data == NULL) {
                session->s_snmp_errno = API_ERR_AUTHENTICATION_FAILURE;
                return -1;
            }
        }

        DEBUG_DUMPSECTION("recv", "PDU");
        result = Api_pduParse(pdu, data, &length);
        if (result < 0) {
            /*
    ...
    case PRIOT_VERSION_3:
        ...
        if (result) {
            struct Secmod_Def_s *secmod =
                Secmod_find(pdu->securityModel);
            if (!sessp) {
        ...
        */
        ...
        if (!DefaultStore_getBoolean (DEFAULTSTORE_STORAGE::LIBRARY_ID,
                                    DEFAULTSTORE_LIB_BOOLEAN::NO_DISCOVERY) &&
            ...
            result = API_ERR_JUST_A_CONTEXT_PROBE;
            ...
            if (NULL != pdu->variables &&
                ...
                ((PRIOT_MSG_GET == pdu->command &&
                  Api_oidCompare(snmpEngineIDoid,
                                   snmpEngineIDoid_len,
                                   pdu->variables->name,
                                   pdu->variables->nameLength) == 0)
                 /* if it's a GETNEXT ensure it's less than the engineID _oid */
                 ||
                 (PRIOT_MSG_GETNEXT == pdu->command &&
                  Api_oidCompare(snmpEngineIDoid,
                                   snmpEngineIDoid_len,
                                   pdu->variables->name,
                                   pdu->variables->nameLength) > 0)
           ...
           Types_Pdu *pdu, u_char * data, size_t length)
{
    ...
    if (rc) {
        if (!pss->s_snmp_errno) {
            pss->s_snmp_errno = API_ERR_BAD_PARSE;
        }
        API_SET_PRIOT_ERROR(pss->s_snmp_errno);
    }
...
int
Api_pduParse(Types_Pdu *pdu, u_char * data, size_t * length)
{
    u_char          type;
    u_char          msg_type;
    u_char         *var_val;
    ...
    case PRIOT_MSG_TRAP:
        ...
        if (data == NULL)
            return -1;
        pdu->enterprise =
            (_oid *) malloc(pdu->enterpriseLength * sizeof(_oid));
        if (pdu->enterprise == NULL) {
            return -1;
        }
        memmove(pdu->enterprise, objid,
                pdu->enterpriseLength * sizeof(_oid));
         ...
         */
        data =
            Asn01_parseInt(data, length, &type,
                          (long *) &pdu->specificType,
                          sizeof(pdu->specificType));
        if (data == NULL)
            return -1;
    ...
    while ((int) *length > 0) {
        ...
        case ASN01_COUNTER64:
            ...
            p = Asn01_parseUnsignedInt64(var_val, &len, &vp->type,
                                     (struct Asn01_Counter64_s *) vp->val.
                                     counter64, vp->valLen);
            if (!p)
                return -1;
            break;
        ...
        case ASN01_OBJECT_ID:
            ...
            if (!p)
                return -1;
            vp->valLen *= sizeof(_oid);
            vp->val.objid = (_oid *) malloc(vp->valLen);
                 ...
                 Types_Pdu *pdu, Types_CallbackFT callback, void *cb_data)
{
    ...
    if (pdu == NULL) {
        session->s_snmp_errno = API_ERR_NULL_PDU;
        return 0;
    }
    ...
    if (pdu->version == PRIOT_VERSION_3 && session->sndMsgMaxSize != 0 && length > session->sndMsgMaxSize) {
        ...
        session->s_snmp_errno = API_ERR_TOO_LONG;
        TOOLS_FREE(pktbuf);
        return 0;
    }
    ...
    if (result < 0) {
        session->s_snmp_errno = API_ERR_BAD_SENDTO;
                     ...
                     Types_CallbackFT callback, void *cb_data)
{
    ...
    if (sessp == NULL) {
        api_priotErrno = API_ERR_BAD_SESSION;       /*MTCRITICAL_RESOURCE */
        return (0);
    }
    /*
     * send pdu
 ...
 */
void
Api_freeVarInternals(Types_VariableList * var)
{
    if (!var)
        return;
...
void
Api_freeVar(Types_VariableList * var)
{
...
void
Api_freeVarbind(Types_VariableList * var)
{
...
Api_freePdu(Types_Pdu *pdu)
{
     ...
     */
    if ((sptr = Secmod_find(pdu->securityModel)) != NULL &&
        sptr->pdu_free != NULL) {
        (*sptr->pdu_free) (pdu);
    }
                     ...
                     u_char * packetptr, int length)
{
  ...
  if (DefaultStore_getBoolean (DEFAULTSTORE_STORAGE::LIBRARY_ID,DEFAULTSTORE_LIB_BOOLEAN::DUMP_PACKET)) {
  ...
  if (pdu->flags & PRIOT_UCD_MSG_FLAG_RESPONSE_PDU) {
    ...
    if (pdu->command == PRIOT_MSG_REPORT) {
      if (sp->s_snmp_errno == API_ERR_NOT_IN_TIME_WINDOW ||
          Api_v3GetReportType(pdu) ==
          API_ERR_NOT_IN_TIME_WINDOW) {
        /*
...
void
Api_read2(Types_LargeFdSet * fdset)
{
    struct Api_SessionList_s *slp;
    MtSupport_resLock(MTSUPPORT_LIBRARY_ID, MTSUPPORT_LIB_SESSION);
    for (slp = api_sessions; slp; slp = slp->next) {
 ...
 */
int
Api_sessRead3(void *sessp, Types_LargeFdSet * fdset)
{
    struct Api_SessionList_s *slp = (struct Api_SessionList_s *) sessp;
        ...
        Transport_Transport *new_transport=Transport_copy(transport);
            if (new_transport != NULL) {
              ...
              isp->hook_create_pdu);
                ...
                sp->s_snmp_errno = API_ERR_MALLOC;
                sp->s_errno = errno;
                Api_setDetail(strerror(errno));
                return -1;
            }
        } else {
            sp->s_snmp_errno = API_ERR_BAD_RECVFROM;
            sp->s_errno = errno;
            Api_setDetail(strerror(errno));
            return -1;
        }
 ...
 */
int
Api_sessRead(void *sessp, fd_set * fdset)
{
  int rc;
  Types_LargeFdSet lfdset;
...
int
Api_sessRead2(void *sessp, Types_LargeFdSet * fdset)
{
    struct Api_SessionList_s *psl;
    Types_Session *pss;
    int             rc;
 ...
 */
int
Api_selectInfo(int *numfds, fd_set *fdset, struct timeval *timeout,
                 int *block)
{
 ...
 */
int
Api_selectInfo2(int *numfds, Types_LargeFdSet *fdset,
 ...
 */
int
Api_sessSelectInfo(void *sessp, int *numfds, fd_set *fdset,
                      struct timeval *timeout, int *block)
{
 ...
 */
int
Api_sessSelectInfoFlags(void *sessp, int *numfds, fd_set *fdset,
 ...
 */
int
Api_sessSelectInfo2(void *sessp, int *numfds, Types_LargeFdSet *fdset,
               struct timeval *timeout, int *block)
{
 ...
 */
int
Api_sessSelectInfo2Flags(void *sessp, int *numfds,
                    ...
                    int incr_retries)
{
    ...
    if (result < 0) {
        sp->s_snmp_errno = API_ERR_BAD_SENDTO;
        sp->s_errno = errno;
        Api_setDetail(strerror(errno));
        return -1;
    } else {
...
Api_sessTimeout(void *sessp)
{
    ...
    for (rp = isp->requests; rp; rp = rp->next_request) {
        ...
        if ((timercmp(&rp->expireM, &now, <))) {
            if ((sptr = Secmod_find(rp->pdu->securityModel)) != NULL &&
 ...
 */
int
Api_oidNcompare(const _oid * in_name1,
                  size_t len1,
                  const _oid * in_name2, size_t len2, size_t max_len)
{
    register int    len;
    register const _oid *name1 = in_name1;
    register const _oid *name2 = in_name2;
    size_t          min_len;
 ...
 */
int
Api_oidCompare(const _oid * in_name1,
                 size_t len1, const _oid * in_name2, size_t len2)
{
    register int    len;
    register const _oid *name1 = in_name1;
    register const _oid *name2 = in_name2;
 ...
 */
int
Api_oidCompareLl(const _oid * in_name1,
                       size_t len1, const _oid * in_name2, size_t len2,
                       size_t *offpt)
{
    register int    len;
...
int
Api_oidsubtreeCompare(const _oid * in_name1,
                     size_t len1, const _oid * in_name2, size_t len2)
{
    int             len = ((len1 < len2) ? len1 : len2);
 ...
 */
int
Api_oidEquals(const _oid * in_name1,
                   size_t len1, const _oid * in_name2, size_t len2)
{
    register const _oid *name1 = in_name1;
    register const _oid *name2 = in_name2;
 ...
 */
int
Api_oidIsSubtree(const _oid * in_name1,
                       size_t len1, const _oid * in_name2, size_t len2)
{
    if (len1 > len2)
        return 1;

    if (memcmp(in_name1, in_name2, len1 * sizeof(_oid)))
        return 1;
 ...
 * @param in_name1 A pointer to the first _oid.
 * @param len1     Length of the first _oid.
 * @param in_name2 A pointer to the second _oid.
 * @param len2     Length of the second _oid.
 * @return         length of common prefix
 *                 0 if no common prefix, -1 on error.
 */
int
Api_oidFindPrefix(const _oid * in_name1, size_t len1,
                    ...
                    const char *errmsg)
{
    ...
    char *temp = NULL;
    int   temp_len = 0;
    int check = !DefaultStore_getBoolean (DEFAULTSTORE_STORAGE::LIBRARY_ID,
                                    DEFAULTSTORE_LIB_BOOLEAN::DONT_CHECK_RANGE);
                          ...
                          u_char type, const void * value, size_t len)
{
    ...
    if (( 0 != rc ) ||
        (name != NULL && Client_setVarObjid(vars, name, name_length))) {
        Api_freeVar(vars);
        return NULL;
    }
 ...
 * API_ERR_RANGE - type, value, or length not found or out of range
 * API_ERR_VALUE - value is not correct
 ...
 */
int
Api_addVar(Types_Pdu *pdu,
             const _oid * name, size_t name_length, char type, const char *value)
{
    char           *st;
    const char     *cp;
    char           *ecp, *vp;
    int             result = API_ERR_SUCCESS;
    int             check = !DefaultStore_getBoolean (DEFAULTSTORE_STORAGE::LIBRARY_ID,
                         DEFAULTSTORE_LIB_BOOLEAN::DONT_CHECK_RANGE);
    int             do_hint = !DefaultStore_getBoolean (DEFAULTSTORE_STORAGE::LIBRARY_ID,
                         DEFAULTSTORE_LIB_BOOLEAN::NO_DISPLAY_HINT);
    u_char         *hintptr;
    ...
    case 'i':
        ...
        if (*ecp) {
            ...
            if (!ep) {
                result = API_ERR_RANGE;   /* ?? or API_ERR_VALUE; */
                Api_setDetail(value);
                break;
            }
        }
    ...
    case 'o':
        ...
        if ((buf = (u_char *)malloc(sizeof(_oid) * TYPES_MAX_OID_LEN)) == NULL) {
            result = API_ERR_MALLOC;
        } else {
            tint = TYPES_MAX_OID_LEN;
            if (Mib_parseOid(value, (_oid *) buf, &tint)) {
                Api_pduAddVariable(pdu, name, name_length, ASN01_OBJECT_ID,
                                      buf, sizeof(_oid) * tint);
            } else {
    ...
    for (cp = strtok_r(vp, " ,\t", &st); cp; cp = strtok_r(NULL, " ,\t", &st)) {
            ...
            if (ix >= (int)buf_len && !Tools_realloc(&buf, &buf_len)) {
                result = API_ERR_MALLOC;
                break;
            }
            bit = 0x80 >> ltmp % 8;
 ...
 */
void           *
Api_sessPointer(Types_Session * session)
{
    struct Api_SessionList_s *slp;
...
void
Api_sessTransportSet(void *sp, Transport_Transport *t)
{
 ...
 */
_oid *
Api_duplicateObjid(const _oid * objToCopy, size_t objToCopyLen)
{
    _oid            *returnOid;
    if (objToCopy != NULL && objToCopyLen != 0) {
        returnOid = (_oid *) malloc(objToCopyLen * sizeof(_oid));
        if (returnOid) {
            memcpy(returnOid, objToCopy, objToCopyLen * sizeof(_oid));
        }
    } else
        returnOid = NULL;
    return returnOid;
